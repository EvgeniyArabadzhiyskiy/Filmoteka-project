 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wt;class Gt extends Ht{static get __EMPTY_NODE(){return Wt}static set __EMPTY_NODE(t){Wt=t}compare(t,e){return K(t.name,e.name)}isDefinedOn(t){throw(0,I.assertionError)("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(t,e){return!1}minPost(){return jt.MIN}maxPost(){return new jt("[MAX_NAME]",Wt)}makePost(t,e){return(0,I.assert)("string"==typeof t,"KeyIndex indexValue must always be a string."),new jt(t,Wt)}toString(){return".key"}}const $t=new Gt;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xt(t,e){return K(t.name,e.name)}function Yt(t,e){return K(t,e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $e;class Ke{static fromObject(t){let e=new Ke(null);return J(t,((t,n)=>{e=e.set(new bt(t),n)})),e}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,e){if(null!=this.value&&e(this.value))return{path:It(),value:this.value};if(Pt(t))return null;{const n=St(t),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(kt(t),e);if(null!=s){return{path:Dt(new bt(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,(()=>!0))}subtree(t){if(Pt(t))return this;{const e=St(t),n=this.children.get(e);return null!==n?n.subtree(kt(t)):new Ke(null)}}set(t,e){if(Pt(t))return new Ke(e,this.children);{const n=St(t),i=(this.children.get(n)||new Ke(null)).set(kt(t),e),s=this.children.insert(n,i);return new Ke(this.value,s)}}remove(t){if(Pt(t))return this.children.isEmpty()?new Ke(null):new Ke(null,this.children);{const e=St(t),n=this.children.get(e);if(n){const i=n.remove(kt(t));let s;return s=i.isEmpty()?this.children.remove(e):this.children.insert(e,i),null===this.value&&s.isEmpty()?new Ke(null):new Ke(this.value,s)}return this}}get(t){if(Pt(t))return this.value;{const e=St(t),n=this.children.get(e);return n?n.get(kt(t)):null}}setTree(t,e){if(Pt(t))return e;{const n=St(t),i=(this.children.get(n)||new Ke(null)).setTree(kt(t),e);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new Ke(this.value,s)}}fold(t){return this.fold_(It(),t)}fold_(t,e){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Dt(t,i),e)})),e(t,this.value,n)}findOnPath(t,e){return this.findOnPath_(t,It(),e)}findOnPath_(t,e,n){const i=!!this.value&&n(e,this.value);if(i)return i;if(Pt(t))return null;{const i=St(t),s=this.children.get(i);return s?s.findOnPath_(kt(t),Dt(e,i),n):null}}foreachOnPath(t,e){return this.foreachOnPath_(t,It(),e)}foreachOnPath_(t,e,n){if(Pt(t))return this;{this.value&&n(e,this.value);const i=St(t),s=this.children.get(i);return s?s.foreachOnPath_(kt(t),Dt(e,i),n):new Ke(null)}}foreach(t){this.foreach_(It(),t)}foreach_(t,e){this.children.inorderTraversal(((n,i)=>{i.foreach_(Dt(t,n),e)})),this.value&&e(t,this.value)}foreachChild(t){this.children.inorderTraversal(((e,n)=>{n.value&&t(e,n.value)}))}constructor(t,e=(()=>($e||($e=new Qt(z)),$e))()){this.value=t,this.children=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{static empty(){return new ze(new Ke(null))}constructor(t){this.writeTree_=t}}function Qe(t,e,n){if(Pt(e))return new ze(new Ke(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(null!=i){const s=i.path;let r=i.value;const o=Lt(s,e);return r=r.updateChild(o,n),new ze(t.writeTree_.set(s,r))}{const i=new Ke(n),s=t.writeTree_.setTree(e,i);return new ze(s)}}}function Xe(t,e,n){let i=t;return J(n,((t,n)=>{i=Qe(i,Dt(e,t),n)})),i}function Ye(t,e){if(Pt(e))return ze.empty();{const n=t.writeTree_.setTree(e,new Ke(null));return new ze(n)}}function Je(t,e){return null!=Ze(t,e)}function Ze(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return null!=n?t.writeTree_.get(n.path).getChild(Lt(n.path,e)):null}function tn(t){const e=[],n=t.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(re,((t,n)=>{e.push(new jt(t,n))})):t.writeTree_.children.inorderTraversal(((t,n)=>{null!=n.value&&e.push(new jt(t,n.value))})),e}function en(t,e){if(Pt(e))return t;{const n=Ze(t,e);return new ze(null!=n?new Ke(n):t.writeTree_.subtree(e))}}function nn(t){return t.writeTree_.isEmpty()}function sn(t,e){return rn(It(),t.writeTree_,e)}function rn(t,e,n){if(null!=e.value)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal(((e,s)=>{".priority"===e?((0,I.assert)(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=rn(Dt(t,e),s,n)})),n.getChild(t).isEmpty()||null===i||(n=n.updateChild(Dt(t,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $l{static fromTimestamp(t){return new $l(t)}static min(){return new $l(new Gl(0,0))}static max(){return new $l(new Gl(253402300799,999999999))}compareTo(t){return this.timestamp._compareTo(t.timestamp)}isEqual(t){return this.timestamp.isEqual(t.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}constructor(t){this.timestamp=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jl{constructor(t,e,n,i){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=i}}Jl.UNKNOWN_ID=-1;function Zl(t,e){const n=t.toTimestamp().seconds,i=t.toTimestamp().nanoseconds+1,s=$l.fromTimestamp(1e9===i?new Gl(n+1,0):new Gl(n,i));return new eh(s,Yl.empty(),e)}function th(t){return new eh(t.readTime,t.key,-1)}class eh{static min(){return new eh($l.min(),Yl.empty(),-1)}static max(){return new eh($l.max(),Yl.empty(),-1)}constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}}function nh(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:(n=Yl.comparator(t.documentKey,e.documentKey),0!==n?n:Hl(t.largestBatchId,e.largestBatchId))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gu{constructor(t){this.ne=t}}function $u(t){const e=Pu({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?vc(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Of{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new Dl(xl.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Xl(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ff{static fromBase64String(t){try{return new Ff(vh.fromBase64String(t))}catch(t){throw new Dl(xl.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new Ff(vh.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}constructor(t){this._byteString=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return Hl(this._lat,t._lat)||Hl(this._long,t._long)}constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new Dl(xl.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new Dl(xl.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qf=/^__.*__$/;class Bf{toMutation(t,e){return null!==this.fieldMask?new Xc(t,this.data,this.fieldMask,e,this.fieldTransforms):new Qc(t,this.data,e,this.fieldTransforms)}constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}}function jf(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw kl()}}class Hf{get path(){return this.settings.path}get Zc(){return this.settings.Zc}ta(t){return new Hf(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.wt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ea(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),i=this.ta({path:n,na:!1});return i.sa(t),i}ia(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),i=this.ta({path:n,na:!1});return i.Xc(),i}ra(t){return this.ta({path:void 0,na:!0})}oa(t){return tp(t,this.settings.methodName,this.settings.ua||!1,this.path,this.settings.ca)}contains(t){return void 0!==this.fieldMask.find((e=>t.isPrefixOf(e)))||void 0!==this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))}Xc(){if(this.path)for(let t=0;t<this.path.length;t++)this.sa(this.path.get(t))}sa(t){if(0===t.length)throw this.oa("Document fields must not be empty");if(jf(this.Zc)&&qf.test(t))throw this.oa('Document fields cannot begin and end with "__"')}constructor(t,e,n,i,s,r){this.settings=t,this.databaseId=e,this.wt=n,this.ignoreUndefinedProperties=i,void 0===s&&this.Xc(),this.fieldTransforms=s||[],this.fieldMask=r||[]}}class Wf{aa(t,e,n,i=!1){return new Hf({Zc:t,methodName:e,ca:n,path:Xl.emptyPath(),na:!1,ua:i},this.databaseId,this.wt,this.ignoreUndefinedProperties)}constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.wt=n||Nd(t)}}function Gf(t){const e=t._freezeSettings(),n=Nd(t._databaseId);return new Wf(t._databaseId,!!e.ignoreUndefinedProperties,n)}function $f(t,e,n,i,s,r={}){const o=t.aa(r.merge||r.mergeFields?2:0,e,n,s);Xf("Data must be an object, but it was:",o,i);const a=zf(i,o);let l,h;if(r.merge)l=new yh(o.fieldMask),h=o.fieldTransforms;else if(r.mergeFields){const t=[];for(const i of r.mergeFields){const s=Yf(e,i,n);if(!o.contains(s))throw new Dl(xl.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);ep(t,s)||t.push(s)}l=new yh(t),h=o.fieldTransforms.filter((t=>l.covers(t.field)))}else l=null,h=o.fieldTransforms;return new Bf(new Wh(a),l,h)}function Kf(t,e){if(Qf(t=(0,I.getModularInstance)(t)))return Xf("Unsupported field value:",e,t),zf(t,e);if(t instanceof Vf)return function(t,e){if(!jf(e.Zc))throw e.oa(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.oa(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.na&&4!==e.Zc)throw e.oa("Nested arrays are not supported");return function(t,e){const n=[];let i=0;for(const s of t){let t=Kf(s,e.ra(i));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),i++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=(0,I.getModularInstance)(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return kc(e.wt,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=Gl.fromDate(t);return{timestampValue:Cu(e.wt,n)}}if(t instanceof Gl){const n=new Gl(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:Cu(e.wt,n)}}if(t instanceof Uf)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof Ff)return{bytesValue:Eu(e.wt,t._byteString)};if(t instanceof Nf){const n=e.databaseId,i=t.firestore._databaseId;if(!i.isEqual(n))throw e.oa(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Iu(t.firestore._databaseId||e.databaseId,t._key.path)}}throw e.oa(`Unsupported field value: ${Tf(t)}`)}(t,e)}function zf(t,e){const n={};return uh(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):ch(t,((t,i)=>{const s=Kf(i,e.ea(t));null!=s&&(n[t]=s)})),{mapValue:{fields:n}}}function Qf(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof Gl||t instanceof Uf||t instanceof Ff||t instanceof Nf||t instanceof Vf)}function Xf(t,e,n){if(!Qf(n)||("object"!=typeof(i=n)||null===i||Object.getPrototypeOf(i)!==Object.prototype&&null!==Object.getPrototypeOf(i))){const i=Tf(n);throw"an object"===i?e.oa(t+" a custom object"):e.oa(t+" "+i)}var i}function Yf(t,e,n){if((e=(0,I.getModularInstance)(e))instanceof Of)return e._internalPath;if("string"==typeof e)return Zf(t,e);throw tp("Field path arguments must be of type string or ",t,!1,void 0,n)}const Jf=new RegExp("[~\\*/\\[\\]]");function Zf(t,e,n){if(e.search(Jf)>=0)throw tp(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new Of(...e.split("."))._internalPath}catch(i){throw tp(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function tp(t,e,n,i,s){const r=i&&!i.isEmpty(),o=void 0!==s;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let l="";return(r||o)&&(l+=" (found",r&&(l+=` in field ${i}`),o&&(l+=` in document ${s}`),l+=")"),new Dl(xl.INVALID_ARGUMENT,a+t+l)}function ep(t,e){return t.some((t=>t.isEqual(e)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function np(t,e,n){let i;return i=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,i}function ip(t,e){const n=bf(t.firestore,Pf),i=xf(t),s=np(t.converter,e);return sp(n,[$f(Gf(t.firestore),"addDoc",i._key,s,null!==t.converter,{}).toMutation(i._key,Bc.exists(!1))]).then((()=>i))}function sp(t,e){return function(t,e){const n=new Pl;return t.asyncQueue.enqueueAndForget((async()=>async function(t,e,n){const i=cf(t);try{const t=await function(t,e){const n=Rl(t),i=Gl.now(),s=e.reduce(((t,e)=>t.add(e.key)),yu());let r,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(t=>{let a=lu(),l=yu();return n.Ui.getEntries(t,s).next((t=>{a=t,a.forEach(((t,e)=>{e.isValidDocument()||(l=l.add(t))}))})).next((()=>n.localDocuments.getOverlayedDocuments(t,a))).next((s=>{r=s;const o=[];for(const t of e){const e=Kc(t,r.get(t.key).overlayedDocument);null!=e&&o.push(new Xc(t.key,e,Gh(e.value.mapValue),Bc.exists(!0)))}return n.mutationQueue.addMutationBatch(t,i,o,e)})).next((e=>{o=e;const i=e.applyToLocalDocumentSet(r,l);return n.documentOverlayCache.saveOverlays(t,e.batchId,i)}))})).then((()=>({batchId:o.batchId,changes:uu(r)})))}(i.localStore,e);i.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let i=t.oc[t.currentUser.toKey()];i||(i=new dh(Hl)),i=i.insert(e,n),t.oc[t.currentUser.toKey()]=i}(i,t.batchId,n),await lf(i,t.changes),await Ud(i.remoteStore)}catch(t){const e=Jd(t,"Failed to persist write");n.reject(e)}}(await _f(t),e,n))),n.promise}(Lf(t),e)}!function(t,e=!0){var n;n=T.SDK_VERSION,Cl=n,(0,T._registerComponent)(new(0,b.Component)("firestore",((t,{options:n})=>{const i=t.getProvider("app").getImmediate(),s=new Pf(i,new Ol(t.getProvider("auth-internal")),new ql(t.getProvider("app-check-internal")));return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s}),"PUBLIC")),(0,T.registerVersion)("@firebase/firestore","3.4.10",t),(0,T.registerVersion)("@firebase/firestore","3.4.10","esm2017")}();o=s("iyB0E");const rp=function(t=(0,T.getApp)()){return(0,T._getProvider)(t,"firestore").getImmediate()}(as.default),op=(0,ls.getAuth)(),ap={formWrap:document.querySelector(".form-auth"),loginForm:document.querySelector('[name="loginForm"]'),regForm:document.querySelector('[name="regForm"]'),regBtn:document.querySelector('[name="regBtn"]'),loginBtn:document.querySelector('[name="loginBtn"]'),libBtn:document.querySelector(".nav__library"),logoutBtn:document.querySelector('[name="logoutBtn"]'),homeBtn:document.querySelector(".nav__home")};ap.regForm.addEventListener("submit",(function(t){t.preventDefault();const e=t.target.elements.emailReg.value.trim(),n=t.target.elements.passwordReg.value.trim();if(""===e||""===n)return void(ap.regForm.querySelector(".error").innerHTML="Input fields are not filled");(0,ls.createUserWithEmailAndPassword)(op,e,n).then((async t=>{console.log(`New user registered ${t.user.email}`);try{await ip(Rf(rp,"users"),{email:e,password:n,watched:[],queue:[]});ap.regForm.querySelector(".error").innerHTML=""}catch(t){console.error("Error adding document: ",t)}})).catch((t=>{console.log(t.message),t.message.includes("email-already-in-use")?ap.regForm.querySelector(".error").innerHTML="Email already in use":t.message.includes("weak-password")&&(ap.regForm.querySelector(".error").innerHTML="Password should be at least 6 characters")}))})),ap.loginForm.addEventListener("submit",(async function(t){t.preventDefault();const e=t.target.elements.emailLogin.value.trim(),n=t.target.elements.passwordLogin.value.trim();if(""===e||""===n)return void(ap.loginForm.querySelector(".error").innerHTML="Input fields are not filled");await(0,ls.signInWithEmailAndPassword)(op,e,n).then((()=>{ap.loginForm.querySelector(".error").innerHTML=""})).catch((t=>{console.log(t),t.message.includes("wrong-password")?ap.loginForm.querySelector(".error").innerHTML="Wrong password":t.message.includes("user-not-found)")?ap.loginForm.querySelector(".error").innerHTML="User email not found":t.message.includes("too-many-requests)")&&(ap.loginForm.querySelector(".error").innerHTML=" Access to this account has been temporarily disabled due to many failed login attempts. You can immediately restore it by resetting your password or you can try again later.")}))})),ap.logoutBtn.addEventListener("click",(function(t){t.preventDefault(),(0,ls.signOut)(op)})),ap.loginBtn.addEventListener("click",(function(){ap.loginForm.classList.remove("is-hidden"),ap.formWrap.classList.remove("is-hidden"),ap.regForm.classList.add("is-hidden"),ap.homeBtn.classList.remove("nav__current"),ap.loginBtn.classList.add("nav__current"),ap.regBtn.classList.remove("nav__current")})),ap.regBtn.addEventListener("click",(function(){ap.regForm.classList.remove("is-hidden"),ap.formWrap.classList.remove("is-hidden"),ap.loginForm.classList.add("is-hidden"),ap.regBtn.classList.add("nav__current"),ap.loginBtn.classList.remove("nav__current")})),(0,ls.onAuthStateChanged)(op,(async t=>{t&&(ap.logoutBtn.classList.remove("is-hidden"),ap.libBtn.classList.remove("is-hidden"),ap.loginBtn.classList.add("is-hidden"),ap.regBtn.classList.add("is-hidden"),ap.regForm.classList.add("is-hidden"),ap.formWrap.classList.add("is-hidden"),ap.homeBtn.classList.add("nav__current")),t||(ap.loginBtn.classList.remove("is-hidden"),ap.regBtn.classList.remove("is-hidden"),ap.libBtn.classList.add("is-hidden"),ap.logoutBtn.classList.add("is-hidden"))}));m=s("idPZz");var lp=s("58AAY"),hp=s("1qskl");let cp;const up=document.querySelector(".movie-card-list");t(l).start(),(0,m.default)(up),o.default.fetchGenresList().then((t=>{cp=t})),o.default.fetchTrendData().then((e=>{const n=h(a(e.results,cp));up.insertAdjacentHTML("beforeend",n),t(l).done(),es(e.results);const i=document.querySelectorAll(".btn-watche"),s=document.querySelectorAll(".btn-queue");i.forEach((t=>{m.watchedArr.forEach((e=>{e.id===Number(t.dataset.id)&&(t.classList.add("pressed"),t.textContent="Remove from Watched")}))})),s.forEach((t=>{m.queueArr.forEach((e=>{e.id===Number(t.dataset.id)&&(t.classList.add("pressed"),t.textContent="Remove from Queue")}))})),p(e.total_pages,e.page)})).catch((t=>console.log(t))),up.addEventListener("click",(async function(t){if(!t.target.dataset.target)return;const e=t.target.dataset.id,n=await o.default.fetchFullMovieInfo(e);if("watched"===t.target.dataset.target){if(t.target.classList.toggle("pressed"),t.target.classList.contains("pressed"))return t.target.textContent="Remove from Watched",void(0,lp.default)(n,m.watchedArr,t.target.dataset.target);t.target.textContent="Add to Watched",(0,hp.default)(e,m.watchedArr,t.target.dataset.target)}if("queue"===t.target.dataset.target){if(t.target.classList.toggle("pressed"),t.target.classList.contains("pressed"))return t.target.textContent="Remove from Queue",void(0,lp.default)(n,m.queueArr,t.target.dataset.target);t.target.textContent="Add to Queue",(0,hp.default)(e,m.queueArr,t.target.dataset.target)}}));
//# sourceMappingURL=index.f42f9599.js.map
