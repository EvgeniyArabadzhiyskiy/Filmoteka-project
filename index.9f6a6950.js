 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ht="",xt(new Le("platform-logger",(function(e){return new vt(e)}),"PRIVATE")),xt(new Le("heartbeat",(function(e){return new qt(e)}),"PRIVATE")),Dt(mt,gt,Ht),Dt(mt,gt,"esm2017"),Dt("fire-js","");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
e(a)(e(o).mark((function t(n){var r,i,a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=n,e.next=3,Pn(r);case 3:return i=e.sent,a=i.installationEntry,(s=i.registrationPromise)?s.catch(console.error):Wn(r).catch(console.error),e.abrupt("return",a.fid);case 8:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function nr(){return nr=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
e(a)(e(o).mark((function t(n){var r,i,a,s=arguments;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=s.length>1&&void 0!==s[1]&&s[1],i=n,e.next=4,rr(i);case 4:return e.next=6,Wn(i,r);case 6:return a=e.sent,e.abrupt("return",a.token);case 8:case"end":return e.stop()}}),t)}))),nr.apply(this,arguments)}function rr(e){return ir.apply(this,arguments)}function ir(){return(ir=e(a)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,Pn(n);case 2:if(!(r=e.sent.registrationPromise)){e.next=6;break}return e.next=6,r;case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function ar(e){return tn.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Vr,jr,qr=function(){"use strict";function t(n){e(D)(this,t),this.app=n}return e(P)(t,[{key:"_delete",value:function(){return delete Br[this.app.options.appId],Promise.resolve()}}]),t}(),Br={},zr=[],Hr={},Wr="dataLayer",Kr="gtag",Gr=!1;function Qr(e,t,n){!function(){var e=[];if(ne()&&e.push("This is a browser extension environment."),ue()||e.push("Cookies are not available."),e.length>0){var t=e.map((function(e,t){return"(".concat(t+1,") ").concat(e)})).join(" "),n=Tr.create("invalid-analytics-context",{errorInfo:t});dr.warn(n.message)}}();var r,i,a=e.options.appId;if(!a)throw Tr.create("no-app-id");if(!e.options.apiKey){if(!e.options.measurementId)throw Tr.create("no-api-key");dr.warn('The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest'+" measurement ID for this Firebase app. Falling back to the measurement ID ".concat(e.options.measurementId)+' provided in the "measurementId" field in the local Firebase config.')}if(null!=Br[a])throw Tr.create("already-exists",{id:a});if(!Gr){r=Wr,i=[],Array.isArray(window[r])?i=window[r]:window[r]=i;var o=_r(Br,zr,Hr,Wr,Kr),s=o.wrappedGtag,u=o.gtagCore;jr=s,Vr=u,Gr=!0}return Br[a]=function(e,t,n,r,i,a,o){return Ur.apply(this,arguments)}(e,zr,Hr,t,Vr,Wr,n),new qr(e)}function Yr(){return(Yr=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ti=function(){"use strict";function t(n,r){e(D)(this,t),this.shortDelay=n,this.longDelay=r,yi(r>n,"Short delay should be less than long delay!"),this.isMobile=te()||re()}return e(P)(t,[{key:"get",value:function(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(wi()||ne()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(e,t){yi(e.emulator,"Emulator should always be set here");var n=e.emulator.url;return t?"".concat(n).concat(t.startsWith("/")?t.slice(1):t):n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zi(e){if(e)try{var t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(e){}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hi(){return Hi=e(a)(e(o).mark((function t(n){var r,i,a,s,u,c,l=arguments;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=l.length>1&&void 0!==l[1]&&l[1],i=Oe(n),e.next=4,i.getIdToken(r);case 4:return a=e.sent,vi((s=Ki(a))&&s.exp&&s.auth_time&&s.iat,i.auth,"internal-error"),u="object"==typeof s.firebase?s.firebase:void 0,c=null==u?void 0:u.sign_in_provider,e.abrupt("return",{claims:s,token:a,authTime:zi(Wi(s.auth_time)),issuedAtTime:zi(Wi(s.iat)),expirationTime:zi(Wi(s.exp)),signInProvider:c||null,signInSecondFactor:(null==u?void 0:u.sign_in_second_factor)||null});case 10:case"end":return e.stop()}}),t)}))),Hi.apply(this,arguments)}function Wi(e){return 1e3*Number(e)}function Ki(t){var n=e(M)(t.split("."),3),r=n[0],i=n[1],a=n[2];if(void 0===r||void 0===i||void 0===a)return ci("JWT malformed, contained fewer than 3 sections"),null;try{var o=X(i);return o?JSON.parse(o):(ci("Failed to decode base64 JWT payload"),null)}catch(e){return ci("Caught error parsing JWT payload as JSON",e),null}}function Gi(e,t){return Qi.apply(this,arguments)}function Qi(){return Qi=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
e(a)(e(o).mark((function t(n,r){var i;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Di(n,{},e(a)(e(o).mark((function t(){var i,a,s,u,c,l;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=Te({grant_type:"refresh_token",refresh_token:r}).slice(1),a=n.config,s=a.tokenApiHost,u=a.apiKey,c=Mi(n,s,"/v1/token","key=".concat(u)),e.next=5,n._getAdditionalHeaders();case 5:return(l=e.sent)["Content-Type"]="application/x-www-form-urlencoded",e.abrupt("return",Ei.fetch()(c,{method:"POST",headers:l,body:i}));case 8:case"end":return e.stop()}}),t)}))));case 2:return i=t.sent,t.abrupt("return",{accessToken:i.access_token,expiresIn:i.expires_in,refreshToken:i.refresh_token});case 4:case"end":return t.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ia(e){var t,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];switch(e){case"Browser":t=fa(ee());break;case"Worker":t="".concat(fa(ee()),"-").concat(e);break;default:t=e}var r=n.length?n.join(","):"FirebaseCore-web";return"".concat(t,"/","JsCore","/").concat(At,"/").concat(r)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ya=function(){"use strict";function t(n){var r,i,a,o,s,u;e(D)(this,t);var c=Ie(xe(n)),l=null!==(r=c.apiKey)&&void 0!==r?r:null,h=null!==(i=c.oobCode)&&void 0!==i?i:null,f=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(a=c.mode)&&void 0!==a?a:null);vi(l&&h&&f,"argument-error"),this.apiKey=l,this.operation=f,this.code=h,this.continueUrl=null!==(o=c.continueUrl)&&void 0!==o?o:null,this.languageCode=null!==(s=c.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(u=c.tenantId)&&void 0!==u?u:null}return e(P)(t,null,[{key:"parseLink",value:function(e){var n=function(e){var t=Ie(xe(e)).link,n=t?Ie(xe(t)).deep_link_id:null,r=Ie(xe(e)).deep_link_id;return(r?Ie(xe(r)).link:null)||r||n||t||e}(e);try{return new t(n)}catch(e){return null}}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
$o("rcb"),new Ti(3e4,6e4);var Zo="recaptcha";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var As=new Ti(3e4,6e4);function Rs(){var t=Do().___jsl,n=!0,r=!1,i=void 0;if(null==t?void 0:t.H)try{for(var a,o=Object.keys(t.H)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;if(t.H[s].r=t.H[s].r||[],t.H[s].L=t.H[s].L||[],t.H[s].r=e(L)(t.H[s].L),t.CP)for(var u=0;u<t.CP.length;u++)t.CP[u]=null}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}}var Ds=null;function Ps(e){return Ds=Ds||function(e){return new Promise((function(t,n){var r,i,a;function o(){Rs(),gapi.load("gapi.iframes",{callback:function(){t(gapi.iframes.getContext())},ontimeout:function(){Rs(),n(hi(e,"network-request-failed"))},timeout:As.get()})}if(null===(i=null===(r=Do().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=Do().gapi)||void 0===a?void 0:a.load)){var s=$o("iframefcb");return Do()[s]=function(){gapi.load?o():n(hi(e,"network-request-failed"))},Jo("https://apis.google.com/js/api.js?onload=".concat(s)).catch((function(e){return n(e)}))}o()}})).catch((function(e){throw Ds=null,e}))}(e),Ds}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var js={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},qs="_blank",Bs="http://localhost",zs=function(){"use strict";function t(n){e(D)(this,t),this.window=n,this.associatedEvent=null}return e(P)(t,[{key:"close",value:function(){if(this.window)try{this.window.close()}catch(e){}}}]),t}();function Hs(t,n,r){var i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:500,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:600,o=Math.max((window.screen.availHeight-a)/2,0).toString(),s=Math.max((window.screen.availWidth-i)/2,0).toString(),u="",c=Object.assign(Object.assign({},js),{width:i.toString(),height:a.toString(),top:o,left:s}),l=ee().toLowerCase();r&&(u=pa(l)?qs:r),da(l)&&(n=n||Bs,c.scrollbars="yes");var h=Object.entries(c).reduce((function(t,n){var r=e(M)(n,2),i=r[0],a=r[1];return"".concat(t).concat(i,"=").concat(a,",")}),"");if(wa(l)&&"_self"!==u)return Ws(n||"",u),new zs(null);var f=window.open(n||"",u,h);vi(f,t,"popup-blocked");try{f.focus()}catch(e){}return new zs(f)}function Ws(e,t){var n=document.createElement("a");n.href=e,n.target=t;var r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ks="__/auth/handler",Gs="emulator/auth/handler";function Qs(t,n,r,i,a,o){vi(t.config.authDomain,t,"auth-domain-config-required"),vi(t.config.apiKey,t,"invalid-api-key");var s={apiKey:t.config.apiKey,appName:t.name,authType:r,redirectUrl:i,v:At,eventId:a};if(n instanceof Ja){n.setDefaultLanguage(t.languageCode),s.providerId=n.providerId||"",ke(n.getCustomParameters())||(s.customParameters=JSON.stringify(n.getCustomParameters()));var u=!0,c=!1,l=void 0;try{for(var h,f=Object.entries(o||{})[Symbol.iterator]();!(u=(h=f.next()).done);u=!0){var d=e(M)(h.value,2),v=d[0],p=d[1];s[v]=p}}catch(e){c=!0,l=e}finally{try{u||null==f.return||f.return()}finally{if(c)throw l}}}if(n instanceof $a){var y=n.getScopes().filter((function(e){return""!==e}));y.length>0&&(s.scopes=y.join(","))}t.tenantId&&(s.tid=t.tenantId);var m,g,k=s,_=!0,w=!1,b=void 0;try{for(var T,I=Object.keys(k)[Symbol.iterator]();!(_=(T=I.next()).done);_=!0){var x=T.value;void 0===k[x]&&delete k[x]}}catch(e){w=!0,b=e}finally{try{_||null==I.return||I.return()}finally{if(w)throw b}}return"".concat((m=t,g=m.config,g.emulator?Ii(g,Gs):"https://".concat(g.authDomain,"/").concat(Ks)),"?").concat(Te(k).slice(1))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lu(e,t){for(var n in e)e.hasOwnProperty(n)&&t(n,e[n])}var Mu=function(e){H(!Cu(e),"Invalid JSON number");var t,n,r,i,a,o=1023;0===e?(n=0,r=0,t=1/e==-1/0?1:0):(t=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(n=(i=Math.min(Math.floor(Math.log(e)/Math.LN2),o))+o,r=Math.round(e*Math.pow(2,52-i)-Math.pow(2,52))):(n=0,r=Math.round(e/Math.pow(2,-1074))));var s=[];for(a=52;a;a-=1)s.push(r%2?1:0),r=Math.floor(r/2);for(a=11;a;a-=1)s.push(n%2?1:0),n=Math.floor(n/2);s.push(t?1:0),s.reverse();var u=s.join(""),c="";for(a=0;a<64;a+=8){var l=parseInt(u.substr(a,8),2).toString(16);1===l.length&&(l="0"+l),c+=l}return c.toLowerCase()};var Fu=new RegExp("^-?(0*)\\d{1,10}$"),Uu=-2147483648,Vu=2147483647,ju=function(e){if(Fu.test(e)){var t=Number(e);if(t>=Uu&&t<=Vu)return t}return null},qu=function(e){try{e()}catch(e){setTimeout((function(){var t=e.stack||"";throw Eu("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Bu=function(e,t){var n=setTimeout(e,t);return"object"==typeof n&&n.unref&&n.unref(),n},zu=function(){"use strict";function t(n,r){var i=this;e(D)(this,t),this.appName_=n,this.appCheckProvider=r,this.appCheck=null==r?void 0:r.getImmediate({optional:!0}),this.appCheck||null==r||r.get().then((function(e){return i.appCheck=e}))}return e(P)(t,[{key:"getToken",value:function(e){var t=this;return this.appCheck?this.appCheck.getToken(e):new Promise((function(n,r){var i=t;setTimeout((function(){i.appCheck?i.getToken(e).then(n,r):n(null)}),0)}))}},{key:"addTokenChangeListener",value:function(e){var t;null===(t=this.appCheckProvider)||void 0===t||t.get().then((function(t){return t.addTokenListener(e)}))}},{key:"notifyForInvalidToken",value:function(){Eu('Provided AppCheck credentials for the app named "'.concat(this.appName_,'" ')+"are invalid. This usually indicates your app was not initialized correctly.")}}]),t}(),Hu=function(){"use strict";function t(n,r,i){var a=this;e(D)(this,t),this.appName_=n,this.firebaseOptions_=r,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit((function(e){return a.auth_=e}))}return e(P)(t,[{key:"getToken",value:function(e){var t=this;return this.auth_?this.auth_.getToken(e).catch((function(e){return e&&"auth/token-not-initialized"===e.code?(bu("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e)})):new Promise((function(n,r){var i=t;setTimeout((function(){i.auth_?i.getToken(e).then(n,r):n(null)}),0)}))}},{key:"addTokenChangeListener",value:function(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((function(t){return t.addAuthTokenListener(e)}))}},{key:"removeTokenChangeListener",value:function(e){this.authProvider_.get().then((function(t){return t.removeAuthTokenListener(e)}))}},{key:"notifyForInvalidToken",value:function(){var e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Eu(e)}}]),t}(),Wu=function(){"use strict";function t(n){e(D)(this,t),this.accessToken=n}return e(P)(t,[{key:"getToken",value:function(e){return Promise.resolve({accessToken:this.accessToken})}},{key:"addTokenChangeListener",value:function(e){e(this.accessToken)}},{key:"removeTokenChangeListener",value:function(e){}},{key:"notifyForInvalidToken",value:function(){}}]),t}();Wu.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function zc(e,t){return Au(e.name,t.name)}function Hc(e,t){return Au(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Il(){return{value:null,children:new Map}}function xl(e,t,n){if(Tc(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{var r=yc(t);e.children.has(r)||e.children.set(r,Il()),xl(e.children.get(r),t=gc(t),n)}}function El(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach((function(e,n){t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Sl=Cl||(Cl={}))[Sl.OVERWRITE=0]="OVERWRITE",Sl[Sl.MERGE=1]="MERGE",Sl[Sl.ACK_USER_WRITE=2]="ACK_USER_WRITE",Sl[Sl.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";var Dl,Pl=function(){"use strict";function t(n,r,i){e(D)(this,t),this.path=n,this.affectedTree=r,this.revert=i,this.type=Cl.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}return e(P)(t,[{key:"operationForChild",value:function(e){if(Tc(this.path)){if(null!=this.affectedTree.value)return H(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;var n=this.affectedTree.subtree(new vc(e));return new t(pc(),n,this.revert)}return H(yc(this.path)===e,"operationForChild called for unrelated child."),new t(gc(this.path),this.affectedTree,this.revert)}}]),t}(),Ol=function(){"use strict";function t(n,r,i){e(D)(this,t),this.source=n,this.path=r,this.snap=i,this.type=Cl.OVERWRITE}return e(P)(t,[{key:"operationForChild",value:function(e){return Tc(this.path)?new t(this.source,pc(),this.snap.getImmediateChild(e)):new t(this.source,gc(this.path),this.snap)}}]),t}(),Ll=function(){"use strict";function t(n,r,i){e(D)(this,t),this.source=n,this.path=r,this.children=i,this.type=Cl.MERGE}return e(P)(t,[{key:"operationForChild",value:function(e){if(Tc(this.path)){var n=this.children.subtree(new vc(e));return n.isEmpty()?null:n.value?new Ol(this.source,pc(),n.value):new t(this.source,pc(),n)}return H(yc(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new t(this.source,gc(this.path),this.children)}},{key:"toString",value:function(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}]),t}(),Ml=function(){"use strict";function t(n,r,i){e(D)(this,t),this.node_=n,this.fullyInitialized_=r,this.filtered_=i}return e(P)(t,[{key:"isFullyInitialized",value:function(){return this.fullyInitialized_}},{key:"isFiltered",value:function(){return this.filtered_}},{key:"isCompleteForPath",value:function(e){if(Tc(e))return this.isFullyInitialized()&&!this.filtered_;var t=yc(e);return this.isCompleteForChild(t)}},{key:"isCompleteForChild",value:function(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}},{key:"getNode",value:function(){return this.node_}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fl(e,t,n,r,i,a){var o=r.filter((function(e){return e.type===n}));o.sort((function(t,n){return function(e,t,n){if(null==t.childName||null==n.childName)throw W("Should only compare child_ events.");var r=new Oc(t.childName,t.snapshotNode),i=new Oc(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var zl=function(){return Dl||(Dl=new Bc(Ru)),Dl},Hl=function(){"use strict";function t(n){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:zl();e(D)(this,t),this.value=n,this.children=r}return e(P)(t,[{key:"isEmpty",value:function(){return null===this.value&&this.children.isEmpty()}},{key:"findRootMostMatchingPathAndValue",value:function(e,t){if(null!=this.value&&t(this.value))return{path:pc(),value:this.value};if(Tc(e))return null;var n=yc(e),r=this.children.get(n);if(null!==r){var i=r.findRootMostMatchingPathAndValue(gc(e),t);return null!=i?{path:bc(new vc(n),i.path),value:i.value}:null}return null}},{key:"findRootMostValueAndPath",value:function(e){return this.findRootMostMatchingPathAndValue(e,(function(){return!0}))}},{key:"subtree",value:function(e){if(Tc(e))return this;var n=yc(e),r=this.children.get(n);return null!==r?r.subtree(gc(e)):new t(null)}},{key:"set",value:function(e,n){if(Tc(e))return new t(n,this.children);var r=yc(e),i=(this.children.get(r)||new t(null)).set(gc(e),n),a=this.children.insert(r,i);return new t(this.value,a)}},{key:"remove",value:function(e){if(Tc(e))return this.children.isEmpty()?new t(null):new t(null,this.children);var n=yc(e),r=this.children.get(n);if(r){var i,a=r.remove(gc(e));return i=a.isEmpty()?this.children.remove(n):this.children.insert(n,a),null===this.value&&i.isEmpty()?new t(null):new t(this.value,i)}return this}},{key:"get",value:function(e){if(Tc(e))return this.value;var t=yc(e),n=this.children.get(t);return n?n.get(gc(e)):null}},{key:"setTree",value:function(e,n){if(Tc(e))return n;var r,i=yc(e),a=(this.children.get(i)||new t(null)).setTree(gc(e),n);return r=a.isEmpty()?this.children.remove(i):this.children.insert(i,a),new t(this.value,r)}},{key:"fold",value:function(e){return this.fold_(pc(),e)}},{key:"fold_",value:function(e,t){var n={};return this.children.inorderTraversal((function(r,i){n[r]=i.fold_(bc(e,r),t)})),t(e,this.value,n)}},{key:"findOnPath",value:function(e,t){return this.findOnPath_(e,pc(),t)}},{key:"findOnPath_",value:function(e,t,n){var r=!!this.value&&n(t,this.value);if(r)return r;if(Tc(e))return null;var i=yc(e),a=this.children.get(i);return a?a.findOnPath_(gc(e),bc(t,i),n):null}},{key:"foreachOnPath",value:function(e,t){return this.foreachOnPath_(e,pc(),t)}},{key:"foreachOnPath_",value:function(e,n,r){if(Tc(e))return this;this.value&&r(n,this.value);var i=yc(e),a=this.children.get(i);return a?a.foreachOnPath_(gc(e),bc(n,i),r):new t(null)}},{key:"foreach",value:function(e){this.foreach_(pc(),e)}},{key:"foreach_",value:function(e,t){this.children.inorderTraversal((function(n,r){r.foreach_(bc(e,n),t)})),this.value&&t(e,this.value)}},{key:"foreachChild",value:function(e){this.children.inorderTraversal((function(t,n){n.value&&e(t,n.value)}))}}],[{key:"fromObject",value:function(e){var n=new t(null);return Lu(e,(function(e,t){n=n.set(new vc(e),t)})),n}}]),t}(),Wl=function(){"use strict";function t(n){e(D)(this,t),this.writeTree_=n}return e(P)(t,null,[{key:"empty",value:function(){return new t(new Hl(null))}}]),t}();function Kl(e,t,n){if(Tc(t))return new Wl(new Hl(n));var r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){var i=r.path,a=r.value,o=Ic(i,t);return a=a.updateChild(o,n),new Wl(e.writeTree_.set(i,a))}var s=new Hl(n),u=e.writeTree_.setTree(t,s);return new Wl(u)}function Gl(e,t,n){var r=e;return Lu(n,(function(e,n){r=Kl(r,bc(t,e),n)})),r}function Ql(e,t){if(Tc(t))return Wl.empty();var n=e.writeTree_.setTree(t,new Hl(null));return new Wl(n)}function Yl(e,t){return null!=Xl(e,t)}function Xl(e,t){var n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Ic(n.path,t)):null}function Jl(e){var t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(el,(function(e,n){t.push(new Oc(e,n))})):e.writeTree_.children.inorderTraversal((function(e,n){null!=n.value&&t.push(new Oc(e,n.value))})),t}function $l(e,t){if(Tc(t))return e;var n=Xl(e,t);return new Wl(null!=n?new Hl(n):e.writeTree_.subtree(t))}function Zl(e){return e.writeTree_.isEmpty()}function eh(e,t){return th(pc(),e.writeTree_,t)}function th(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);var r=null;return t.children.inorderTraversal((function(t,i){".priority"===t?(H(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=th(bc(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(bc(e,".priority"),r)),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(e,t,n,r,i){var a,o,s=new mh;if(n.type===Cl.OVERWRITE){var u=n;u.source.fromUser?a=Th(e,t,u.path,u.snap,r,i,s):(H(u.source.fromServer,"Unknown source."),o=u.source.tagged||t.serverCache.isFiltered()&&!Tc(u.path),a=bh(e,t,u.path,u.snap,r,i,o,s))}else if(n.type===Cl.MERGE){var c=n;c.source.fromUser?a=function(e,t,n,r,i,a,o){var s=t;return r.foreach((function(r,u){var c=bc(n,r);Ih(t,yc(c))&&(s=Th(e,s,c,u,i,a,o))})),r.foreach((function(r,u){var c=bc(n,r);Ih(t,yc(c))||(s=Th(e,s,c,u,i,a,o))})),s}(e,t,c.path,c.children,r,i,s):(H(c.source.fromServer,"Unknown source."),o=c.source.tagged||t.serverCache.isFiltered(),a=Eh(e,t,c.path,c.children,r,i,o,s))}else if(n.type===Cl.ACK_USER_WRITE){var l=n;a=l.revert?function(e,t,n,r,i,a){var o;if(null!=fh(r,n))return t;var s,u=new kh(r,t,i),c=t.eventCache.getNode();if(Tc(n)||".priority"===yc(n)){var l;if(t.serverCache.isFullyInitialized())l=ch(r,Bl(t));else{var h=t.serverCache.getNode();H(h instanceof ol,"serverChildren would be complete if leaf node"),l=lh(r,h)}s=e.filter.updateFullNode(c,l,a)}else{var f=yc(n),d=vh(r,f,t.serverCache);null==d&&t.serverCache.isCompleteForChild(f)&&(d=c.getImmediateChild(f)),(s=null!=d?e.filter.updateChild(c,f,d,gc(n),u,a):t.eventCache.getNode().hasChild(f)?e.filter.updateChild(c,f,ol.EMPTY_NODE,gc(n),u,a):c).isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ch(r,Bl(t))).isLeafNode()&&(s=e.filter.updateFullNode(s,o,a))}return o=t.serverCache.isFullyInitialized()||null!=fh(r,pc()),Vl(t,s,o,e.filter.filtersNodes())}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Rh;function Dh(e,t,n,r){var i=t.source.queryId;if(null!==i){var a=e.views.get(i);return H(null!=a,"SyncTree gave us an op for an invalid query."),Nh(a,t,n,r)}var o=[],s=!0,u=!1,c=void 0;try{for(var l,h=e.views.values()[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value;o=o.concat(Nh(f,t,n,r))}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}return o}function Ph(e,t){var n=null,r=!0,i=!1,a=void 0;try{for(var o,s=e.views.values()[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n=n||Sh(u,t)}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}return n}var Oh=function t(n){"use strict";e(D)(this,t),this.listenProvider_=n,this.syncPointTree_=new Hl(null),this.pendingWriteTree_={visibleWrites:Wl.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map};function Lh(e,t,n,r,i){return function(e,t,n,r,i){H(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=Kl(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?Vh(e,new Ol({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Mh(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=rh(e.pendingWriteTree_,t),i=ih(e.pendingWriteTree_,t);if(i){var a=new Hl(null);return null!=r.snap?a=a.set(pc(),!0):Lu(r.children,(function(e){a=a.set(new vc(e),!0)})),Vh(e,new Pl(r.path,a,n))}return[]}function Fh(e,t,n){return Vh(e,new Ol({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Uh(e,t,n){var r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,(function(e,n){var r=Ph(n,Ic(e,t));if(r)return r}));return uh(r,t,i,n,!0)}function Vh(e,t){return jh(t,e.syncPointTree_,null,nh(e.pendingWriteTree_,pc()))}function jh(e,t,n,r){if(Tc(e.path))return qh(e,t,n,r);var i=t.get(pc());null==n&&null!=i&&(n=Ph(i,pc()));var a=[],o=yc(e.path),s=e.operationForChild(o),u=t.children.get(o);if(u&&s){var c=n?n.getImmediateChild(o):null,l=ph(r,o);a=a.concat(jh(s,u,c,l))}return i&&(a=a.concat(Dh(i,e,r,n))),a}function qh(e,t,n,r){var i=t.get(pc());null==n&&null!=i&&(n=Ph(i,pc()));var a=[];return t.children.inorderTraversal((function(t,i){var o=n?n.getImmediateChild(t):null,s=ph(r,t),u=e.operationForChild(t);u&&(a=a.concat(qh(u,i,o,s)))})),i&&(a=a.concat(Dh(i,e,r,n))),a}function Bh(e,t){return e.tagToQueryMap.get(t)}function zh(e){var t=e.indexOf("$");return H(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new vc(e.substr(0,t))}}function Hh(e,t,n){var r=e.syncPointTree_.get(t);return H(r,"Missing sync point for query tag that we're tracking"),Dh(r,n,nh(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Hm.UNKNOWN_ID=-1;function Wm(e,t){var n=e.toTimestamp().seconds,r=e.toTimestamp().nanoseconds+1,i=Um.fromTimestamp(1e9===r?new Fm(n+1,0):new Fm(n,r));return new Gm(i,zm.empty(),t)}function Km(e){return new Gm(e.readTime,e.key,-1)}var Gm=function(){"use strict";function t(n,r,i){e(D)(this,t),this.readTime=n,this.documentKey=r,this.largestBatchId=i}return e(P)(t,null,[{key:"min",value:function(){return new t(Um.min(),zm.empty(),-1)}},{key:"max",value:function(){return new t(Um.max(),zm.empty(),-1)}}]),t}();function Qm(e,t){var n=e.readTime.compareTo(t.readTime);return 0!==n?n:0!==(n=zm.comparator(e.documentKey,t.documentKey))?n:Lm(e.largestBatchId,t.largestBatchId)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.code===Tm.FAILED_PRECONDITION&&n.message===Ym){e.next=2;break}throw n;case 2:ym("LocalStore","Unexpectedly lost primary lease");case 3:case"end":return e.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mg(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function gg(e){var t=e.mapValue.fields.__previous_value__;return mg(t)?gg(t):t}function kg(e){var t=vg(e.mapValue.fields.__local_write_time__.timestampValue);return new Fm(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function bg(e){return null==e}function Tg(e){return 0===e&&1/e==-1/0}function Ig(e){return"number"==typeof e&&Number.isInteger(e)&&!Tg(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var xg={mapValue:{fields:{__type__:{stringValue:"__max__"}}}};function Eg(e){return"nullValue"in e?0:"booleanValue"in e?1:"integerValue"in e||"doubleValue"in e?2:"timestampValue"in e?3:"stringValue"in e?5:"bytesValue"in e?6:"referenceValue"in e?7:"geoPointValue"in e?8:"arrayValue"in e?9:"mapValue"in e?mg(e)?4:Vg(e)?9007199254740991:10:_m()}function Cg(e,t){if(e===t)return!0;var n,r=Eg(e);if(r!==Eg(t))return!1;switch(r){case 0:case 9007199254740991:return!0;case 1:return e.booleanValue===t.booleanValue;case 4:return kg(e).isEqual(kg(t));case 3:return function(e,t){if("string"==typeof e.timestampValue&&"string"==typeof t.timestampValue&&e.timestampValue.length===t.timestampValue.length)return e.timestampValue===t.timestampValue;var n=vg(e.timestampValue),r=vg(t.timestampValue);return n.seconds===r.seconds&&n.nanos===r.nanos}(e,t);case 5:return e.stringValue===t.stringValue;case 6:return n=t,yg(e.bytesValue).isEqual(yg(n.bytesValue));case 7:return e.referenceValue===t.referenceValue;case 8:return function(e,t){return pg(e.geoPointValue.latitude)===pg(t.geoPointValue.latitude)&&pg(e.geoPointValue.longitude)===pg(t.geoPointValue.longitude)}(e,t);case 2:return function(e,t){if("integerValue"in e&&"integerValue"in t)return pg(e.integerValue)===pg(t.integerValue);if("doubleValue"in e&&"doubleValue"in t){var n=pg(e.doubleValue),r=pg(t.doubleValue);return n===r?Tg(n)===Tg(r):isNaN(n)&&isNaN(r)}return!1}(e,t);case 9:return Mm(e.arrayValue.values||[],t.arrayValue.values||[],Cg);case 10:return function(e,t){var n=e.mapValue.fields||{},r=t.mapValue.fields||{};if(ng(n)!==ng(r))return!1;for(var i in n)if(n.hasOwnProperty(i)&&(void 0===r[i]||!Cg(n[i],r[i])))return!1;return!0}(e,t);default:return _m()}}function Sg(e,t){return void 0!==(e.values||[]).find((function(e){return Cg(e,t)}))}function Ng(e,t){if(e===t)return 0;var n,r,i,a,o=Eg(e),s=Eg(t);if(o!==s)return Lm(o,s);switch(o){case 0:case 9007199254740991:return 0;case 1:return Lm(e.booleanValue,t.booleanValue);case 2:return r=t,i=pg((n=e).integerValue||n.doubleValue),a=pg(r.integerValue||r.doubleValue),i<a?-1:i>a?1:i===a?0:isNaN(i)?isNaN(a)?0:-1:1;case 3:return Ag(e.timestampValue,t.timestampValue);case 4:return Ag(kg(e),kg(t));case 5:return Lm(e.stringValue,t.stringValue);case 6:return function(e,t){var n=yg(e),r=yg(t);return n.compareTo(r)}(e.bytesValue,t.bytesValue);case 7:return function(e,t){for(var n=e.split("/"),r=t.split("/"),i=0;i<n.length&&i<r.length;i++){var a=Lm(n[i],r[i]);if(0!==a)return a}return Lm(n.length,r.length)}(e.referenceValue,t.referenceValue);case 8:return function(e,t){var n=Lm(pg(e.latitude),pg(t.latitude));return 0!==n?n:Lm(pg(e.longitude),pg(t.longitude))}(e.geoPointValue,t.geoPointValue);case 9:return function(e,t){for(var n=e.values||[],r=t.values||[],i=0;i<n.length&&i<r.length;++i){var a=Ng(n[i],r[i]);if(a)return a}return Lm(n.length,r.length)}(e.arrayValue,t.arrayValue);case 10:return function(e,t){if(e===xg.mapValue&&t===xg.mapValue)return 0;if(e===xg.mapValue)return 1;if(t===xg.mapValue)return-1;var n=e.fields||{},r=Object.keys(n),i=t.fields||{},a=Object.keys(i);r.sort(),a.sort();for(var o=0;o<r.length&&o<a.length;++o){var s=Lm(r[o],a[o]);if(0!==s)return s;var u=Ng(n[r[o]],i[a[o]]);if(0!==u)return u}return Lm(r.length,a.length)}(e.mapValue,t.mapValue);default:throw _m()}}function Ag(e,t){if("string"==typeof e&&"string"==typeof t&&e.length===t.length)return Lm(e,t);var n=vg(e),r=vg(t),i=Lm(n.seconds,r.seconds);return 0!==i?i:Lm(n.nanos,r.nanos)}function Rg(e){return Dg(e)}function Dg(e){var t,n,r,i;return"nullValue"in e?"null":"booleanValue"in e?""+e.booleanValue:"integerValue"in e?""+e.integerValue:"doubleValue"in e?""+e.doubleValue:"timestampValue"in e?(r=e.timestampValue,i=vg(r),"time(".concat(i.seconds,",").concat(i.nanos,")")):"stringValue"in e?e.stringValue:"bytesValue"in e?yg(e.bytesValue).toBase64():"referenceValue"in e?(n=e.referenceValue,zm.fromName(n).toString()):"geoPointValue"in e?"geo(".concat((t=e.geoPointValue).latitude,",").concat(t.longitude,")"):"arrayValue"in e?function(e){var t="[",n=!0,r=!0,i=!1,a=void 0;try{for(var o,s=(e.values||[])[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n?n=!1:t+=",",t+=Dg(u)}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}return t+"]"}(e.arrayValue):"mapValue"in e?function(e){var t=Object.keys(e.fields||{}).sort(),n="{",r=!0,i=!0,a=!1,o=void 0;try{for(var s,u=t[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;r?r=!1:n+=",",n+="".concat(c,":").concat(Dg(e.fields[c]))}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return n+"}"}(e.mapValue):_m()}function Pg(e){return!!e&&"integerValue"in e}function Og(e){return!!e&&"arrayValue"in e}function Lg(e){return!!e&&"nullValue"in e}function Mg(e){return!!e&&"doubleValue"in e&&isNaN(Number(e.doubleValue))}function Fg(e){return!!e&&"mapValue"in e}function Ug(e){if(e.geoPointValue)return{geoPointValue:Object.assign({},e.geoPointValue)};if(e.timestampValue&&"object"==typeof e.timestampValue)return{timestampValue:Object.assign({},e.timestampValue)};if(e.mapValue){var t={mapValue:{fields:{}}};return rg(e.mapValue.fields,(function(e,n){return t.mapValue.fields[e]=Ug(n)})),t}if(e.arrayValue){for(var n={arrayValue:{values:[]}},r=0;r<(e.arrayValue.values||[]).length;++r)n.arrayValue.values[r]=Ug(e.arrayValue.values[r]);return n}return Object.assign({},e)}function Vg(e){return"__max__"===(((e.mapValue||{}).fields||{}).__type__||{}).stringValue}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var jg=function(){"use strict";function t(n){e(D)(this,t),this.value=n}return e(P)(t,[{key:"field",value:function(e){if(e.isEmpty())return this.value;for(var t=this.value,n=0;n<e.length-1;++n)if(!Fg(t=(t.mapValue.fields||{})[e.get(n)]))return null;return(t=(t.mapValue.fields||{})[e.lastSegment()])||null}},{key:"set",value:function(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ug(t)}},{key:"setAll",value:function(e){var t=this,n=Bm.emptyPath(),r={},i=[];e.forEach((function(e,a){if(!n.isImmediateParentOf(a)){var o=t.getFieldsMap(n);t.applyChanges(o,r,i),r={},i=[],n=a.popLast()}e?r[a.lastSegment()]=Ug(e):i.push(a.lastSegment())}));var a=this.getFieldsMap(n);this.applyChanges(a,r,i)}},{key:"delete",value:function(e){var t=this.field(e.popLast());Fg(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}},{key:"isEqual",value:function(e){return Cg(this.value,e.value)}},{key:"getFieldsMap",value:function(e){var t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(var n=0;n<e.length;++n){var r=t.mapValue.fields[e.get(n)];Fg(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}},{key:"applyChanges",value:function(e,t,n){rg(t,(function(t,n){return e[t]=n}));var r=!0,i=!1,a=void 0;try{for(var o,s=n[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;delete e[u]}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}}},{key:"clone",value:function(){return new t(Ug(this.value))}}],[{key:"empty",value:function(){return new t({mapValue:{}})}}]),t}();function qg(e){var t=[];return rg(e.fields,(function(e,n){var r=new Bm([e]);if(Fg(n)){var i=qg(n.mapValue).fields,a=!0,o=!1,s=void 0;if(0===i.length)t.push(r);else try{for(var u,c=i[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;t.push(r.child(l))}}catch(e){o=!0,s=e}finally{try{a||null==c.return||c.return()}finally{if(o)throw s}}}else t.push(r)})),new lg(t)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hg(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[],r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:[],i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,a=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,o=arguments.length>6&&void 0!==arguments[6]?arguments[6]:null;return new zg(e,t,n,r,i,a,o)}function Wg(e){var t=bm(e);if(null===t.ut){var n=t.path.canonicalString();null!==t.collectionGroup&&(n+="|cg:"+t.collectionGroup),n+="|f:",n+=t.filters.map((function(e){var t;return(t=e).field.canonicalString()+t.op.toString()+Rg(t.value)})).join(","),n+="|ob:",n+=t.orderBy.map((function(e){return(t=e).field.canonicalString()+t.dir;var t})).join(","),bg(t.limit)||(n+="|l:",n+=t.limit),t.startAt&&(n+="|lb:",n+=t.startAt.inclusive?"b:":"a:",n+=t.startAt.position.map((function(e){return Rg(e)})).join(",")),t.endAt&&(n+="|ub:",n+=t.endAt.inclusive?"a:":"b:",n+=t.endAt.position.map((function(e){return Rg(e)})).join(",")),t.ut=n}return t.ut}function Kg(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(var n=0;n<e.orderBy.length;n++)if(!ak(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(var r=0;r<e.filters.length;r++)if(i=e.filters[r],a=t.filters[r],i.op!==a.op||!i.field.isEqual(a.field)||!Cg(i.value,a.value))return!1;var i,a;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!sk(e.startAt,t.startAt)&&sk(e.endAt,t.endAt)}function Gg(e){return zm.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}var Qg=function(t){"use strict";e(U)(r,(function t(){e(D)(this,t)}));var n=e(j)(r);function r(t,i,a){var o;return e(D)(this,r),(o=n.call(this)).field=t,o.op=i,o.value=a,e($f)(o)}return e(P)(r,[{key:"matches",value:function(e){var t=e.data.field(this.field);return"!="===this.op?null!==t&&this.at(Ng(t,this.value)):null!==t&&Eg(this.value)===Eg(t)&&this.at(Ng(t,this.value))}},{key:"at",value:function(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return _m()}}},{key:"ht",value:function(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}}],[{key:"create",value:function(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.ct(e,t,n):new Yg(e,t,n):"array-contains"===t?new Zg(e,n):"in"===t?new ek(e,n):"not-in"===t?new tk(e,n):"array-contains-any"===t?new nk(e,n):new r(e,t,n)}},{key:"ct",value:function(e,t,n){return"in"===t?new Xg(e,n):new Jg(e,n)}}]),r}(),Yg=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a){var o;return e(D)(this,r),(o=n.call(this,t,i,a)).key=zm.fromName(a.referenceValue),e($f)(o)}return e(P)(r,[{key:"matches",value:function(e){var t=zm.comparator(e.key,this.key);return this.at(t)}}]),r}(Qg),Xg=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){var a;return e(D)(this,r),(a=n.call(this,t,"in",i)).keys=$g("in",i),e($f)(a)}return e(P)(r,[{key:"matches",value:function(e){return this.keys.some((function(t){return t.isEqual(e.key)}))}}]),r}(Qg),Jg=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){var a;return e(D)(this,r),(a=n.call(this,t,"not-in",i)).keys=$g("not-in",i),e($f)(a)}return e(P)(r,[{key:"matches",value:function(e){return!this.keys.some((function(t){return t.isEqual(e.key)}))}}]),r}(Qg);function $g(e,t){var n;return((null===(n=t.arrayValue)||void 0===n?void 0:n.values)||[]).map((function(e){return zm.fromName(e.referenceValue)}))}var Zg=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){return e(D)(this,r),n.call(this,t,"array-contains",i)}return e(P)(r,[{key:"matches",value:function(e){var t=e.data.field(this.field);return Og(t)&&Sg(t.arrayValue,this.value)}}]),r}(Qg),ek=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){return e(D)(this,r),n.call(this,t,"in",i)}return e(P)(r,[{key:"matches",value:function(e){var t=e.data.field(this.field);return null!==t&&Sg(this.value.arrayValue,t)}}]),r}(Qg),tk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){return e(D)(this,r),n.call(this,t,"not-in",i)}return e(P)(r,[{key:"matches",value:function(e){if(Sg(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;var t=e.data.field(this.field);return null!==t&&!Sg(this.value.arrayValue,t)}}]),r}(Qg),nk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){return e(D)(this,r),n.call(this,t,"array-contains-any",i)}return e(P)(r,[{key:"matches",value:function(e){var t=this,n=e.data.field(this.field);return!(!Og(n)||!n.arrayValue.values)&&n.arrayValue.values.some((function(e){return Sg(t.value.arrayValue,e)}))}}]),r}(Qg),rk=function t(n,r){"use strict";e(D)(this,t),this.position=n,this.inclusive=r},ik=function t(n){"use strict";var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"asc";e(D)(this,t),this.field=n,this.dir=r};function ak(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}function ok(e,t,n){for(var r=0,i=0;i<e.position.length;i++){var a=t[i],o=e.position[i];if(r=a.field.isKeyField()?zm.comparator(zm.fromName(o.referenceValue),n.key):Ng(o,n.data.field(a.field)),"desc"===a.dir&&(r*=-1),0!==r)break}return r}function sk(e,t){if(null===e)return null===t;if(null===t)return!1;if(e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(var n=0;n<e.position.length;n++)if(!Cg(e.position[n],t.position[n]))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var uk=function t(n){"use strict";var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[],a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:[],o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:"F",u=arguments.length>6&&void 0!==arguments[6]?arguments[6]:null,c=arguments.length>7&&void 0!==arguments[7]?arguments[7]:null;e(D)(this,t),this.path=n,this.collectionGroup=r,this.explicitOrderBy=i,this.filters=a,this.limit=o,this.limitType=s,this.startAt=u,this.endAt=c,this.lt=null,this.ft=null,this.startAt,this.endAt};function ck(e,t,n,r,i,a,o,s){return new uk(e,t,n,r,i,a,o,s)}function lk(e){return new uk(e)}function hk(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}function fk(e){var t=!0,n=!1,r=void 0;try{for(var i,a=e.filters[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;if(o.ht())return o.field}}catch(e){n=!0,r=e}finally{try{t||null==a.return||a.return()}finally{if(n)throw r}}return null}function dk(e){return null!==e.collectionGroup}function vk(e){var t=bm(e);if(null===t.lt){t.lt=[];var n=fk(t),r=hk(t);if(null!==n&&null===r)n.isKeyField()||t.lt.push(new ik(n)),t.lt.push(new ik(Bm.keyField(),"asc"));else{var i=!1,a=!0,o=!1,s=void 0;try{for(var u,c=t.explicitOrderBy[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;t.lt.push(l),l.field.isKeyField()&&(i=!0)}}catch(e){o=!0,s=e}finally{try{a||null==c.return||c.return()}finally{if(o)throw s}}if(!i){var h=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.lt.push(new ik(Bm.keyField(),h))}}}return t.lt}function pk(e){var t=bm(e);if(!t.ft)if("F"===t.limitType)t.ft=Hg(t.path,t.collectionGroup,vk(t),t.filters,t.limit,t.startAt,t.endAt);else{var n=[],r=!0,i=!1,a=void 0;try{for(var o,s=vk(t)[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value,c="desc"===u.dir?"asc":"desc";n.push(new ik(u.field,c))}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}var l=t.endAt?new rk(t.endAt.position,t.endAt.inclusive):null,h=t.startAt?new rk(t.startAt.position,t.startAt.inclusive):null;t.ft=Hg(t.path,t.collectionGroup,n,t.filters,t.limit,l,h)}return t.ft}function yk(e,t,n){return new uk(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function mk(e,t){return Kg(pk(e),pk(t))&&e.limitType===t.limitType}function gk(e){return"".concat(Wg(pk(e)),"|lt:").concat(e.limitType)}function kk(e){return"Query(target=".concat((t=pk(e),n=t.path.canonicalString(),null!==t.collectionGroup&&(n+=" collectionGroup="+t.collectionGroup),t.filters.length>0&&(n+=", filters: [".concat(t.filters.map((function(e){var t;return"".concat((t=e).field.canonicalString()," ").concat(t.op," ").concat(Rg(t.value))})).join(", "),"]")),bg(t.limit)||(n+=", limit: "+t.limit),t.orderBy.length>0&&(n+=", orderBy: [".concat(t.orderBy.map((function(e){return"".concat((t=e).field.canonicalString()," (").concat(t.dir,")");var t})).join(", "),"]")),t.startAt&&(n+=", startAt: ",n+=t.startAt.inclusive?"b:":"a:",n+=t.startAt.position.map((function(e){return Rg(e)})).join(",")),t.endAt&&(n+=", endAt: ",n+=t.endAt.inclusive?"a:":"b:",n+=t.endAt.position.map((function(e){return Rg(e)})).join(",")),"Target(".concat(n,")")),"; limitType=").concat(e.limitType,")");var t,n}function _k(e,t){return t.isFoundDocument()&&(i=e,o=(a=t).key.path,null!==i.collectionGroup?a.key.hasCollectionId(i.collectionGroup)&&i.path.isPrefixOf(o):zm.isDocumentKey(i.path)?i.path.isEqual(o):i.path.isImmediateParentOf(o))&&function(e,t){var n=!0,r=!1,i=void 0;try{for(var a,o=e.explicitOrderBy[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;if(!s.field.isKeyField()&&null===t.data.field(s.field))return!1}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}return!0}(e,t)&&function(e,t){var n=!0,r=!1,i=void 0;try{for(var a,o=e.filters[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){if(!a.value.matches(t))return!1}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}return!0}(e,t)&&(r=t,!((n=e).startAt&&!function(e,t,n){var r=ok(e,t,n);return e.inclusive?r<=0:r<0}(n.startAt,vk(n),r)||n.endAt&&!function(e,t,n){var r=ok(e,t,n);return e.inclusive?r>=0:r>0}(n.endAt,vk(n),r)));var n,r,i,a,o}function wk(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function bk(e){return function(t,n){var r=!1,i=!0,a=!1,o=void 0;try{for(var s,u=vk(e)[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value,l=Tk(c,t,n);if(0!==l)return l;r=r||c.field.isKeyField()}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return 0}}function Tk(e,t,n){var r,i,a,o,s=e.field.isKeyField()?zm.comparator(t.key,n.key):(r=e.field,i=n,a=t.data.field(r),o=i.data.field(r),null!==a&&null!==o?Ng(a,o):_m());switch(e.dir){case"asc":return s;case"desc":return-1*s;default:return _m()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ik(e,t){if(e.dt){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Tg(t)?"-0":t}}function xk(e){return{integerValue:""+e}}function Ek(e,t){return Ig(t)?xk(t):Ik(e,t)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ck=function t(){"use strict";e(D)(this,t),this._=void 0};function Sk(e,t,n){return e instanceof Rk?(i=t,a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:(r=n).seconds,nanos:r.nanoseconds}}}},i&&(a.fields.__previous_value__=i),{mapValue:a}):e instanceof Dk?Pk(e,t):e instanceof Ok?Lk(e,t):function(e,t){var n=Ak(e,t),r=Fk(n)+Fk(e._t);return Pg(n)&&Pg(e._t)?xk(r):Ik(e.wt,r)}(e,t);var r,i,a}function Nk(e,t,n){return e instanceof Dk?Pk(e,t):e instanceof Ok?Lk(e,t):n}function Ak(e,t){var n,r;return e instanceof Mk?Pg(n=t)||(r=n)&&"doubleValue"in r?t:{integerValue:0}:null}var Rk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(){return e(D)(this,r),n.apply(this,arguments)}return r}(Ck),Dk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this)).elements=t,e($f)(i)}return r}(Ck);function Pk(e,t){var n=Uk(t),r=!0,i=!1,a=void 0;try{for(var o,s=function(e,t){var r=t.value;n.some((function(e){return Cg(e,r)}))||n.push(r)},u=e.elements[Symbol.iterator]();!(r=(o=u.next()).done);r=!0)s(0,o)}catch(e){i=!0,a=e}finally{try{r||null==u.return||u.return()}finally{if(i)throw a}}return{arrayValue:{values:n}}}var Ok=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this)).elements=t,e($f)(i)}return r}(Ck);function Lk(e,t){var n=Uk(t),r=!0,i=!1,a=void 0;try{for(var o,s=function(e,t){var r=t.value;n=n.filter((function(e){return!Cg(e,r)}))},u=e.elements[Symbol.iterator]();!(r=(o=u.next()).done);r=!0)s(0,o)}catch(e){i=!0,a=e}finally{try{r||null==u.return||u.return()}finally{if(i)throw a}}return{arrayValue:{values:n}}}var Mk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){var a;return e(D)(this,r),(a=n.call(this)).wt=t,a._t=i,e($f)(a)}return r}(Ck);function Fk(e){return pg(e.integerValue||e.doubleValue)}function Uk(e){return Og(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Vk=function t(n,r){"use strict";e(D)(this,t),this.version=n,this.transformResults=r},jk=function(){"use strict";function t(n,r){e(D)(this,t),this.updateTime=n,this.exists=r}return e(P)(t,[{key:"isNone",get:function(){return void 0===this.updateTime&&void 0===this.exists}},{key:"isEqual",value:function(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}],[{key:"none",value:function(){return new t}},{key:"exists",value:function(e){return new t(void 0,e)}},{key:"updateTime",value:function(e){return new t(e)}}]),t}();function qk(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}var Bk=function t(){"use strict";e(D)(this,t)};function zk(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new t_(e.key,jk.none()):new Qk(e.key,e.data,jk.none());var n=e.data,r=jg.empty(),i=new ug(Bm.comparator),a=!0,o=!1,s=void 0;try{for(var u,c=t.fields[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;if(!i.has(l)){var h=n.field(l);null===h&&l.length>1&&(l=l.popLast(),h=n.field(l)),null===h?r.delete(l):r.set(l,h),i=i.add(l)}}}catch(e){o=!0,s=e}finally{try{a||null==c.return||c.return()}finally{if(o)throw s}}return new Yk(e.key,r,new lg(i.toArray()),jk.none())}function Hk(e,t,n){var r,i,a,o,s;e instanceof Qk?(i=t,a=n,o=(r=e).value.clone(),s=Jk(r.fieldTransforms,i,a.transformResults),o.setAll(s),i.convertToFoundDocument(a.version,o).setHasCommittedMutations()):e instanceof Yk?function(e,t,n){if(qk(e.precondition,t)){var r=Jk(e.fieldTransforms,t,n.transformResults),i=t.data;i.setAll(Xk(e)),i.setAll(r),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}else t.convertToUnknownDocument(n.version)}(e,t,n):function(e,t,n){t.convertToNoDocument(n.version).setHasCommittedMutations()}(0,t,n)}function Wk(e,t,n,r){return e instanceof Qk?function(e,t,n,r){if(!qk(e.precondition,t))return n;var i=e.value.clone(),a=$k(e.fieldTransforms,r,t);return i.setAll(a),t.convertToFoundDocument(t.version,i).setHasLocalMutations(),null}(e,t,n,r):e instanceof Yk?function(e,t,n,r){if(!qk(e.precondition,t))return n;var i=$k(e.fieldTransforms,r,t),a=t.data;return a.setAll(Xk(e)),a.setAll(i),t.convertToFoundDocument(t.version,a).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map((function(e){return e.field})))}(e,t,n,r):(i=t,a=n,qk(e.precondition,i)?(i.convertToNoDocument(i.version).setHasLocalMutations(),null):a);var i,a}function Kk(e,t){var n=null,r=!0,i=!1,a=void 0;try{for(var o,s=e.fieldTransforms[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value,c=t.data.field(u.field),l=Ak(u.transform,c||null);null!=l&&(null===n&&(n=jg.empty()),n.set(u.field,l))}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}return n||null}function Gk(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,r=t.fieldTransforms,!!(void 0===n&&void 0===r||n&&r&&Mm(n,r,(function(e,t){return function(e,t){return e.field.isEqual(t.field)&&(n=e.transform,r=t.transform,n instanceof Dk&&r instanceof Dk||n instanceof Ok&&r instanceof Ok?Mm(n.elements,r.elements,Cg):n instanceof Mk&&r instanceof Mk?Cg(n._t,r._t):n instanceof Rk&&r instanceof Rk);var n,r}(e,t)}))))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask));var n,r}var Qk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a){var o,s=arguments.length>3&&void 0!==arguments[3]?arguments[3]:[];return e(D)(this,r),(o=n.call(this)).key=t,o.value=i,o.precondition=a,o.fieldTransforms=s,o.type=0,e($f)(o)}return e(P)(r,[{key:"getFieldMask",value:function(){return null}}]),r}(Bk),Yk=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a,o){var s,u=arguments.length>4&&void 0!==arguments[4]?arguments[4]:[];return e(D)(this,r),(s=n.call(this)).key=t,s.data=i,s.fieldMask=a,s.precondition=o,s.fieldTransforms=u,s.type=1,e($f)(s)}return e(P)(r,[{key:"getFieldMask",value:function(){return this.fieldMask}}]),r}(Bk);function Xk(e){var t=new Map;return e.fieldMask.fields.forEach((function(n){if(!n.isEmpty()){var r=e.data.field(n);t.set(n,r)}})),t}function Jk(e,t,n){var r=new Map;wm(e.length===n.length);for(var i=0;i<n.length;i++){var a=e[i],o=a.transform,s=t.data.field(a.field);r.set(a.field,Nk(o,s,n[i]))}return r}function $k(e,t,n){var r=new Map,i=!0,a=!1,o=void 0;try{for(var s,u=e[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value,l=c.transform,h=n.data.field(c.field);r.set(c.field,Sk(l,h,t))}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return r}var Zk,e_,t_=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){var a;return e(D)(this,r),(a=n.call(this)).key=t,a.precondition=i,a.type=2,a.fieldTransforms=[],e($f)(a)}return e(P)(r,[{key:"getFieldMask",value:function(){return null}}]),r}(Bk),n_=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i){var a;return e(D)(this,r),(a=n.call(this)).key=t,a.precondition=i,a.type=3,a.fieldTransforms=[],e($f)(a)}return e(P)(r,[{key:"getFieldMask",value:function(){return null}}]),r}(Bk),r_=function t(n){"use strict";e(D)(this,t),this.count=n};function i_(e){switch(e){default:return _m();case Tm.CANCELLED:case Tm.UNKNOWN:case Tm.DEADLINE_EXCEEDED:case Tm.RESOURCE_EXHAUSTED:case Tm.INTERNAL:case Tm.UNAVAILABLE:case Tm.UNAUTHENTICATED:return!1;case Tm.INVALID_ARGUMENT:case Tm.NOT_FOUND:case Tm.ALREADY_EXISTS:case Tm.PERMISSION_DENIED:case Tm.FAILED_PRECONDITION:case Tm.ABORTED:case Tm.OUT_OF_RANGE:case Tm.UNIMPLEMENTED:case Tm.DATA_LOSS:return!0}}function a_(e){if(void 0===e)return mm("GRPC error has no .code"),Tm.UNKNOWN;switch(e){case Zk.OK:return Tm.OK;case Zk.CANCELLED:return Tm.CANCELLED;case Zk.UNKNOWN:return Tm.UNKNOWN;case Zk.DEADLINE_EXCEEDED:return Tm.DEADLINE_EXCEEDED;case Zk.RESOURCE_EXHAUSTED:return Tm.RESOURCE_EXHAUSTED;case Zk.INTERNAL:return Tm.INTERNAL;case Zk.UNAVAILABLE:return Tm.UNAVAILABLE;case Zk.UNAUTHENTICATED:return Tm.UNAUTHENTICATED;case Zk.INVALID_ARGUMENT:return Tm.INVALID_ARGUMENT;case Zk.NOT_FOUND:return Tm.NOT_FOUND;case Zk.ALREADY_EXISTS:return Tm.ALREADY_EXISTS;case Zk.PERMISSION_DENIED:return Tm.PERMISSION_DENIED;case Zk.FAILED_PRECONDITION:return Tm.FAILED_PRECONDITION;case Zk.ABORTED:return Tm.ABORTED;case Zk.OUT_OF_RANGE:return Tm.OUT_OF_RANGE;case Zk.UNIMPLEMENTED:return Tm.UNIMPLEMENTED;case Zk.DATA_LOSS:return Tm.DATA_LOSS;default:return _m()}}(e_=Zk||(Zk={}))[e_.OK=0]="OK",e_[e_.CANCELLED=1]="CANCELLED",e_[e_.UNKNOWN=2]="UNKNOWN",e_[e_.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",e_[e_.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",e_[e_.NOT_FOUND=5]="NOT_FOUND",e_[e_.ALREADY_EXISTS=6]="ALREADY_EXISTS",e_[e_.PERMISSION_DENIED=7]="PERMISSION_DENIED",e_[e_.UNAUTHENTICATED=16]="UNAUTHENTICATED",e_[e_.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",e_[e_.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",e_[e_.ABORTED=10]="ABORTED",e_[e_.OUT_OF_RANGE=11]="OUT_OF_RANGE",e_[e_.UNIMPLEMENTED=12]="UNIMPLEMENTED",e_[e_.INTERNAL=13]="INTERNAL",e_[e_.UNAVAILABLE=14]="UNAVAILABLE",e_[e_.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var o_=function(){"use strict";function t(n,r){e(D)(this,t),this.mapKeyFn=n,this.equalsFn=r,this.inner={},this.innerSize=0}return e(P)(t,[{key:"get",value:function(t){var n=this.mapKeyFn(t),r=this.inner[n];if(void 0!==r){var i=!0,a=!1,o=void 0;try{for(var s,u=r[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=e(M)(s.value,2),l=c[0],h=c[1];if(this.equalsFn(l,t))return h}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}}}},{key:"has",value:function(e){return void 0!==this.get(e)}},{key:"set",value:function(e,t){var n=this.mapKeyFn(e),r=this.inner[n];if(void 0===r)return this.inner[n]=[[e,t]],void this.innerSize++;for(var i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return void(r[i]=[e,t]);r.push([e,t]),this.innerSize++}},{key:"delete",value:function(e){var t=this.mapKeyFn(e),n=this.inner[t];if(void 0===n)return!1;for(var r=0;r<n.length;r++)if(this.equalsFn(n[r][0],e))return 1===n.length?delete this.inner[t]:n.splice(r,1),this.innerSize--,!0;return!1}},{key:"forEach",value:function(t){rg(this.inner,(function(n,r){var i=!0,a=!1,o=void 0;try{for(var s,u=r[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=e(M)(s.value,2),l=c[0],h=c[1];t(l,h)}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}}))}},{key:"isEmpty",value:function(){return ig(this.inner)}},{key:"size",value:function(){return this.innerSize}}]),t}(),s_=new ag(zm.comparator);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u_(){return s_}var c_=new ag(zm.comparator);function l_(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];var r=c_,i=!0,a=!1,o=void 0;try{for(var s,u=t[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;r=r.insert(c.key,c)}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return r}function h_(e){var t=c_;return e.forEach((function(e,n){return t=t.insert(e,n.overlayedDocument)})),t}function f_(){return v_()}function d_(){return v_()}function v_(){return new o_((function(e){return e.toString()}),(function(e,t){return e.isEqual(t)}))}var p_=new ag(zm.comparator),y_=new ug(zm.comparator);function m_(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];var r=y_,i=!0,a=!1,o=void 0;try{for(var s,u=t[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;r=r.add(c)}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return r}var g_=new ug(Lm);function k_(){return g_}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var __=function(){"use strict";function t(n,r,i,a,o){e(D)(this,t),this.snapshotVersion=n,this.targetChanges=r,this.targetMismatches=i,this.documentUpdates=a,this.resolvedLimboDocuments=o}return e(P)(t,null,[{key:"createSynthesizedRemoteEventForCurrentChange",value:function(e,n){var r=new Map;return r.set(e,w_.createSynthesizedTargetChangeForCurrentChange(e,n)),new t(Um.min(),r,k_(),u_(),m_())}}]),t}(),w_=function(){"use strict";function t(n,r,i,a,o){e(D)(this,t),this.resumeToken=n,this.current=r,this.addedDocuments=i,this.modifiedDocuments=a,this.removedDocuments=o}return e(P)(t,null,[{key:"createSynthesizedTargetChangeForCurrentChange",value:function(e,n){return new t(fg.EMPTY_BYTE_STRING,n,m_(),m_(),m_())}}]),t}(),b_=function t(n,r,i,a){"use strict";e(D)(this,t),this.gt=n,this.removedTargetIds=r,this.key=i,this.yt=a},T_=function t(n,r){"use strict";e(D)(this,t),this.targetId=n,this.It=r},I_=function t(n,r){"use strict";var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:fg.EMPTY_BYTE_STRING,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;e(D)(this,t),this.state=n,this.targetIds=r,this.resumeToken=i,this.cause=a},x_=function(){"use strict";function t(){e(D)(this,t),this.Tt=0,this.Et=S_(),this.At=fg.EMPTY_BYTE_STRING,this.Rt=!1,this.bt=!0}return e(P)(t,[{key:"current",get:function(){return this.Rt}},{key:"resumeToken",get:function(){return this.At}},{key:"Pt",get:function(){return 0!==this.Tt}},{key:"vt",get:function(){return this.bt}},{key:"Vt",value:function(e){e.approximateByteSize()>0&&(this.bt=!0,this.At=e)}},{key:"St",value:function(){var e=m_(),t=m_(),n=m_();return this.Et.forEach((function(r,i){switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:_m()}})),new w_(this.At,this.Rt,e,t,n)}},{key:"Dt",value:function(){this.bt=!1,this.Et=S_()}},{key:"Ct",value:function(e,t){this.bt=!0,this.Et=this.Et.insert(e,t)}},{key:"xt",value:function(e){this.bt=!0,this.Et=this.Et.remove(e)}},{key:"Nt",value:function(){this.Tt+=1}},{key:"kt",value:function(){this.Tt-=1}},{key:"Ot",value:function(){this.bt=!0,this.Rt=!0}}]),t}(),E_=function(){"use strict";function t(n){e(D)(this,t),this.Mt=n,this.Ft=new Map,this.$t=u_(),this.Bt=C_(),this.Lt=new ug(Lm)}return e(P)(t,[{key:"Ut",value:function(e){var t=!0,n=!1,r=void 0;try{for(var i,a=e.gt[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;e.yt&&e.yt.isFoundDocument()?this.qt(o,e.yt):this.Kt(o,e.key,e.yt)}}catch(e){n=!0,r=e}finally{try{t||null==a.return||a.return()}finally{if(n)throw r}}var s=!0,u=!1,c=void 0;try{for(var l,h=e.removedTargetIds[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value;this.Kt(f,e.key,e.yt)}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}}},{key:"Gt",value:function(e){var t=this;this.forEachTarget(e,(function(n){var r=t.Qt(n);switch(e.state){case 0:t.jt(n)&&r.Vt(e.resumeToken);break;case 1:r.kt(),r.Pt||r.Dt(),r.Vt(e.resumeToken);break;case 2:r.kt(),r.Pt||t.removeTarget(n);break;case 3:t.jt(n)&&(r.Ot(),r.Vt(e.resumeToken));break;case 4:t.jt(n)&&(t.Wt(n),r.Vt(e.resumeToken));break;default:_m()}}))}},{key:"forEachTarget",value:function(e,t){var n=this;e.targetIds.length>0?e.targetIds.forEach(t):this.Ft.forEach((function(e,r){n.jt(r)&&t(r)}))}},{key:"zt",value:function(e){var t=e.targetId,n=e.It.count,r=this.Ht(t);if(r){var i=r.target;if(Gg(i))if(0===n){var a=new zm(i.path);this.Kt(t,a,Bg.newNoDocument(a,Um.min()))}else wm(1===n);else this.Jt(t)!==n&&(this.Wt(t),this.Lt=this.Lt.add(t))}}},{key:"Yt",value:function(e){var t=this,n=new Map;this.Ft.forEach((function(r,i){var a=t.Ht(i);if(a){if(r.current&&Gg(a.target)){var o=new zm(a.target.path);null!==t.$t.get(o)||t.Xt(i,o)||t.Kt(i,o,Bg.newNoDocument(o,e))}r.vt&&(n.set(i,r.St()),r.Dt())}}));var r=m_();this.Bt.forEach((function(e,n){var i=t,a=!0;n.forEachWhile((function(e){var t=i.Ht(e);return!t||2===t.purpose||(a=!1,!1)})),a&&(r=r.add(e))})),this.$t.forEach((function(t,n){return n.setReadTime(e)}));var i=new __(e,n,this.Lt,this.$t,r);return this.$t=u_(),this.Bt=C_(),this.Lt=new ug(Lm),i}},{key:"qt",value:function(e,t){if(this.jt(e)){var n=this.Xt(e,t.key)?2:0;this.Qt(e).Ct(t.key,n),this.$t=this.$t.insert(t.key,t),this.Bt=this.Bt.insert(t.key,this.Zt(t.key).add(e))}}},{key:"Kt",value:function(e,t,n){if(this.jt(e)){var r=this.Qt(e);this.Xt(e,t)?r.Ct(t,1):r.xt(t),this.Bt=this.Bt.insert(t,this.Zt(t).delete(e)),n&&(this.$t=this.$t.insert(t,n))}}},{key:"removeTarget",value:function(e){this.Ft.delete(e)}},{key:"Jt",value:function(e){var t=this.Qt(e).St();return this.Mt.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}},{key:"Nt",value:function(e){this.Qt(e).Nt()}},{key:"Qt",value:function(e){var t=this.Ft.get(e);return t||(t=new x_,this.Ft.set(e,t)),t}},{key:"Zt",value:function(e){var t=this.Bt.get(e);return t||(t=new ug(Lm),this.Bt=this.Bt.insert(e,t)),t}},{key:"jt",value:function(e){var t=null!==this.Ht(e);return t||ym("WatchChangeAggregator","Detected inactive target",e),t}},{key:"Ht",value:function(e){var t=this.Ft.get(e);return t&&t.Pt?null:this.Mt.te(e)}},{key:"Wt",value:function(e){var t=this;this.Ft.set(e,new x_),this.Mt.getRemoteKeysForTarget(e).forEach((function(n){t.Kt(e,n,null)}))}},{key:"Xt",value:function(e,t){return this.Mt.getRemoteKeysForTarget(e).has(t)}}]),t}();function C_(){return new ag(zm.comparator)}function S_(){return new ag(zm.comparator)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var N_={asc:"ASCENDING",desc:"DESCENDING"},A_={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},R_=function t(n,r){"use strict";e(D)(this,t),this.databaseId=n,this.dt=r};function D_(e,t){return e.dt?"".concat(new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z",""),".").concat(("000000000"+t.nanoseconds).slice(-9),"Z"):{seconds:""+t.seconds,nanos:t.nanoseconds}}function P_(e,t){return e.dt?t.toBase64():t.toUint8Array()}function O_(e,t){return D_(e,t.toTimestamp())}function L_(e){return wm(!!e),Um.fromTimestamp((t=vg(e),new Fm(t.seconds,t.nanos)));var t}function M_(e,t){return(n=e,new jm(["projects",n.projectId,"databases",n.database])).child("documents").child(t).canonicalString();var n}function F_(e){var t=jm.fromString(e);return wm(tw(t)),t}function U_(e,t){return M_(e.databaseId,t.path)}function V_(e,t){var n=F_(t);if(n.get(1)!==e.databaseId.projectId)throw new Im(Tm.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new Im(Tm.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new zm(z_(n))}function j_(e,t){return M_(e.databaseId,t)}function q_(e){var t=F_(e);return 4===t.length?jm.emptyPath():z_(t)}function B_(e){return new jm(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function z_(e){return wm(e.length>4&&"documents"===e.get(4)),e.popFirst(5)}function H_(e,t,n){return{name:U_(e,t),fields:n.value.mapValue.fields}}function W_(e,t){var n,r,i;if(t instanceof Qk)n={update:H_(e,t.key,t.value)};else if(t instanceof t_)n={delete:U_(e,t.key)};else if(t instanceof Yk)n={update:H_(e,t.key,t.data),updateMask:(r=t.fieldMask,i=[],r.fields.forEach((function(e){return i.push(e.canonicalString())})),{fieldPaths:i})};else{if(!(t instanceof n_))return _m();n={verify:U_(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map((function(e){return function(e,t){var n=t.transform;if(n instanceof Rk)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof Dk)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof Ok)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof Mk)return{fieldPath:t.field.canonicalString(),increment:n._t};throw _m()}(0,e)}))),t.precondition.isNone||(n.currentDocument=function(e,t){return void 0!==t.updateTime?{updateTime:O_(e,t.updateTime)}:void 0!==t.exists?{exists:t.exists}:_m()}(e,t.precondition)),n}function K_(e,t){return{documents:[j_(e,t.path)]}}function G_(e,t){var n={structuredQuery:{}},r=t.path;null!==t.collectionGroup?(n.parent=j_(e,r),n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(n.parent=j_(e,r.popLast()),n.structuredQuery.from=[{collectionId:r.lastSegment()}]);var i=function(e){if(0!==e.length){var t=e.map((function(e){return function(e){if("=="===e.op){if(Mg(e.value))return{unaryFilter:{field:$_(e.field),op:"IS_NAN"}};if(Lg(e.value))return{unaryFilter:{field:$_(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(Mg(e.value))return{unaryFilter:{field:$_(e.field),op:"IS_NOT_NAN"}};if(Lg(e.value))return{unaryFilter:{field:$_(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:$_(e.field),op:J_(e.op),value:e.value}}}(e)}));return 1===t.length?t[0]:{compositeFilter:{op:"AND",filters:t}}}}(t.filters);i&&(n.structuredQuery.where=i);var a=function(e){if(0!==e.length)return e.map((function(e){return{field:$_((t=e).field),direction:X_(t.dir)};var t}))}(t.orderBy);a&&(n.structuredQuery.orderBy=a);var o,s,u,c=(o=e,s=t.limit,o.dt||bg(s)?s:{value:s});return null!==c&&(n.structuredQuery.limit=c),t.startAt&&(n.structuredQuery.startAt={before:(u=t.startAt).inclusive,values:u.position}),t.endAt&&(n.structuredQuery.endAt=function(e){return{before:!e.inclusive,values:e.position}}(t.endAt)),n}function Q_(e){var t=q_(e.parent),n=e.structuredQuery,r=n.from?n.from.length:0,i=null;if(r>0){wm(1===r);var a=n.from[0];a.allDescendants?i=a.collectionId:t=t.child(a.collectionId)}var o=[];n.where&&(o=Y_(n.where));var s=[];n.orderBy&&(s=n.orderBy.map((function(e){return new ik(Z_((t=e).field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(t.direction));var t})));var u,c,l=null;n.limit&&(u=n.limit,l=bg(c="object"==typeof u?u.value:u)?null:c);var h=null;n.startAt&&(h=function(e){var t=!!e.before,n=e.values||[];return new rk(n,t)}(n.startAt));var f=null;return n.endAt&&(f=function(e){var t=!e.before,n=e.values||[];return new rk(n,t)}(n.endAt)),ck(t,i,s,o,l,"F",h,f)}function Y_(e){return e?void 0!==e.unaryFilter?[ew(e)]:void 0!==e.fieldFilter?[(t=e,Qg.create(Z_(t.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return _m()}}(t.fieldFilter.op),t.fieldFilter.value))]:void 0!==e.compositeFilter?e.compositeFilter.filters.map((function(e){return Y_(e)})).reduce((function(e,t){return e.concat(t)})):_m():[];var t}function X_(e){return N_[e]}function J_(e){return A_[e]}function $_(e){return{fieldPath:e.canonicalString()}}function Z_(e){return Bm.fromServerFormat(e.fieldPath)}function ew(e){switch(e.unaryFilter.op){case"IS_NAN":var t=Z_(e.unaryFilter.field);return Qg.create(t,"==",{doubleValue:NaN});case"IS_NULL":var n=Z_(e.unaryFilter.field);return Qg.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":var r=Z_(e.unaryFilter.field);return Qg.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":var i=Z_(e.unaryFilter.field);return Qg.create(i,"!=",{nullValue:"NULL_VALUE"});default:return _m()}}function tw(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var nw=["mutationQueues","mutations","documentMutations","remoteDocuments","targets","owner","targetGlobal","targetDocuments","clientMetadata","remoteDocumentGlobal","collectionParents","bundles","namedQueries"],rw=(e(L)(nw).concat(["documentOverlays"]),["mutationQueues","mutations","documentMutations","remoteDocumentsV14","targets","owner","targetGlobal","targetDocuments","clientMetadata","remoteDocumentGlobal","collectionParents","bundles","namedQueries","documentOverlays"]),iw=rw;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */e(L)(iw).concat(["indexConfiguration","indexState","indexEntries"]);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var aw=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this.batchId=n,this.localWriteTime=r,this.baseMutations=i,this.mutations=a}return e(P)(t,[{key:"applyToRemoteDocument",value:function(e,t){for(var n=t.mutationResults,r=0;r<this.mutations.length;r++){var i=this.mutations[r];i.key.isEqual(e.key)&&Hk(i,e,n[r])}}},{key:"applyToLocalView",value:function(e,t){var n=!0,r=!1,i=void 0;try{for(var a,o=this.baseMutations[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;s.key.isEqual(e.key)&&(t=Wk(s,e,t,this.localWriteTime))}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}var u=!0,c=!1,l=void 0;try{for(var h,f=this.mutations[Symbol.iterator]();!(u=(h=f.next()).done);u=!0){var d=h.value;d.key.isEqual(e.key)&&(t=Wk(d,e,t,this.localWriteTime))}}catch(e){c=!0,l=e}finally{try{u||null==f.return||f.return()}finally{if(c)throw l}}return t}},{key:"applyToLocalDocumentSet",value:function(e,t){var n=this,r=d_();return this.mutations.forEach((function(i){var a=e.get(i.key),o=a.overlayedDocument,s=n.applyToLocalView(o,a.mutatedFields),u=zk(o,s=t.has(i.key)?null:s);null!==u&&r.set(i.key,u),o.isValidDocument()||o.convertToNoDocument(Um.min())})),r}},{key:"keys",value:function(){return this.mutations.reduce((function(e,t){return e.add(t.key)}),m_())}},{key:"isEqual",value:function(e){return this.batchId===e.batchId&&Mm(this.mutations,e.mutations,(function(e,t){return Gk(e,t)}))&&Mm(this.baseMutations,e.baseMutations,(function(e,t){return Gk(e,t)}))}}]),t}(),ow=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this.batch=n,this.commitVersion=r,this.mutationResults=i,this.docVersions=a}return e(P)(t,null,[{key:"from",value:function(e,n,r){wm(e.mutations.length===r.length);for(var i=p_,a=e.mutations,o=0;o<a.length;o++)i=i.insert(a[o].key,r[o].version);return new t(e,n,r,i)}}]),t}(),sw=function(){"use strict";function t(n,r){e(D)(this,t),this.largestBatchId=n,this.mutation=r}return e(P)(t,[{key:"getKey",value:function(){return this.mutation.key}},{key:"isEqual",value:function(e){return null!==e&&this.mutation===e.mutation}},{key:"toString",value:function(){return"Overlay{\n      largestBatchId: ".concat(this.largestBatchId,",\n      mutation: ").concat(this.mutation.toString(),"\n    }")}}]),t}(),uw=function(){"use strict";function t(n,r,i,a){var o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:Um.min(),s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:Um.min(),u=arguments.length>6&&void 0!==arguments[6]?arguments[6]:fg.EMPTY_BYTE_STRING;e(D)(this,t),this.target=n,this.targetId=r,this.purpose=i,this.sequenceNumber=a,this.snapshotVersion=o,this.lastLimboFreeSnapshotVersion=s,this.resumeToken=u}return e(P)(t,[{key:"withSequenceNumber",value:function(e){return new t(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken)}},{key:"withResumeToken",value:function(e,n){return new t(this.target,this.targetId,this.purpose,this.sequenceNumber,n,this.lastLimboFreeSnapshotVersion,e)}},{key:"withLastLimboFreeSnapshotVersion",value:function(e){return new t(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken)}}]),t}(),cw=function t(n){"use strict";e(D)(this,t),this.ne=n};function lw(e){var t=Q_({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?yk(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
var vw=function(){"use strict";function t(n,r,i){e(D)(this,t),this.cacheSizeCollectionThreshold=n,this.percentileToCollect=r,this.maximumSequenceNumbersToCollect=i}return e(P)(t,null,[{key:"withCacheSize",value:function(e){return new t(e,t.DEFAULT_COLLECTION_PERCENTILE,t.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vw.DEFAULT_COLLECTION_PERCENTILE=10,vw.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,vw.DEFAULT=new vw(41943040,vw.DEFAULT_COLLECTION_PERCENTILE,vw.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),vw.DISABLED=new vw(-1,0,0);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var pw=function(){"use strict";function t(n){e(D)(this,t),this.En=n}return e(P)(t,[{key:"next",value:function(){return this.En+=2,this.En}}],[{key:"An",value:function(){return new t(0)}},{key:"Rn",value:function(){return new t(-1)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var mw=function t(n,r){"use strict";e(D)(this,t),this.overlayedDocument=n,this.mutatedFields=r},gw=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this.remoteDocumentCache=n,this.mutationQueue=r,this.documentOverlayCache=i,this.indexManager=a}return e(P)(t,[{key:"getDocument",value:function(e,t){var n=this,r=null;return this.documentOverlayCache.getOverlay(e,t).next((function(i){return r=i,n.getBaseDocument(e,t,r)})).next((function(e){return null!==r&&Wk(r.mutation,e,lg.empty(),Fm.now()),e}))}},{key:"getDocuments",value:function(e,t){var n=this;return this.remoteDocumentCache.getEntries(e,t).next((function(t){return n.getLocalViewOfDocuments(e,t,m_()).next((function(){return t}))}))}},{key:"getLocalViewOfDocuments",value:function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:m_(),r=this,i=f_();return this.populateOverlays(e,i,t).next((function(){return r.computeViews(e,t,i,n).next((function(e){var t=l_();return e.forEach((function(e,n){t=t.insert(e,n.overlayedDocument)})),t}))}))}},{key:"getOverlayedDocuments",value:function(e,t){var n=this,r=f_();return this.populateOverlays(e,r,t).next((function(){return n.computeViews(e,t,r,m_())}))}},{key:"populateOverlays",value:function(e,t,n){var r=[];return n.forEach((function(e){t.has(e)||r.push(e)})),this.documentOverlayCache.getOverlays(e,r).next((function(e){e.forEach((function(e,n){t.set(e,n)}))}))}},{key:"computeViews",value:function(e,t,n,r){var i=u_(),a=v_(),o=v_();return t.forEach((function(e,t){var o=n.get(t.key);r.has(t.key)&&(void 0===o||o.mutation instanceof Yk)?i=i.insert(t.key,t):void 0!==o&&(a.set(t.key,o.mutation.getFieldMask()),Wk(o.mutation,t,o.mutation.getFieldMask(),Fm.now()))})),this.recalculateAndSaveOverlays(e,i).next((function(e){return e.forEach((function(e,t){return a.set(e,t)})),t.forEach((function(e,t){var n;return o.set(e,new mw(t,null!==(n=a.get(e))&&void 0!==n?n:null))})),o}))}},{key:"recalculateAndSaveOverlays",value:function(e,t){var n=this,r=v_(),i=new ag((function(e,t){return e-t})),a=m_();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((function(e){var n=!0,a=!1,o=void 0;try{for(var s,u=function(e,n){var a=n.value;a.keys().forEach((function(e){var n=t.get(e);if(null!==n){var o=r.get(e)||lg.empty();o=a.applyToLocalView(n,o),r.set(e,o);var s=(i.get(a.batchId)||m_()).add(e);i=i.insert(a.batchId,s)}}))},c=e[Symbol.iterator]();!(n=(s=c.next()).done);n=!0)u(0,s)}catch(e){a=!0,o=e}finally{try{n||null==c.return||c.return()}finally{if(a)throw o}}})).next((function(){for(var o=[],s=i.getReverseIterator();s.hasNext();){var u=s.getNext(),c=u.key,l=u.value,h=d_();l.forEach((function(e){if(!a.has(e)){var n=zk(t.get(e),r.get(e));null!==n&&h.set(e,n),a=a.add(e)}})),o.push(n.documentOverlayCache.saveOverlays(e,c,h))}return Zm.waitFor(o)})).next((function(){return r}))}},{key:"recalculateAndSaveOverlaysForDocumentKeys",value:function(e,t){var n=this;return this.remoteDocumentCache.getEntries(e,t).next((function(t){return n.recalculateAndSaveOverlays(e,t)}))}},{key:"getDocumentsMatchingQuery",value:function(e,t,n){return r=t,zm.isDocumentKey(r.path)&&null===r.collectionGroup&&0===r.filters.length?this.getDocumentsMatchingDocumentQuery(e,t.path):dk(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n):this.getDocumentsMatchingCollectionQuery(e,t,n);var r}},{key:"getNextDocuments",value:function(e,t,n,r){var i=this;return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,r).next((function(a){var o=i,s=r-a.size>0?i.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,r-a.size):Zm.resolve(f_()),u=-1,c=a;return s.next((function(t){return Zm.forEach(t,(function(t,n){return u<n.largestBatchId&&(u=n.largestBatchId),a.get(t)?Zm.resolve():o.getBaseDocument(e,t,n).next((function(e){c=c.insert(t,e)}))})).next((function(){return o.populateOverlays(e,t,a)})).next((function(){return o.computeViews(e,c,t,m_())})).next((function(e){return{batchId:u,changes:h_(e)}}))}))}))}},{key:"getDocumentsMatchingDocumentQuery",value:function(e,t){return this.getDocument(e,new zm(t)).next((function(e){var t=l_();return e.isFoundDocument()&&(t=t.insert(e.key,e)),t}))}},{key:"getDocumentsMatchingCollectionGroupQuery",value:function(e,t,n){var r=this,i=t.collectionGroup,a=l_();return this.indexManager.getCollectionParents(e,i).next((function(o){return Zm.forEach(o,(function(o){var s,u,c=(s=t,u=o.child(i),new uk(u,null,s.explicitOrderBy.slice(),s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt));return r.getDocumentsMatchingCollectionQuery(e,c,n).next((function(e){e.forEach((function(e,t){a=a.insert(e,t)}))}))})).next((function(){return a}))}))}},{key:"getDocumentsMatchingCollectionQuery",value:function(e,t,n){var r,i=this;return this.remoteDocumentCache.getAllFromCollection(e,t.path,n).next((function(a){return r=a,i.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId)})).next((function(e){e.forEach((function(e,t){var n=t.getKey();null===r.get(n)&&(r=r.insert(n,Bg.newInvalidDocument(n)))}));var n=l_();return r.forEach((function(r,i){var a=e.get(r);void 0!==a&&Wk(a.mutation,i,lg.empty(),Fm.now()),_k(t,i)&&(n=n.insert(r,i))})),n}))}},{key:"getBaseDocument",value:function(e,t,n){return null===n||1===n.mutation.type?this.remoteDocumentCache.getEntry(e,t):Zm.resolve(Bg.newInvalidDocument(t))}}]),t}(),kw=function(){"use strict";function t(n){e(D)(this,t),this.wt=n,this.Jn=new Map,this.Yn=new Map}return e(P)(t,[{key:"getBundleMetadata",value:function(e,t){return Zm.resolve(this.Jn.get(t))}},{key:"saveBundleMetadata",value:function(e,t){var n;return this.Jn.set(t.id,{id:(n=t).id,version:n.version,createTime:L_(n.createTime)}),Zm.resolve()}},{key:"getNamedQuery",value:function(e,t){return Zm.resolve(this.Yn.get(t))}},{key:"saveNamedQuery",value:function(e,t){return this.Yn.set(t.name,{name:(n=t).name,query:lw(n.bundledQuery),readTime:L_(n.readTime)}),Zm.resolve();var n}}]),t}(),_w=function(){"use strict";function t(){e(D)(this,t),this.overlays=new ag(zm.comparator),this.Xn=new Map}return e(P)(t,[{key:"getOverlay",value:function(e,t){return Zm.resolve(this.overlays.get(t))}},{key:"getOverlays",value:function(e,t){var n=this,r=f_();return Zm.forEach(t,(function(t){return n.getOverlay(e,t).next((function(e){null!==e&&r.set(t,e)}))})).next((function(){return r}))}},{key:"saveOverlays",value:function(e,t,n){var r=this;return n.forEach((function(n,i){r.ie(e,t,i)})),Zm.resolve()}},{key:"removeOverlaysForBatchId",value:function(e,t,n){var r=this,i=this.Xn.get(n);return void 0!==i&&(i.forEach((function(e){return r.overlays=r.overlays.remove(e)})),this.Xn.delete(n)),Zm.resolve()}},{key:"getOverlaysForCollection",value:function(e,t,n){for(var r=f_(),i=t.length+1,a=new zm(t.child("")),o=this.overlays.getIteratorFrom(a);o.hasNext();){var s=o.getNext().value,u=s.getKey();if(!t.isPrefixOf(u.path))break;u.path.length===i&&s.largestBatchId>n&&r.set(s.getKey(),s)}return Zm.resolve(r)}},{key:"getOverlaysForCollectionGroup",value:function(e,t,n,r){for(var i=new ag((function(e,t){return e-t})),a=this.overlays.getIterator();a.hasNext();){var o=a.getNext().value;if(o.getKey().getCollectionGroup()===t&&o.largestBatchId>n){var s=i.get(o.largestBatchId);null===s&&(s=f_(),i=i.insert(o.largestBatchId,s)),s.set(o.getKey(),o)}}for(var u=f_(),c=i.getIterator();c.hasNext()&&(c.getNext().value.forEach((function(e,t){return u.set(e,t)})),!(u.size()>=r)););return Zm.resolve(u)}},{key:"ie",value:function(e,t,n){var r=this.overlays.get(n.key);if(null!==r){var i=this.Xn.get(r.largestBatchId).delete(n.key);this.Xn.set(r.largestBatchId,i)}this.overlays=this.overlays.insert(n.key,new sw(t,n));var a=this.Xn.get(t);void 0===a&&(a=m_(),this.Xn.set(t,a)),this.Xn.set(t,a.add(n.key))}}]),t}(),ww=function(){"use strict";function t(){e(D)(this,t),this.Zn=new ug(bw.ts),this.es=new ug(bw.ns)}return e(P)(t,[{key:"isEmpty",value:function(){return this.Zn.isEmpty()}},{key:"addReference",value:function(e,t){var n=new bw(e,t);this.Zn=this.Zn.add(n),this.es=this.es.add(n)}},{key:"ss",value:function(e,t){var n=this;e.forEach((function(e){return n.addReference(e,t)}))}},{key:"removeReference",value:function(e,t){this.rs(new bw(e,t))}},{key:"os",value:function(e,t){var n=this;e.forEach((function(e){return n.removeReference(e,t)}))}},{key:"us",value:function(e){var t=this,n=new zm(new jm([])),r=new bw(n,e),i=new bw(n,e+1),a=[];return this.es.forEachInRange([r,i],(function(e){t.rs(e),a.push(e.key)})),a}},{key:"cs",value:function(){var e=this;this.Zn.forEach((function(t){return e.rs(t)}))}},{key:"rs",value:function(e){this.Zn=this.Zn.delete(e),this.es=this.es.delete(e)}},{key:"hs",value:function(e){var t=new zm(new jm([])),n=new bw(t,e),r=new bw(t,e+1),i=m_();return this.es.forEachInRange([n,r],(function(e){i=i.add(e.key)})),i}},{key:"containsKey",value:function(e){var t=new bw(e,0),n=this.Zn.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}]),t}(),bw=function(){"use strict";function t(n,r){e(D)(this,t),this.key=n,this.ls=r}return e(P)(t,null,[{key:"ts",value:function(e,t){return zm.comparator(e.key,t.key)||Lm(e.ls,t.ls)}},{key:"ns",value:function(e,t){return Lm(e.ls,t.ls)||zm.comparator(e.key,t.key)}}]),t}(),Tw=function(){"use strict";function t(n,r){e(D)(this,t),this.indexManager=n,this.referenceDelegate=r,this.mutationQueue=[],this.fs=1,this.ds=new ug(bw.ts)}return e(P)(t,[{key:"checkEmpty",value:function(e){return Zm.resolve(0===this.mutationQueue.length)}},{key:"addMutationBatch",value:function(e,t,n,r){var i=this.fs;this.fs++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];var a=new aw(i,t,n,r);this.mutationQueue.push(a);var o=!0,s=!1,u=void 0;try{for(var c,l=r[Symbol.iterator]();!(o=(c=l.next()).done);o=!0){var h=c.value;this.ds=this.ds.add(new bw(h.key,i)),this.indexManager.addToCollectionParentIndex(e,h.key.path.popLast())}}catch(e){s=!0,u=e}finally{try{o||null==l.return||l.return()}finally{if(s)throw u}}return Zm.resolve(a)}},{key:"lookupMutationBatch",value:function(e,t){return Zm.resolve(this._s(t))}},{key:"getNextMutationBatchAfterBatchId",value:function(e,t){var n=t+1,r=this.ws(n),i=r<0?0:r;return Zm.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}},{key:"getHighestUnacknowledgedBatchId",value:function(){return Zm.resolve(0===this.mutationQueue.length?-1:this.fs-1)}},{key:"getAllMutationBatches",value:function(e){return Zm.resolve(this.mutationQueue.slice())}},{key:"getAllMutationBatchesAffectingDocumentKey",value:function(e,t){var n=this,r=new bw(t,0),i=new bw(t,Number.POSITIVE_INFINITY),a=[];return this.ds.forEachInRange([r,i],(function(e){var t=n._s(e.ls);a.push(t)})),Zm.resolve(a)}},{key:"getAllMutationBatchesAffectingDocumentKeys",value:function(e,t){var n=this,r=new ug(Lm);return t.forEach((function(e){var t=new bw(e,0),i=new bw(e,Number.POSITIVE_INFINITY);n.ds.forEachInRange([t,i],(function(e){r=r.add(e.ls)}))})),Zm.resolve(this.gs(r))}},{key:"getAllMutationBatchesAffectingQuery",value:function(e,t){var n=t.path,r=n.length+1,i=n;zm.isDocumentKey(i)||(i=i.child(""));var a=new bw(new zm(i),0),o=new ug(Lm);return this.ds.forEachWhile((function(e){var t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(o=o.add(e.ls)),!0)}),a),Zm.resolve(this.gs(o))}},{key:"gs",value:function(e){var t=this,n=[];return e.forEach((function(e){var r=t._s(e);null!==r&&n.push(r)})),n}},{key:"removeMutationBatch",value:function(e,t){var n=this;wm(0===this.ys(t.batchId,"removed")),this.mutationQueue.shift();var r=this.ds;return Zm.forEach(t.mutations,(function(i){var a=new bw(i.key,t.batchId);return r=r.delete(a),n.referenceDelegate.markPotentiallyOrphaned(e,i.key)})).next((function(){n.ds=r}))}},{key:"In",value:function(e){}},{key:"containsKey",value:function(e,t){var n=new bw(t,0),r=this.ds.firstAfterOrEqual(n);return Zm.resolve(t.isEqual(r&&r.key))}},{key:"performConsistencyCheck",value:function(e){return this.mutationQueue.length,Zm.resolve()}},{key:"ys",value:function(e,t){return this.ws(e)}},{key:"ws",value:function(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}},{key:"_s",value:function(e){var t=this.ws(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}]),t}(),Iw=function(){"use strict";function t(n){e(D)(this,t),this.ps=n,this.docs=new ag(zm.comparator),this.size=0}return e(P)(t,[{key:"setIndexManager",value:function(e){this.indexManager=e}},{key:"addEntry",value:function(e,t){var n=t.key,r=this.docs.get(n),i=r?r.size:0,a=this.ps(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:a}),this.size+=a-i,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}},{key:"removeEntry",value:function(e){var t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}},{key:"getEntry",value:function(e,t){var n=this.docs.get(t);return Zm.resolve(n?n.document.mutableCopy():Bg.newInvalidDocument(t))}},{key:"getEntries",value:function(e,t){var n=this,r=u_();return t.forEach((function(e){var t=n.docs.get(e);r=r.insert(e,t?t.document.mutableCopy():Bg.newInvalidDocument(e))})),Zm.resolve(r)}},{key:"getAllFromCollection",value:function(e,t,n){for(var r=u_(),i=new zm(t.child("")),a=this.docs.getIteratorFrom(i);a.hasNext();){var o=a.getNext(),s=o.key,u=o.value.document;if(!t.isPrefixOf(s.path))break;s.path.length>t.length+1||Qm(Km(u),n)<=0||(r=r.insert(u.key,u.mutableCopy()))}return Zm.resolve(r)}},{key:"getAllFromCollectionGroup",value:function(e,t,n,r){_m()}},{key:"Is",value:function(e,t){return Zm.forEach(this.docs,(function(e){return t(e)}))}},{key:"newChangeBuffer",value:function(e){return new xw(this)}},{key:"getSize",value:function(e){return Zm.resolve(this.size)}}]),t}(),xw=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this)).zn=t,e($f)(i)}return e(P)(r,[{key:"applyChanges",value:function(e){var t=this,n=[];return this.changes.forEach((function(r,i){i.isValidDocument()?n.push(t.zn.addEntry(e,i)):t.zn.removeEntry(r)})),Zm.waitFor(n)}},{key:"getFromCache",value:function(e,t){return this.zn.getEntry(e,t)}},{key:"getAllFromCache",value:function(e,t){return this.zn.getEntries(e,t)}}]),r}(yw),Ew=function(){"use strict";function t(n){e(D)(this,t),this.persistence=n,this.Ts=new o_((function(e){return Wg(e)}),Kg),this.lastRemoteSnapshotVersion=Um.min(),this.highestTargetId=0,this.Es=0,this.As=new ww,this.targetCount=0,this.Rs=pw.An()}return e(P)(t,[{key:"forEachTarget",value:function(e,t){return this.Ts.forEach((function(e,n){return t(n)})),Zm.resolve()}},{key:"getLastRemoteSnapshotVersion",value:function(e){return Zm.resolve(this.lastRemoteSnapshotVersion)}},{key:"getHighestSequenceNumber",value:function(e){return Zm.resolve(this.Es)}},{key:"allocateTargetId",value:function(e){return this.highestTargetId=this.Rs.next(),Zm.resolve(this.highestTargetId)}},{key:"setTargetsMetadata",value:function(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.Es&&(this.Es=t),Zm.resolve()}},{key:"vn",value:function(e){this.Ts.set(e.target,e);var t=e.targetId;t>this.highestTargetId&&(this.Rs=new pw(t),this.highestTargetId=t),e.sequenceNumber>this.Es&&(this.Es=e.sequenceNumber)}},{key:"addTargetData",value:function(e,t){return this.vn(t),this.targetCount+=1,Zm.resolve()}},{key:"updateTargetData",value:function(e,t){return this.vn(t),Zm.resolve()}},{key:"removeTargetData",value:function(e,t){return this.Ts.delete(t.target),this.As.us(t.targetId),this.targetCount-=1,Zm.resolve()}},{key:"removeTargets",value:function(e,t,n){var r=this,i=0,a=[];return this.Ts.forEach((function(o,s){s.sequenceNumber<=t&&null===n.get(s.targetId)&&(r.Ts.delete(o),a.push(r.removeMatchingKeysForTargetId(e,s.targetId)),i++)})),Zm.waitFor(a).next((function(){return i}))}},{key:"getTargetCount",value:function(e){return Zm.resolve(this.targetCount)}},{key:"getTargetData",value:function(e,t){var n=this.Ts.get(t)||null;return Zm.resolve(n)}},{key:"addMatchingKeys",value:function(e,t,n){return this.As.ss(t,n),Zm.resolve()}},{key:"removeMatchingKeys",value:function(e,t,n){this.As.os(t,n);var r=this.persistence.referenceDelegate,i=[];return r&&t.forEach((function(t){i.push(r.markPotentiallyOrphaned(e,t))})),Zm.waitFor(i)}},{key:"removeMatchingKeysForTargetId",value:function(e,t){return this.As.us(t),Zm.resolve()}},{key:"getMatchingKeysForTargetId",value:function(e,t){var n=this.As.hs(t);return Zm.resolve(n)}},{key:"containsKey",value:function(e,t){return Zm.resolve(this.As.containsKey(t))}}]),t}(),Cw=function(){"use strict";function t(n,r){var i=this;e(D)(this,t),this.bs={},this.overlays={},this.Ps=new tg(0),this.vs=!1,this.vs=!0,this.referenceDelegate=n(this),this.Vs=new Ew(this),this.indexManager=new fw,this.remoteDocumentCache=new Iw((function(e){return i.referenceDelegate.Ss(e)})),this.wt=new cw(r),this.Ds=new kw(this.wt)}return e(P)(t,[{key:"start",value:function(){return Promise.resolve()}},{key:"shutdown",value:function(){return this.vs=!1,Promise.resolve()}},{key:"started",get:function(){return this.vs}},{key:"setDatabaseDeletedListener",value:function(){}},{key:"setNetworkEnabled",value:function(){}},{key:"getIndexManager",value:function(e){return this.indexManager}},{key:"getDocumentOverlayCache",value:function(e){var t=this.overlays[e.toKey()];return t||(t=new _w,this.overlays[e.toKey()]=t),t}},{key:"getMutationQueue",value:function(e,t){var n=this.bs[e.toKey()];return n||(n=new Tw(t,this.referenceDelegate),this.bs[e.toKey()]=n),n}},{key:"getTargetCache",value:function(){return this.Vs}},{key:"getRemoteDocumentCache",value:function(){return this.remoteDocumentCache}},{key:"getBundleCache",value:function(){return this.Ds}},{key:"runTransaction",value:function(e,t,n){var r=this;ym("MemoryPersistence","Starting transaction:",e);var i=new Sw(this.Ps.next());return this.referenceDelegate.Cs(),n(i).next((function(e){return r.referenceDelegate.xs(i).next((function(){return e}))})).toPromise().then((function(e){return i.raiseOnCommittedEvent(),e}))}},{key:"Ns",value:function(e,t){return Zm.or(Object.values(this.bs).map((function(n){return function(){return n.containsKey(e,t)}})))}}]),t}(),Sw=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this)).currentSequenceNumber=t,e($f)(i)}return r}(Xm),Nw=function(){"use strict";function t(n){e(D)(this,t),this.persistence=n,this.ks=new ww,this.Os=null}return e(P)(t,[{key:"Fs",get:function(){if(this.Os)return this.Os;throw _m()}},{key:"addReference",value:function(e,t,n){return this.ks.addReference(n,t),this.Fs.delete(n.toString()),Zm.resolve()}},{key:"removeReference",value:function(e,t,n){return this.ks.removeReference(n,t),this.Fs.add(n.toString()),Zm.resolve()}},{key:"markPotentiallyOrphaned",value:function(e,t){return this.Fs.add(t.toString()),Zm.resolve()}},{key:"removeTarget",value:function(e,t){var n=this;this.ks.us(t.targetId).forEach((function(e){return n.Fs.add(e.toString())}));var r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next((function(e){var t=n;e.forEach((function(e){return t.Fs.add(e.toString())}))})).next((function(){return r.removeTargetData(e,t)}))}},{key:"Cs",value:function(){this.Os=new Set}},{key:"xs",value:function(e){var t=this,n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Zm.forEach(this.Fs,(function(r){var i=zm.fromPath(r);return t.$s(e,i).next((function(e){e||n.removeEntry(i,Um.min())}))})).next((function(){return t.Os=null,n.apply(e)}))}},{key:"updateLimboDocument",value:function(e,t){var n=this;return this.$s(e,t).next((function(e){e?n.Fs.delete(t.toString()):n.Fs.add(t.toString())}))}},{key:"Ss",value:function(e){return 0}},{key:"$s",value:function(e,t){var n=this;return Zm.or([function(){return Zm.resolve(n.ks.containsKey(t))},function(){return n.persistence.getTargetCache().containsKey(e,t)},function(){return n.persistence.Ns(e,t)}])}}],[{key:"Ms",value:function(e){return new t(e)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var Aw=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this.targetId=n,this.fromCache=r,this.Pi=i,this.vi=a}return e(P)(t,null,[{key:"Vi",value:function(e,n){var r=m_(),i=m_(),a=!0,o=!1,s=void 0;try{for(var u,c=n.docChanges[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;switch(l.type){case 0:r=r.add(l.doc.key);break;case 1:i=i.add(l.doc.key)}}}catch(e){o=!0,s=e}finally{try{a||null==c.return||c.return()}finally{if(o)throw s}}return new t(e,n.fromCache,r,i)}}]),t}(),Rw=function(){"use strict";function t(){e(D)(this,t),this.Si=!1}return e(P)(t,[{key:"initialize",value:function(e,t){this.Di=e,this.indexManager=t,this.Si=!0}},{key:"getDocumentsMatchingQuery",value:function(e,t,n,r){var i=this;return this.Ci(e,t).next((function(a){return a||i.xi(e,t,r,n)})).next((function(n){return n||i.Ni(e,t)}))}},{key:"Ci",value:function(e,t){return Zm.resolve(null)}},{key:"xi",value:function(e,t,n,r){var i=this;return function(e){return 0===e.filters.length&&null===e.limit&&null==e.startAt&&null==e.endAt&&(0===e.explicitOrderBy.length||1===e.explicitOrderBy.length&&e.explicitOrderBy[0].field.isKeyField())}(t)||r.isEqual(Um.min())?this.Ni(e,t):this.Di.getDocuments(e,n).next((function(a){var o=i.ki(t,a);return i.Oi(t,o,n,r)?i.Ni(e,t):(pm()<=Ue.DEBUG&&ym("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),kk(t)),i.Mi(e,o,t,Wm(r,-1)))}))}},{key:"ki",value:function(e,t){var n=new ug(bk(e));return t.forEach((function(t,r){_k(e,r)&&(n=n.add(r))})),n}},{key:"Oi",value:function(e,t,n,r){if(null===e.limit)return!1;if(n.size!==t.size)return!0;var i="F"===e.limitType?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}},{key:"Ni",value:function(e,t){return pm()<=Ue.DEBUG&&ym("QueryEngine","Using full collection scan to execute query:",kk(t)),this.Di.getDocumentsMatchingQuery(e,t,Gm.min())}},{key:"Mi",value:function(e,t,n,r){return this.Di.getDocumentsMatchingQuery(e,n,r).next((function(e){return t.forEach((function(t){e=e.insert(t.key,t)})),e}))}}]),t}(),Dw=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this.persistence=n,this.Fi=r,this.wt=a,this.$i=new ag(Lm),this.Bi=new o_((function(e){return Wg(e)}),Kg),this.Li=new Map,this.Ui=n.getRemoteDocumentCache(),this.Vs=n.getTargetCache(),this.Ds=n.getBundleCache(),this.qi(i)}return e(P)(t,[{key:"qi",value:function(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new gw(this.Ui,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ui.setIndexManager(this.indexManager),this.Fi.initialize(this.localDocuments,this.indexManager)}},{key:"collectGarbage",value:function(e){var t=this;return this.persistence.runTransaction("Collect garbage","readwrite-primary",(function(n){return e.collect(n,t.$i)}))}}]),t}();
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pw(e,t,n,r){return new Dw(e,t,n,r)}function Ow(e,t){return Lw.apply(this,arguments)}function Lw(){return(Lw=e(a)(e(o).mark((function t(n,r){var i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=bm(n),e.next=3,i.persistence.runTransaction("Handle user change","readonly",(function(e){var t;return i.mutationQueue.getAllMutationBatches(e).next((function(n){return t=n,i.qi(r),i.mutationQueue.getAllMutationBatches(e)})).next((function(n){var r=[],a=[],o=m_(),s=!0,u=!1,c=void 0;try{for(var l,h=t[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value;r.push(f.batchId);var d=!0,v=!1,p=void 0;try{for(var y,m=f.mutations[Symbol.iterator]();!(d=(y=m.next()).done);d=!0){var g=y.value;o=o.add(g.key)}}catch(e){v=!0,p=e}finally{try{d||null==m.return||m.return()}finally{if(v)throw p}}}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}var k=!0,_=!1,w=void 0;try{for(var b,T=n[Symbol.iterator]();!(k=(b=T.next()).done);k=!0){var I=b.value;a.push(I.batchId);var x=!0,E=!1,C=void 0;try{for(var S,N=I.mutations[Symbol.iterator]();!(x=(S=N.next()).done);x=!0){var A=S.value;o=o.add(A.key)}}catch(e){E=!0,C=e}finally{try{x||null==N.return||N.return()}finally{if(E)throw C}}}}catch(e){_=!0,w=e}finally{try{k||null==T.return||T.return()}finally{if(_)throw w}}return i.localDocuments.getDocuments(e,o).next((function(e){return{Ki:e,removedBatchIds:r,addedBatchIds:a}}))}))}));case 3:return e.abrupt("return",e.sent);case 4:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Mw(e,t){var n=bm(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(function(e){var r,i,a,o,s,u,c,l=t.batch.keys(),h=n.Ui.newChangeBuffer({trackRemovals:!0});return(r=n,i=e,a=t,o=h,s=a.batch,u=s.keys(),c=Zm.resolve(),u.forEach((function(e){c=c.next((function(){return o.getEntry(i,e)})).next((function(t){var n=a.docVersions.get(e);wm(null!==n),t.version.compareTo(n)<0&&(s.applyToRemoteDocument(t,a),t.isValidDocument()&&(t.setReadTime(a.commitVersion),o.addEntry(t)))}))})),c.next((function(){return r.mutationQueue.removeMutationBatch(i,s)}))).next((function(){return h.apply(e)})).next((function(){return n.mutationQueue.performConsistencyCheck(e)})).next((function(){return n.documentOverlayCache.removeOverlaysForBatchId(e,l,t.batch.batchId)})).next((function(){return n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,function(e){for(var t=m_(),n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t))})).next((function(){return n.localDocuments.getDocuments(e,l)}))}))}function Fw(e){var t=bm(e);return t.persistence.runTransaction("Get last remote snapshot version","readonly",(function(e){return t.Vs.getLastRemoteSnapshotVersion(e)}))}function Uw(e,t){var n=bm(e),r=t.snapshotVersion,i=n.$i;return n.persistence.runTransaction("Apply remote event","readwrite-primary",(function(e){var a=n.Ui.newChangeBuffer({trackRemovals:!0});i=n.$i;var o=[];t.targetChanges.forEach((function(a,s){var u=i.get(s);if(u){o.push(n.Vs.removeMatchingKeys(e,a.removedDocuments,s).next((function(){return n.Vs.addMatchingKeys(e,a.addedDocuments,s)})));var c,l,h,f=u.withSequenceNumber(e.currentSequenceNumber);t.targetMismatches.has(s)?f=f.withResumeToken(fg.EMPTY_BYTE_STRING,Um.min()).withLastLimboFreeSnapshotVersion(Um.min()):a.resumeToken.approximateByteSize()>0&&(f=f.withResumeToken(a.resumeToken,r)),i=i.insert(s,f),l=f,h=a,(0===(c=u).resumeToken.approximateByteSize()||l.snapshotVersion.toMicroseconds()-c.snapshotVersion.toMicroseconds()>=3e8||h.addedDocuments.size+h.modifiedDocuments.size+h.removedDocuments.size>0)&&o.push(n.Vs.updateTargetData(e,f))}}));var s=u_(),u=m_();if(t.documentUpdates.forEach((function(r){t.resolvedLimboDocuments.has(r)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(e,r))})),o.push(Vw(e,a,t.documentUpdates).next((function(e){s=e.Gi,u=e.Qi}))),!r.isEqual(Um.min())){var c=n.Vs.getLastRemoteSnapshotVersion(e).next((function(t){return n.Vs.setTargetsMetadata(e,e.currentSequenceNumber,r)}));o.push(c)}return Zm.waitFor(o).next((function(){return a.apply(e)})).next((function(){return n.localDocuments.getLocalViewOfDocuments(e,s,u)})).next((function(){return s}))})).then((function(e){return n.$i=i,e}))}function Vw(e,t,n){var r=m_(),i=m_();return n.forEach((function(e){return r=r.add(e)})),t.getEntries(e,r).next((function(e){var r=u_();return n.forEach((function(n,a){var o=e.get(n);a.isFoundDocument()!==o.isFoundDocument()&&(i=i.add(n)),a.isNoDocument()&&a.version.isEqual(Um.min())?(t.removeEntry(n,a.readTime),r=r.insert(n,a)):!o.isValidDocument()||a.version.compareTo(o.version)>0||0===a.version.compareTo(o.version)&&o.hasPendingWrites?(t.addEntry(a),r=r.insert(n,a)):ym("LocalStore","Ignoring outdated watch update for ",n,". Current version:",o.version," Watch version:",a.version)})),{Gi:r,Qi:i}}))}function jw(e,t){var n=bm(e);return n.persistence.runTransaction("Get next mutation batch","readonly",(function(e){return void 0===t&&(t=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(e,t)}))}function qw(e,t){var n=bm(e);return n.persistence.runTransaction("Allocate target","readwrite",(function(e){var r;return n.Vs.getTargetData(e,t).next((function(i){return i?(r=i,Zm.resolve(r)):n.Vs.allocateTargetId(e).next((function(i){return r=new uw(t,i,0,e.currentSequenceNumber),n.Vs.addTargetData(e,r).next((function(){return r}))}))}))})).then((function(e){var r=n.$i.get(e.targetId);return(null===r||e.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.$i=n.$i.insert(e.targetId,e),n.Bi.set(t,e.targetId)),e}))}function Bw(e,t,n){return zw.apply(this,arguments)}function zw(){return(zw=e(a)(e(o).mark((function t(n,r,i){var a,s,u;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(a=bm(n),s=a.$i.get(r),u=i?"readwrite":"readwrite-primary",e.prev=1,e.t0=i,e.t0){e.next=6;break}return e.next=6,a.persistence.runTransaction("Release target",u,(function(e){return a.persistence.referenceDelegate.removeTarget(e,s)}));case 6:e.next=13;break;case 8:if(e.prev=8,e.t1=e.catch(1),eg(e.t1)){e.next=12;break}throw e.t1;case 12:ym("LocalStore","Failed to update sequence numbers for target ".concat(r,": ").concat(e.t1));case 13:a.$i=a.$i.remove(r),a.Bi.delete(s.target);case 14:case"end":return e.stop()}}),t,null,[[1,8]])})))).apply(this,arguments)}function Hw(e,t,n){var r=bm(e),i=Um.min(),a=m_();return r.persistence.runTransaction("Execute query","readonly",(function(e){return(o=r,s=e,u=pk(t),c=bm(o),l=c.Bi.get(u),void 0!==l?Zm.resolve(c.$i.get(l)):c.Vs.getTargetData(s,u)).next((function(t){if(t)return i=t.lastLimboFreeSnapshotVersion,r.Vs.getMatchingKeysForTargetId(e,t.targetId).next((function(e){a=e}))})).next((function(){return r.Fi.getDocumentsMatchingQuery(e,t,n?i:Um.min(),n?a:m_())})).next((function(e){return Ww(r,wk(t),e),{documents:e,ji:a}}));var o,s,u,c,l}))}function Ww(e,t,n){var r=Um.min();n.forEach((function(e,t){t.readTime.compareTo(r)>0&&(r=t.readTime)})),e.Li.set(t,r)}var Kw=function(){"use strict";function t(){e(D)(this,t),this.activeTargetIds=k_()}return e(P)(t,[{key:"Xi",value:function(e){this.activeTargetIds=this.activeTargetIds.add(e)}},{key:"Zi",value:function(e){this.activeTargetIds=this.activeTargetIds.delete(e)}},{key:"Yi",value:function(){var e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}]),t}(),Gw=function(){"use strict";function t(){e(D)(this,t),this.Fr=new Kw,this.$r={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}return e(P)(t,[{key:"addPendingMutation",value:function(e){}},{key:"updateMutationState",value:function(e,t,n){}},{key:"addLocalQueryTarget",value:function(e){return this.Fr.Xi(e),this.$r[e]||"not-current"}},{key:"updateQueryState",value:function(e,t,n){this.$r[e]=t}},{key:"removeLocalQueryTarget",value:function(e){this.Fr.Zi(e)}},{key:"isLocalQueryTarget",value:function(e){return this.Fr.activeTargetIds.has(e)}},{key:"clearQueryState",value:function(e){delete this.$r[e]}},{key:"getAllActiveQueryTargets",value:function(){return this.Fr.activeTargetIds}},{key:"isActiveQueryTarget",value:function(e){return this.Fr.activeTargetIds.has(e)}},{key:"start",value:function(){return this.Fr=new Kw,Promise.resolve()}},{key:"handleUserChange",value:function(e,t,n){}},{key:"setOnlineState",value:function(e){}},{key:"shutdown",value:function(){}},{key:"writeSequenceNumber",value:function(e){}},{key:"notifyBundleLoaded",value:function(e){}}]),t}(),Qw=function(){"use strict";function t(){e(D)(this,t)}return e(P)(t,[{key:"Br",value:function(e){}},{key:"shutdown",value:function(){}}]),t}(),Yw=function(){"use strict";function t(){var n=this;e(D)(this,t),this.Lr=function(){return n.Ur()},this.qr=function(){return n.Kr()},this.Gr=[],this.Qr()}return e(P)(t,[{key:"Br",value:function(e){this.Gr.push(e)}},{key:"shutdown",value:function(){window.removeEventListener("online",this.Lr),window.removeEventListener("offline",this.qr)}},{key:"Qr",value:function(){window.addEventListener("online",this.Lr),window.addEventListener("offline",this.qr)}},{key:"Ur",value:function(){ym("ConnectivityMonitor","Network connectivity changed: AVAILABLE");var e=!0,t=!1,n=void 0;try{for(var r,i=this.Gr[Symbol.iterator]();!(e=(r=i.next()).done);e=!0){(0,r.value)(0)}}catch(e){t=!0,n=e}finally{try{e||null==i.return||i.return()}finally{if(t)throw n}}}},{key:"Kr",value:function(){ym("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");var e=!0,t=!1,n=void 0;try{for(var r,i=this.Gr[Symbol.iterator]();!(e=(r=i.next()).done);e=!0){(0,r.value)(1)}}catch(e){t=!0,n=e}finally{try{e||null==i.return||i.return()}finally{if(t)throw n}}}}],[{key:"V",value:function(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}]),t}(),Xw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery"},Jw=function(){"use strict";function t(n){e(D)(this,t),this.jr=n.jr,this.Wr=n.Wr}return e(P)(t,[{key:"zr",value:function(e){this.Hr=e}},{key:"Jr",value:function(e){this.Yr=e}},{key:"onMessage",value:function(e){this.Xr=e}},{key:"close",value:function(){this.Wr()}},{key:"send",value:function(e){this.jr(e)}},{key:"Zr",value:function(){this.Hr()}},{key:"eo",value:function(e){this.Yr(e)}},{key:"no",value:function(e){this.Xr(e)}}]),t}(),$w=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this,t)).forceLongPolling=t.forceLongPolling,i.autoDetectLongPolling=t.autoDetectLongPolling,i.useFetchStreams=t.useFetchStreams,e($f)(i)}return e(P)(r,[{key:"co",value:function(e,t,n,r){return new Promise((function(i,a){var o=new lm;o.listenOnce(am.COMPLETE,(function(){try{switch(o.getLastErrorCode()){case im.NO_ERROR:var t=o.getResponseJson();ym("Connection","XHR received:",JSON.stringify(t)),i(t);break;case im.TIMEOUT:ym("Connection",'RPC "'+e+'" timed out'),a(new Im(Tm.DEADLINE_EXCEEDED,"Request time out"));break;case im.HTTP_ERROR:var n=o.getStatus();if(ym("Connection",'RPC "'+e+'" failed with status:',n,"response text:",o.getResponseText()),n>0){var r=o.getResponseJson().error;if(r&&r.status&&r.message){var s=(u=r.status,c=u.toLowerCase().replace(/_/g,"-"),Object.values(Tm).indexOf(c)>=0?c:Tm.UNKNOWN);a(new Im(s,r.message))}else a(new Im(Tm.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new Im(Tm.UNAVAILABLE,"Connection failed."));break;default:_m()}}finally{ym("Connection",'RPC "'+e+'" completed.')}var u,c}));var s=JSON.stringify(r);o.send(t,"POST",s,n,15)}))}},{key:"ho",value:function(e,t,n){var r=[this.so,"/","google.firestore.v1.Firestore","/",e,"/channel"],i=nm(),a=rm(),o={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:"projects/".concat(this.databaseId.projectId,"/databases/").concat(this.databaseId.database)},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(o.xmlHttpFactory=new um({})),this.uo(o.initMessageHeaders,t,n),te()||re()||ee().indexOf("Electron/")>=0||ie()||ee().indexOf("MSAppHost/")>=0||ne()||(o.httpHeadersOverwriteParam="$httpHeaders");var s=r.join("");ym("Connection","Creating WebChannel: "+s,o);var u=i.createWebChannel(s,o),c=!1,l=!1,h=new Jw({jr:function(e){l?ym("Connection","Not sending because WebChannel is closed:",e):(c||(ym("Connection","Opening WebChannel transport."),u.open(),c=!0),ym("Connection","WebChannel sending:",e),u.send(e))},Wr:function(){return u.close()}}),f=function(e,t,n){e.listen(t,(function(e){try{n(e)}catch(e){setTimeout((function(){throw e}),0)}}))};return f(u,cm.EventType.OPEN,(function(){l||ym("Connection","WebChannel transport opened.")})),f(u,cm.EventType.CLOSE,(function(){l||(l=!0,ym("Connection","WebChannel transport closed"),h.eo())})),f(u,cm.EventType.ERROR,(function(e){l||(l=!0,gm("Connection","WebChannel transport errored:",e),h.eo(new Im(Tm.UNAVAILABLE,"The operation could not be completed")))})),f(u,cm.EventType.MESSAGE,(function(e){var t;if(!l){var n=e.data[0];wm(!!n);var r=n,i=r.error||(null===(t=r[0])||void 0===t?void 0:t.error);if(i){ym("Connection","WebChannel received error:",i);var a=i.status,o=function(e){var t=Zk[e];if(void 0!==t)return a_(t)}(a),s=i.message;void 0===o&&(o=Tm.INTERNAL,s="Unknown error status: "+a+" with message "+i.message),l=!0,h.eo(new Im(o,s)),u.close()}else ym("Connection","WebChannel received:",n),h.no(n)}})),f(a,om.STAT_EVENT,(function(e){e.stat===sm.PROXY?ym("Connection","Detected buffering proxy"):e.stat===sm.NOPROXY&&ym("Connection","Detected no buffering proxy")})),setTimeout((function(){h.Zr()}),0),h}}]),r}(function(){"use strict";function t(n){e(D)(this,t),this.databaseInfo=n,this.databaseId=n.databaseId;var r=n.ssl?"https":"http";this.so=r+"://"+n.host,this.io="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}return e(P)(t,[{key:"ro",value:function(e,t,n,r,i){var a=this.oo(e,t);ym("RestConnection","Sending: ",a,n);var o={};return this.uo(o,r,i),this.co(e,a,o,n).then((function(e){return ym("RestConnection","Received: ",e),e}),(function(t){throw gm("RestConnection","".concat(e," failed with error: "),t,"url: ",a,"request:",n),t}))}},{key:"ao",value:function(e,t,n,r,i){return this.ro(e,t,n,r,i)}},{key:"uo",value:function(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+dm,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((function(t,n){return e[n]=t})),n&&n.headers.forEach((function(t,n){return e[n]=t}))}},{key:"oo",value:function(e,t){var n=Xw[e];return"".concat(this.so,"/v1/").concat(t,":").concat(n)}}]),t}());function Zw(){return"undefined"!=typeof document?document:null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eb(e){return new R_(e,!0)}var tb=function(){"use strict";function t(n,r){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1e3,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:1.5,o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:6e4;e(D)(this,t),this.js=n,this.timerId=r,this.lo=i,this.fo=a,this._o=o,this.wo=0,this.mo=null,this.yo=Date.now(),this.reset()}return e(P)(t,[{key:"reset",value:function(){this.wo=0}},{key:"po",value:function(){this.wo=this._o}},{key:"Io",value:function(e){var t=this;this.cancel();var n=Math.floor(this.wo+this.To()),r=Math.max(0,Date.now()-this.yo),i=Math.max(0,n-r);i>0&&ym("ExponentialBackoff","Backing off for ".concat(i," ms (base delay: ").concat(this.wo," ms, delay with jitter: ").concat(n," ms, last attempt: ").concat(r," ms ago)")),this.mo=this.js.enqueueAfterDelay(this.timerId,i,(function(){return t.yo=Date.now(),e()})),this.wo*=this.fo,this.wo<this.lo&&(this.wo=this.lo),this.wo>this._o&&(this.wo=this._o)}},{key:"Eo",value:function(){null!==this.mo&&(this.mo.skipDelay(),this.mo=null)}},{key:"cancel",value:function(){null!==this.mo&&(this.mo.cancel(),this.mo=null)}},{key:"To",value:function(){return(Math.random()-.5)*this.wo}}]),t}(),nb=function(){"use strict";function t(n,r,i,a,o,s,u,c){e(D)(this,t),this.js=n,this.Ao=i,this.Ro=a,this.bo=o,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=u,this.listener=c,this.state=0,this.Po=0,this.vo=null,this.Vo=null,this.stream=null,this.So=new tb(n,r)}return e(P)(t,[{key:"Do",value:function(){return 1===this.state||5===this.state||this.Co()}},{key:"Co",value:function(){return 2===this.state||3===this.state}},{key:"start",value:function(){4!==this.state?this.auth():this.xo()}},{key:"stop",value:function(){var t=this;return e(a)(e(o).mark((function n(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=t.Do(),!e.t0){e.next=4;break}return e.next=4,t.close(0);case 4:case"end":return e.stop()}}),n)})))()}},{key:"No",value:function(){this.state=0,this.So.reset()}},{key:"ko",value:function(){var e=this;this.Co()&&null===this.vo&&(this.vo=this.js.enqueueAfterDelay(this.Ao,6e4,(function(){return e.Oo()})))}},{key:"Mo",value:function(e){this.Fo(),this.stream.send(e)}},{key:"Oo",value:function(){var t=this;return e(a)(e(o).mark((function n(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!t.Co()){e.next=2;break}return e.abrupt("return",t.close(0));case 2:case"end":return e.stop()}}),n)})))()}},{key:"Fo",value:function(){this.vo&&(this.vo.cancel(),this.vo=null)}},{key:"$o",value:function(){this.Vo&&(this.Vo.cancel(),this.Vo=null)}},{key:"close",value:function(t,n){var r=this;return e(a)(e(o).mark((function i(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r.Fo(),r.$o(),r.So.cancel(),r.Po++,4!==t?r.So.reset():n&&n.code===Tm.RESOURCE_EXHAUSTED?(mm(n.toString()),mm("Using maximum backoff delay to prevent overloading the backend."),r.So.po()):n&&n.code===Tm.UNAUTHENTICATED&&3!==r.state&&(r.authCredentialsProvider.invalidateToken(),r.appCheckCredentialsProvider.invalidateToken()),null!==r.stream&&(r.Bo(),r.stream.close(),r.stream=null),r.state=t,e.next=9,r.listener.Jr(n);case 9:case"end":return e.stop()}}),i)})))()}},{key:"Bo",value:function(){}},{key:"auth",value:function(){var t=this;this.state=1;var n=this.Lo(this.Po),r=this.Po;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((function(n){var i=e(M)(n,2),a=i[0],o=i[1];t.Po===r&&t.Uo(a,o)}),(function(e){var r=t;n((function(){var t=new Im(Tm.UNKNOWN,"Fetching auth token failed: "+e.message);return r.qo(t)}))}))}},{key:"Uo",value:function(e,t){var n=this,r=this.Lo(this.Po);this.stream=this.Ko(e,t),this.stream.zr((function(){var e=n;r((function(){return e.state=2,e.Vo=e.js.enqueueAfterDelay(e.Ro,1e4,(function(){return e.Co()&&(e.state=3),Promise.resolve()})),e.listener.zr()}))})),this.stream.Jr((function(e){var t=n;r((function(){return t.qo(e)}))})),this.stream.onMessage((function(e){var t=n;r((function(){return t.onMessage(e)}))}))}},{key:"xo",value:function(){var t=this;this.state=5,this.So.Io(e(a)(e(o).mark((function n(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t.state=0,t.start();case 1:case"end":return e.stop()}}),n)}))))}},{key:"qo",value:function(e){return ym("PersistentStream","close with error: ".concat(e)),this.stream=null,this.close(4,e)}},{key:"Lo",value:function(e){var t=this;return function(n){var r=t;t.js.enqueueAndForget((function(){return r.Po===e?n():(ym("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())}))}}}]),t}(),rb=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a,o,s,u){var c;return e(D)(this,r),(c=n.call(this,t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",i,a,o,u)).wt=s,e($f)(c)}return e(P)(r,[{key:"Ko",value:function(e,t){return this.bo.ho("Listen",e,t)}},{key:"onMessage",value:function(e){this.So.reset();var t=function(e,t){var n,r;if("targetChange"in t){t.targetChange;var i="NO_CHANGE"===(r=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===r?1:"REMOVE"===r?2:"CURRENT"===r?3:"RESET"===r?4:_m(),a=t.targetChange.targetIds||[],o=function(e,t){return e.dt?(wm(void 0===t||"string"==typeof t),fg.fromBase64String(t||"")):(wm(void 0===t||t instanceof Uint8Array),fg.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),s=t.targetChange.cause,u=s&&function(e){var t=void 0===e.code?Tm.UNKNOWN:a_(e.code);return new Im(t,e.message||"")}(s);n=new I_(i,a,o,u||null)}else if("documentChange"in t){t.documentChange;var c=t.documentChange;c.document,c.document.name,c.document.updateTime;var l=V_(e,c.document.name),h=L_(c.document.updateTime),f=new jg({mapValue:{fields:c.document.fields}}),d=Bg.newFoundDocument(l,h,f),v=c.targetIds||[],p=c.removedTargetIds||[];n=new b_(v,p,d.key,d)}else if("documentDelete"in t){t.documentDelete;var y=t.documentDelete;y.document;var m=V_(e,y.document),g=y.readTime?L_(y.readTime):Um.min(),k=Bg.newNoDocument(m,g),_=y.removedTargetIds||[];n=new b_([],_,k.key,k)}else if("documentRemove"in t){t.documentRemove;var w=t.documentRemove;w.document;var b=V_(e,w.document),T=w.removedTargetIds||[];n=new b_([],T,b,null)}else{if(!("filter"in t))return _m();t.filter;var I=t.filter;I.targetId;var x=I.count||0,E=new r_(x),C=I.targetId;n=new T_(C,E)}return n}(this.wt,e),n=function(e){if(!("targetChange"in e))return Um.min();var t=e.targetChange;return t.targetIds&&t.targetIds.length?Um.min():t.readTime?L_(t.readTime):Um.min()}(e);return this.listener.Go(t,n)}},{key:"Qo",value:function(e){var t,n,r,i,a={};a.database=B_(this.wt),a.addTarget=(t=this.wt,i=(n=e).target,(r=Gg(i)?{documents:K_(t,i)}:{query:G_(t,i)}).targetId=n.targetId,n.resumeToken.approximateByteSize()>0?r.resumeToken=P_(t,n.resumeToken):n.snapshotVersion.compareTo(Um.min())>0&&(r.readTime=D_(t,n.snapshotVersion.toTimestamp())),r);var o=function(e,t){var n=function(e,t){switch(t){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return _m()}}(0,t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.wt,e);o&&(a.labels=o),this.Mo(a)}},{key:"jo",value:function(e){var t={};t.database=B_(this.wt),t.removeTarget=e,this.Mo(t)}}]),r}(nb),ib=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a,o,s,u){var c;return e(D)(this,r),(c=n.call(this,t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",i,a,o,u)).wt=s,c.Wo=!1,e($f)(c)}return e(P)(r,[{key:"zo",get:function(){return this.Wo}},{key:"start",value:function(){this.Wo=!1,this.lastStreamToken=void 0,e(ei)(e(ri)(r.prototype),"start",this).call(this)}},{key:"Bo",value:function(){this.Wo&&this.Ho([])}},{key:"Ko",value:function(e,t){return this.bo.ho("Write",e,t)}},{key:"onMessage",value:function(e){if(wm(!!e.streamToken),this.lastStreamToken=e.streamToken,this.Wo){this.So.reset();var t=(r=e.writeResults,i=e.commitTime,r&&r.length>0?(wm(void 0!==i),r.map((function(e){return n=i,(r=(t=e).updateTime?L_(t.updateTime):L_(n)).isEqual(Um.min())&&(r=L_(n)),new Vk(r,t.transformResults||[]);var t,n,r}))):[]),n=L_(e.commitTime);return this.listener.Jo(n,t)}var r,i;return wm(!e.writeResults||0===e.writeResults.length),this.Wo=!0,this.listener.Yo()}},{key:"Xo",value:function(){var e={};e.database=B_(this.wt),this.Mo(e)}},{key:"Ho",value:function(e){var t=this,n={streamToken:this.lastStreamToken,writes:e.map((function(e){return W_(t.wt,e)}))};this.Mo(n)}}]),r}(nb),ab=function(t){"use strict";e(U)(r,(function t(){e(D)(this,t)}));var n=e(j)(r);function r(t,i,a,o){var s;return e(D)(this,r),(s=n.call(this)).authCredentials=t,s.appCheckCredentials=i,s.bo=a,s.wt=o,s.Zo=!1,e($f)(s)}return e(P)(r,[{key:"tu",value:function(){if(this.Zo)throw new Im(Tm.FAILED_PRECONDITION,"The client has already been terminated.")}},{key:"ro",value:function(t,n,r){var i=this;return this.tu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((function(a){var o=e(M)(a,2),s=o[0],u=o[1];return i.bo.ro(t,n,r,s,u)})).catch((function(e){throw"FirebaseError"===e.name?(e.code===Tm.UNAUTHENTICATED&&(i.authCredentials.invalidateToken(),i.appCheckCredentials.invalidateToken()),e):new Im(Tm.UNKNOWN,e.toString())}))}},{key:"ao",value:function(t,n,r){var i=this;return this.tu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((function(a){var o=e(M)(a,2),s=o[0],u=o[1];return i.bo.ao(t,n,r,s,u)})).catch((function(e){throw"FirebaseError"===e.name?(e.code===Tm.UNAUTHENTICATED&&(i.authCredentials.invalidateToken(),i.appCheckCredentials.invalidateToken()),e):new Im(Tm.UNKNOWN,e.toString())}))}},{key:"terminate",value:function(){this.Zo=!0}}]),r}(),ob=function(){"use strict";function t(n,r){e(D)(this,t),this.asyncQueue=n,this.onlineStateHandler=r,this.state="Unknown",this.eu=0,this.nu=null,this.su=!0}return e(P)(t,[{key:"iu",value:function(){var e=this;0===this.eu&&(this.ru("Unknown"),this.nu=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(function(){return e.nu=null,e.ou("Backend didn't respond within 10 seconds."),e.ru("Offline"),Promise.resolve()})))}},{key:"uu",value:function(e){"Online"===this.state?this.ru("Unknown"):(this.eu++,this.eu>=1&&(this.cu(),this.ou("Connection failed 1 times. Most recent error: ".concat(e.toString())),this.ru("Offline")))}},{key:"set",value:function(e){this.cu(),this.eu=0,"Online"===e&&(this.su=!1),this.ru(e)}},{key:"ru",value:function(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}},{key:"ou",value:function(e){var t="Could not reach Cloud Firestore backend. ".concat(e,"\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.");this.su?(mm(t),this.su=!1):ym("OnlineStateTracker",t)}},{key:"cu",value:function(){null!==this.nu&&(this.nu.cancel(),this.nu=null)}}]),t}(),sb=function t(n,r,i,s,u){"use strict";var c=this;e(D)(this,t),this.localStore=n,this.datastore=r,this.asyncQueue=i,this.remoteSyncer={},this.au=[],this.hu=new Map,this.lu=new Set,this.fu=[],this.du=u,this.du.Br((function(t){var n=c;i.enqueueAndForget(e(a)(e(o).mark((function t(){return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(t.t0=gb(n),!t.t0){t.next=5;break}return ym("RemoteStore","Restarting streams for network reachability change."),t.next=5,function(){var t=e(a)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return(r=bm(n)).lu.add(4),e.next=4,lb(r);case 4:return r._u.set("Unknown"),r.lu.delete(4),e.next=8,ub(r);case 8:case"end":return e.stop()}}),t)})));return function(e){return t.apply(this,arguments)}}()(n);case 5:case"end":return t.stop()}}),t)}))))})),this._u=new ob(i,s)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ub(e){return cb.apply(this,arguments)}function cb(){return(cb=e(a)(e(o).mark((function t(n){var r,i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(r=!0,i=!1,a=void 0,!gb(n)){e.next=25;break}e.prev=2,s=n.fu[Symbol.iterator]();case 4:if(r=(u=s.next()).done){e.next=11;break}return c=u.value,e.next=8,c(!0);case 8:r=!0,e.next=4;break;case 11:e.next=17;break;case 13:e.prev=13,e.t0=e.catch(2),i=!0,a=e.t0;case 17:e.prev=17,e.prev=18,r||null==s.return||s.return();case 20:if(e.prev=20,!i){e.next=23;break}throw a;case 23:return e.finish(20);case 24:return e.finish(17);case 25:case"end":return e.stop()}}),t,null,[[2,13,17,25],[18,,20,24]])})))).apply(this,arguments)}function lb(e){return hb.apply(this,arguments)}function hb(){return(hb=e(a)(e(o).mark((function t(n){var r,i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:r=!0,i=!1,a=void 0,e.prev=1,s=n.fu[Symbol.iterator]();case 3:if(r=(u=s.next()).done){e.next=10;break}return c=u.value,e.next=7,c(!1);case 7:r=!0,e.next=3;break;case 10:e.next=16;break;case 12:e.prev=12,e.t0=e.catch(1),i=!0,a=e.t0;case 16:e.prev=16,e.prev=17,r||null==s.return||s.return();case 19:if(e.prev=19,!i){e.next=22;break}throw a;case 22:return e.finish(19);case 23:return e.finish(16);case 24:case"end":return e.stop()}}),t,null,[[1,12,16,24],[17,,19,23]])})))).apply(this,arguments)}function fb(e,t){var n=bm(e);n.hu.has(t.targetId)||(n.hu.set(t.targetId,t),mb(n)?yb(n):Gb(n).Co()&&vb(n,t))}function db(e,t){var n=bm(e),r=Gb(n);n.hu.delete(t),r.Co()&&pb(n,t),0===n.hu.size&&(r.Co()?r.ko():gb(n)&&n._u.set("Unknown"))}function vb(e,t){e.wu.Nt(t.targetId),Gb(e).Qo(t)}function pb(e,t){e.wu.Nt(t),Gb(e).jo(t)}function yb(e){e.wu=new E_({getRemoteKeysForTarget:function(t){return e.remoteSyncer.getRemoteKeysForTarget(t)},te:function(t){return e.hu.get(t)||null}}),Gb(e).start(),e._u.iu()}function mb(e){return gb(e)&&!Gb(e).Do()&&e.hu.size>0}function gb(e){return 0===bm(e).lu.size}function kb(e){e.wu=void 0}function _b(e){return wb.apply(this,arguments)}function wb(){return(wb=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:n.hu.forEach((function(e,t){vb(n,e)}));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function bb(e,t){return Tb.apply(this,arguments)}function Tb(){return(Tb=e(a)(e(o).mark((function t(n,r){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:kb(n),mb(n)?(n._u.uu(r),yb(n)):n._u.set("Unknown");case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Ib(e,t,n){return xb.apply(this,arguments)}function xb(){return xb=e(a)(e(o).mark((function t(n,r,i){var s;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(n._u.set("Online"),!(r instanceof I_&&2===r.state&&r.cause)){t.next=13;break}return t.prev=1,t.next=4,function(){var t=e(a)(e(o).mark((function t(n,r){var i,a,s,u,c,l,h;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:i=r.cause,a=!0,s=!1,u=void 0,e.prev=2,c=r.targetIds[Symbol.iterator]();case 4:if(a=(l=c.next()).done){e.next=15;break}if(h=l.value,e.t0=n.hu.has(h),!e.t0){e.next=12;break}return e.next=10,n.remoteSyncer.rejectListen(h,i);case 10:n.hu.delete(h),n.wu.removeTarget(h);case 12:a=!0,e.next=4;break;case 15:e.next=21;break;case 17:e.prev=17,e.t1=e.catch(2),s=!0,u=e.t1;case 21:e.prev=21,e.prev=22,a||null==c.return||c.return();case 24:if(e.prev=24,!s){e.next=27;break}throw u;case 27:return e.finish(24);case 28:return e.finish(21);case 29:case"end":return e.stop()}}),t,null,[[2,17,21,29],[22,,24,28]])})));return function(e,n){return t.apply(this,arguments)}}()(n,r);case 4:t.next=11;break;case 6:return t.prev=6,t.t0=t.catch(1),ym("RemoteStore","Failed to remove targets %s: %s ",r.targetIds.join(","),t.t0),t.next=11,Eb(n,t.t0);case 11:case 22:t.next=29;break;case 13:if(r instanceof b_?n.wu.Ut(r):r instanceof T_?n.wu.zt(r):n.wu.Gt(r),i.isEqual(Um.min())){t.next=29;break}return t.prev=14,t.next=17,Fw(n.localStore);case 17:if(s=t.sent,t.t1=i.compareTo(s)>=0,!t.t1){t.next=22;break}return t.next=22,function(e,t){var n=e.wu.Yt(t);return n.targetChanges.forEach((function(n,r){if(n.resumeToken.approximateByteSize()>0){var i=e.hu.get(r);i&&e.hu.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((function(t){var n=e.hu.get(t);if(n){e.hu.set(t,n.withResumeToken(fg.EMPTY_BYTE_STRING,n.snapshotVersion)),pb(e,t);var r=new uw(n.target,t,1,n.sequenceNumber);vb(e,r)}})),e.remoteSyncer.applyRemoteEvent(n)}(n,i);case 24:return t.prev=24,t.t2=t.catch(14),ym("RemoteStore","Failed to raise snapshot:",t.t2),t.next=29,Eb(n,t.t2);case 29:case"end":return t.stop()}}),t,null,[[1,6],[14,24]])}))),xb.apply(this,arguments)}function Eb(e,t,n){return Cb.apply(this,arguments)}function Cb(){return(Cb=e(a)(e(o).mark((function t(n,r,i){return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(eg(r)){t.next=2;break}throw r;case 2:return n.lu.add(1),t.next=5,lb(n);case 5:n._u.set("Offline"),i||(i=function(){return Fw(n.localStore)}),n.asyncQueue.enqueueRetryable(e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return ym("RemoteStore","Retrying IndexedDB access"),e.next=3,i();case 3:return n.lu.delete(1),e.next=6,ub(n);case 6:case"end":return e.stop()}}),t)}))));case 8:case"end":return t.stop()}}),t)})))).apply(this,arguments)}function Sb(e,t){return t().catch((function(n){return Eb(e,n,t)}))}function Nb(e){return Ab.apply(this,arguments)}function Ab(){return(Ab=e(a)(e(o).mark((function t(n){var r,i,a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:r=bm(n),i=Qb(r),a=r.au.length>0?r.au[r.au.length-1].batchId:-1;case 2:if(!Rb(r)){e.next=19;break}return e.prev=3,e.next=6,jw(r.localStore,a);case 6:if(null!==(s=e.sent)){e.next=10;break}return 0===r.au.length&&i.ko(),e.abrupt("break",19);case 10:a=s.batchId,Db(r,s),e.next=17;break;case 13:return e.prev=13,e.t0=e.catch(3),e.next=17,Eb(r,e.t0);case 17:e.next=2;break;case 19:Pb(r)&&Ob(r);case 20:case"end":return e.stop()}}),t,null,[[3,13]])})))).apply(this,arguments)}function Rb(e){return gb(e)&&e.au.length<10}function Db(e,t){e.au.push(t);var n=Qb(e);n.Co()&&n.zo&&n.Ho(t.mutations)}function Pb(e){return gb(e)&&!Qb(e).Do()&&e.au.length>0}function Ob(e){Qb(e).start()}function Lb(e){return Mb.apply(this,arguments)}function Mb(){return(Mb=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:Qb(n).Xo();case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Fb(e){return Ub.apply(this,arguments)}function Ub(){return(Ub=e(a)(e(o).mark((function t(n){var r,i,a,s,u,c,l;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:for(r=Qb(n),i=!0,a=!1,s=void 0,e.prev=2,u=n.au[Symbol.iterator]();!(i=(c=u.next()).done);i=!0)l=c.value,r.Ho(l.mutations);e.next=10;break;case 6:e.prev=6,e.t0=e.catch(2),a=!0,s=e.t0;case 10:e.prev=10,e.prev=11,i||null==u.return||u.return();case 13:if(e.prev=13,!a){e.next=16;break}throw s;case 16:return e.finish(13);case 17:return e.finish(10);case 18:case"end":return e.stop()}}),t,null,[[2,6,10,18],[11,,13,17]])})))).apply(this,arguments)}function Vb(e,t,n){return jb.apply(this,arguments)}function jb(){return(jb=e(a)(e(o).mark((function t(n,r,i){var a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return a=n.au.shift(),s=ow.from(a,r,i),e.next=3,Sb(n,(function(){return n.remoteSyncer.applySuccessfulWrite(s)}));case 3:return e.next=5,Nb(n);case 5:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function qb(e,t){return Bb.apply(this,arguments)}function Bb(){return Bb=e(a)(e(o).mark((function t(n,r){return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(t.t0=r&&Qb(n).zo,!t.t0){t.next=4;break}return t.next=4,function(){var t=e(a)(e(o).mark((function t(n,r){var i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!i_(a=r.code)||a===Tm.ABORTED){e.next=7;break}return i=n.au.shift(),Qb(n).No(),e.next=5,Sb(n,(function(){return n.remoteSyncer.rejectFailedWrite(i.batchId,r)}));case 5:return e.next=7,Nb(n);case 7:case 8:case"end":return e.stop()}}),t)})));return function(e,n){return t.apply(this,arguments)}}()(n,r);case 4:Pb(n)&&Ob(n);case 5:case"end":return t.stop()}}),t)}))),Bb.apply(this,arguments)}function zb(e,t){return Hb.apply(this,arguments)}function Hb(){return(Hb=e(a)(e(o).mark((function t(n,r){var i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return(i=bm(n)).asyncQueue.verifyOperationInProgress(),ym("RemoteStore","RemoteStore received new credentials"),a=gb(i),i.lu.add(3),e.next=6,lb(i);case 6:return a&&i._u.set("Unknown"),e.next=9,i.remoteSyncer.handleCredentialChange(r);case 9:return i.lu.delete(3),e.next=12,ub(i);case 12:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Wb(e,t){return Kb.apply(this,arguments)}function Kb(){return(Kb=e(a)(e(o).mark((function t(n,r){var i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(i=bm(n),!r){e.next=7;break}return i.lu.delete(2),e.next=5,ub(i);case 5:e.next=13;break;case 7:if(e.t0=r,e.t0){e.next=13;break}return i.lu.add(2),e.next=12,lb(i);case 12:i._u.set("Unknown");case 13:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Gb(t){return t.mu||(t.mu=(r=t.datastore,i=t.asyncQueue,s={zr:_b.bind(null,t),Jr:bb.bind(null,t),Go:Ib.bind(null,t)},(u=bm(r)).tu(),new rb(i,u.bo,u.authCredentials,u.appCheckCredentials,u.wt,s)),t.fu.push((n=e(a)(e(o).mark((function n(r){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!r){e.next=4;break}t.mu.No(),mb(t)?yb(t):t._u.set("Unknown"),e.next=7;break;case 4:return e.next=6,t.mu.stop();case 6:kb(t);case 7:case"end":return e.stop()}}),n)}))),function(e){return n.apply(this,arguments)}))),t.mu;var n,r,i,s,u}function Qb(t){return t.gu||(t.gu=(r=t.datastore,i=t.asyncQueue,s={zr:Lb.bind(null,t),Jr:qb.bind(null,t),Yo:Fb.bind(null,t),Jo:Vb.bind(null,t)},(u=bm(r)).tu(),new ib(i,u.bo,u.authCredentials,u.appCheckCredentials,u.wt,s)),t.fu.push((n=e(a)(e(o).mark((function n(r){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!r){e.next=6;break}return t.gu.No(),e.next=4,Nb(t);case 4:e.next=9;break;case 6:return e.next=8,t.gu.stop();case 8:t.au.length>0&&(ym("RemoteStore","Stopping write stream with ".concat(t.au.length," pending writes")),t.au=[]);case 9:case"end":return e.stop()}}),n)}))),function(e){return n.apply(this,arguments)}))),t.gu
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */;var n,r,i,s,u}var Yb=function(){"use strict";function t(n,r,i,a,o){e(D)(this,t),this.asyncQueue=n,this.timerId=r,this.targetTimeMs=i,this.op=a,this.removalCallback=o,this.deferred=new xm,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((function(e){}))}return e(P)(t,[{key:"start",value:function(e){var t=this;this.timerHandle=setTimeout((function(){return t.handleDelayElapsed()}),e)}},{key:"skipDelay",value:function(){return this.handleDelayElapsed()}},{key:"cancel",value:function(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new Im(Tm.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}},{key:"handleDelayElapsed",value:function(){var e=this;this.asyncQueue.enqueueAndForget((function(){return null!==e.timerHandle?(e.clearTimeout(),e.op().then((function(t){return e.deferred.resolve(t)}))):Promise.resolve()}))}},{key:"clearTimeout",value:function(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}],[{key:"createAndSchedule",value:function(e,n,r,i,a){var o=new t(e,n,Date.now()+r,i,a);return o.start(r),o}}]),t}();function Xb(e,t){if(mm("AsyncQueue","".concat(t,": ").concat(e)),eg(e))return new Im(Tm.UNAVAILABLE,"".concat(t,": ").concat(e));throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Jb=function(){"use strict";function t(n){e(D)(this,t),this.comparator=n?function(e,t){return n(e,t)||zm.comparator(e.key,t.key)}:function(e,t){return zm.comparator(e.key,t.key)},this.keyedMap=l_(),this.sortedSet=new ag(this.comparator)}return e(P)(t,[{key:"has",value:function(e){return null!=this.keyedMap.get(e)}},{key:"get",value:function(e){return this.keyedMap.get(e)}},{key:"first",value:function(){return this.sortedSet.minKey()}},{key:"last",value:function(){return this.sortedSet.maxKey()}},{key:"isEmpty",value:function(){return this.sortedSet.isEmpty()}},{key:"indexOf",value:function(e){var t=this.keyedMap.get(e);return t?this.sortedSet.indexOf(t):-1}},{key:"size",get:function(){return this.sortedSet.size}},{key:"forEach",value:function(e){this.sortedSet.inorderTraversal((function(t,n){return e(t),!1}))}},{key:"add",value:function(e){var t=this.delete(e.key);return t.copy(t.keyedMap.insert(e.key,e),t.sortedSet.insert(e,null))}},{key:"delete",value:function(e){var t=this.get(e);return t?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(t)):this}},{key:"isEqual",value:function(e){if(!(e instanceof t))return!1;if(this.size!==e.size)return!1;for(var n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();n.hasNext();){var i=n.getNext().key,a=r.getNext().key;if(!i.isEqual(a))return!1}return!0}},{key:"toString",value:function(){var e=[];return this.forEach((function(t){e.push(t.toString())})),0===e.length?"DocumentSet ()":"DocumentSet (\n  "+e.join("  \n")+"\n)"}},{key:"copy",value:function(e,n){var r=new t;return r.comparator=this.comparator,r.keyedMap=e,r.sortedSet=n,r}}],[{key:"emptySet",value:function(e){return new t(e.comparator)}}]),t}(),$b=function(){"use strict";function t(){e(D)(this,t),this.yu=new ag(zm.comparator)}return e(P)(t,[{key:"track",value:function(e){var t=e.doc.key,n=this.yu.get(t);n?0!==e.type&&3===n.type?this.yu=this.yu.insert(t,e):3===e.type&&1!==n.type?this.yu=this.yu.insert(t,{type:n.type,doc:e.doc}):2===e.type&&2===n.type?this.yu=this.yu.insert(t,{type:2,doc:e.doc}):2===e.type&&0===n.type?this.yu=this.yu.insert(t,{type:0,doc:e.doc}):1===e.type&&0===n.type?this.yu=this.yu.remove(t):1===e.type&&2===n.type?this.yu=this.yu.insert(t,{type:1,doc:n.doc}):0===e.type&&1===n.type?this.yu=this.yu.insert(t,{type:2,doc:e.doc}):_m():this.yu=this.yu.insert(t,e)}},{key:"pu",value:function(){var e=[];return this.yu.inorderTraversal((function(t,n){e.push(n)})),e}}]),t}(),Zb=function(){"use strict";function t(n,r,i,a,o,s,u,c){e(D)(this,t),this.query=n,this.docs=r,this.oldDocs=i,this.docChanges=a,this.mutatedKeys=o,this.fromCache=s,this.syncStateChanged=u,this.excludesMetadataChanges=c}return e(P)(t,[{key:"hasPendingWrites",get:function(){return!this.mutatedKeys.isEmpty()}},{key:"isEqual",value:function(e){if(!(this.fromCache===e.fromCache&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&mk(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;var t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(var r=0;r<t.length;r++)if(t[r].type!==n[r].type||!t[r].doc.isEqual(n[r].doc))return!1;return!0}}],[{key:"fromInitialDocuments",value:function(e,n,r,i){var a=[];return n.forEach((function(e){a.push({type:0,doc:e})})),new t(e,n,Jb.emptySet(n),a,r,i,!0,!1)}}]),t}(),eT=function t(){"use strict";e(D)(this,t),this.Iu=void 0,this.listeners=[]},tT=function t(){"use strict";e(D)(this,t),this.queries=new o_((function(e){return gk(e)}),mk),this.onlineState="Unknown",this.Tu=new Set};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nT(e,t){return rT.apply(this,arguments)}function rT(){return(rT=e(a)(e(o).mark((function t(n,r){var i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(i=bm(n),a=r.query,s=!1,(u=i.queries.get(a))||(s=!0,u=new eT),!s){e.next=13;break}return e.prev=3,e.next=6,i.onListen(a);case 6:u.Iu=e.sent,e.next=13;break;case 9:return e.prev=9,e.t0=e.catch(3),c=Xb(e.t0,"Initialization of query '".concat(kk(r.query),"' failed")),e.abrupt("return",void r.onError(c));case 13:i.queries.set(a,u),u.listeners.push(r),r.Eu(i.onlineState),u.Iu&&r.Au(u.Iu)&&uT(i);case 14:case"end":return e.stop()}}),t,null,[[3,9]])})))).apply(this,arguments)}function iT(e,t){return aT.apply(this,arguments)}function aT(){return(aT=e(a)(e(o).mark((function t(n,r){var i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(i=bm(n),a=r.query,s=!1,(u=i.queries.get(a))&&(c=u.listeners.indexOf(r))>=0&&(u.listeners.splice(c,1),s=0===u.listeners.length),!s){e.next=6;break}return e.abrupt("return",(i.queries.delete(a),i.onUnlisten(a)));case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function oT(e,t){var n=bm(e),r=!1,i=!0,a=!1,o=void 0;try{for(var s,u=t[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value,l=c.query,h=n.queries.get(l);if(h){var f=!0,d=!1,v=void 0;try{for(var p,y=h.listeners[Symbol.iterator]();!(f=(p=y.next()).done);f=!0){p.value.Au(c)&&(r=!0)}}catch(e){d=!0,v=e}finally{try{f||null==y.return||y.return()}finally{if(d)throw v}}h.Iu=c}}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}r&&uT(n)}function sT(e,t,n){var r=bm(e),i=r.queries.get(t),a=!0,o=!1,s=void 0;if(i)try{for(var u,c=i.listeners[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){u.value.onError(n)}}catch(e){o=!0,s=e}finally{try{a||null==c.return||c.return()}finally{if(o)throw s}}r.queries.delete(t)}function uT(e){e.Tu.forEach((function(e){e.next()}))}var cT=function(){"use strict";function t(n,r,i){e(D)(this,t),this.query=n,this.Ru=r,this.bu=!1,this.Pu=null,this.onlineState="Unknown",this.options=i||{}}return e(P)(t,[{key:"Au",value:function(e){if(!this.options.includeMetadataChanges){var t=[],n=!0,r=!1,i=void 0;try{for(var a,o=e.docChanges[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;3!==s.type&&t.push(s)}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}e=new Zb(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0)}var u=!1;return this.bu?this.vu(e)&&(this.Ru.next(e),u=!0):this.Vu(e,this.onlineState)&&(this.Su(e),u=!0),this.Pu=e,u}},{key:"onError",value:function(e){this.Ru.error(e)}},{key:"Eu",value:function(e){this.onlineState=e;var t=!1;return this.Pu&&!this.bu&&this.Vu(this.Pu,e)&&(this.Su(this.Pu),t=!0),t}},{key:"Vu",value:function(e,t){if(!e.fromCache)return!0;var n="Offline"!==t;return!(this.options.Du&&n||e.docs.isEmpty()&&"Offline"!==t)}},{key:"vu",value:function(e){if(e.docChanges.length>0)return!0;var t=this.Pu&&this.Pu.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}},{key:"Su",value:function(e){e=Zb.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache),this.bu=!0,this.Ru.next(e)}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var lT=function t(n){"use strict";e(D)(this,t),this.key=n},hT=function t(n){"use strict";e(D)(this,t),this.key=n},fT=function(){"use strict";function t(n,r){e(D)(this,t),this.query=n,this.Fu=r,this.$u=null,this.current=!1,this.Bu=m_(),this.mutatedKeys=m_(),this.Lu=bk(n),this.Uu=new Jb(this.Lu)}return e(P)(t,[{key:"qu",get:function(){return this.Fu}},{key:"Ku",value:function(e,t){var n=this,r=t?t.Gu:new $b,i=t?t.Uu:this.Uu,a=t?t.mutatedKeys:this.mutatedKeys,o=i,s=!1,u="F"===this.query.limitType&&i.size===this.query.limit?i.last():null,c="L"===this.query.limitType&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((function(e,t){var l=i.get(e),h=_k(n.query,t)?t:null,f=!!l&&n.mutatedKeys.has(l.key),d=!!h&&(h.hasLocalMutations||n.mutatedKeys.has(h.key)&&h.hasCommittedMutations),v=!1;l&&h?l.data.isEqual(h.data)?f!==d&&(r.track({type:3,doc:h}),v=!0):n.Qu(l,h)||(r.track({type:2,doc:h}),v=!0,(u&&n.Lu(h,u)>0||c&&n.Lu(h,c)<0)&&(s=!0)):!l&&h?(r.track({type:0,doc:h}),v=!0):l&&!h&&(r.track({type:1,doc:l}),v=!0,(u||c)&&(s=!0)),v&&(h?(o=o.add(h),a=d?a.add(e):a.delete(e)):(o=o.delete(e),a=a.delete(e)))})),null!==this.query.limit)for(;o.size>this.query.limit;){var l="F"===this.query.limitType?o.last():o.first();o=o.delete(l.key),a=a.delete(l.key),r.track({type:1,doc:l})}return{Uu:o,Gu:r,Oi:s,mutatedKeys:a}}},{key:"Qu",value:function(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}},{key:"applyChanges",value:function(e,t,n){var r=this,i=this.Uu;this.Uu=e.Uu,this.mutatedKeys=e.mutatedKeys;var a=e.Gu.pu();a.sort((function(e,t){return n=e.type,i=t.type,(a=function(e){switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return _m()}})(n)-a(i)||r.Lu(e.doc,t.doc);var n,i,a})),this.ju(n);var o=t?this.Wu():[],s=0===this.Bu.size&&this.current?1:0,u=s!==this.$u;return this.$u=s,0!==a.length||u?{snapshot:new Zb(this.query,e.Uu,i,a,e.mutatedKeys,0===s,u,!1),zu:o}:{zu:o}}},{key:"Eu",value:function(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({Uu:this.Uu,Gu:new $b,mutatedKeys:this.mutatedKeys,Oi:!1},!1)):{zu:[]}}},{key:"Hu",value:function(e){return!this.Fu.has(e)&&!!this.Uu.has(e)&&!this.Uu.get(e).hasLocalMutations}},{key:"ju",value:function(e){var t=this;e&&(e.addedDocuments.forEach((function(e){return t.Fu=t.Fu.add(e)})),e.modifiedDocuments.forEach((function(e){})),e.removedDocuments.forEach((function(e){return t.Fu=t.Fu.delete(e)})),this.current=e.current)}},{key:"Wu",value:function(){var e=this;if(!this.current)return[];var t=this.Bu;this.Bu=m_(),this.Uu.forEach((function(t){e.Hu(t.key)&&(e.Bu=e.Bu.add(t.key))}));var n=[];return t.forEach((function(t){e.Bu.has(t)||n.push(new hT(t))})),this.Bu.forEach((function(e){t.has(e)||n.push(new lT(e))})),n}},{key:"Ju",value:function(e){this.Fu=e.ji,this.Bu=m_();var t=this.Ku(e.documents);return this.applyChanges(t,!0)}},{key:"Yu",value:function(){return Zb.fromInitialDocuments(this.query,this.Uu,this.mutatedKeys,0===this.$u)}}]),t}(),dT=function t(n,r,i){"use strict";e(D)(this,t),this.query=n,this.targetId=r,this.view=i},vT=function t(n){"use strict";e(D)(this,t),this.key=n,this.Xu=!1},pT=function(){"use strict";function t(n,r,i,a,o,s){e(D)(this,t),this.localStore=n,this.remoteStore=r,this.eventManager=i,this.sharedClientState=a,this.currentUser=o,this.maxConcurrentLimboResolutions=s,this.Zu={},this.tc=new o_((function(e){return gk(e)}),mk),this.ec=new Map,this.nc=new Set,this.sc=new ag(zm.comparator),this.ic=new Map,this.rc=new ww,this.oc={},this.uc=new Map,this.cc=pw.Rn(),this.onlineState="Unknown",this.ac=void 0}return e(P)(t,[{key:"isPrimaryClient",get:function(){return!0===this.ac}}]),t}();function yT(e,t){return mT.apply(this,arguments)}function mT(){return(mT=e(a)(e(o).mark((function t(n,r){var i,a,s,u,c,l;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(i=WT(n),!(u=i.tc.get(r))){e.next=7;break}a=u.targetId,i.sharedClientState.addLocalQueryTarget(a),s=u.view.Yu(),e.next=16;break;case 7:return e.next=9,qw(i.localStore,pk(r));case 9:return c=e.sent,i.isPrimaryClient&&fb(i.remoteStore,c),l=i.sharedClientState.addLocalQueryTarget(c.targetId),a=c.targetId,e.next=15,gT(i,r,a,"current"===l);case 15:s=e.sent;case 16:return e.abrupt("return",s);case 17:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function gT(e,t,n,r){return kT.apply(this,arguments)}function kT(){return kT=e(a)(e(o).mark((function t(n,r,i,s){var u,c,l,h,f,d;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return n.hc=function(t,r,i){return(s=e(a)(e(o).mark((function t(n,r,i,a){var s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(s=r.view.Ku(i),e.t0=s.Oi,!e.t0){e.next=6;break}return e.next=5,Hw(n.localStore,r.query,!1).then((function(e){var t=e.documents;return r.view.Ku(t,s)}));case 5:s=e.sent;case 6:return u=a&&a.targetChanges.get(r.targetId),c=r.view.applyChanges(s,n.isPrimaryClient,u),e.abrupt("return",(FT(n,r.targetId,c.zu),c.snapshot));case 8:case"end":return e.stop()}}),t)}))),function(e,t,n,r){return s.apply(this,arguments)})(n,t,r,i);var s},t.next=3,Hw(n.localStore,r,!0);case 3:return u=t.sent,c=new fT(r,u.ji),l=c.Ku(u.documents),h=w_.createSynthesizedTargetChangeForCurrentChange(i,s&&"Offline"!==n.onlineState),f=c.applyChanges(l,n.isPrimaryClient,h),FT(n,i,f.zu),d=new dT(r,i,c),t.abrupt("return",(n.tc.set(r,d),n.ec.has(i)?n.ec.get(i).push(r):n.ec.set(i,[r]),f.snapshot));case 11:case"end":return t.stop()}}),t)}))),kT.apply(this,arguments)}function _T(e,t){return wT.apply(this,arguments)}function wT(){return(wT=e(a)(e(o).mark((function t(n,r){var i,a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(i=bm(n),a=i.tc.get(r),!((s=i.ec.get(a.targetId)).length>1)){e.next=3;break}return e.abrupt("return",(i.ec.set(a.targetId,s.filter((function(e){return!mk(e,r)}))),void i.tc.delete(r)));case 3:if(!i.isPrimaryClient){e.next=11;break}if(i.sharedClientState.removeLocalQueryTarget(a.targetId),e.t0=i.sharedClientState.isActiveQueryTarget(a.targetId),e.t0){e.next=9;break}return e.next=9,Bw(i.localStore,a.targetId,!1).then((function(){i.sharedClientState.clearQueryState(a.targetId),db(i.remoteStore,a.targetId),LT(i,a.targetId)})).catch(Jm);case 9:e.next=14;break;case 11:return LT(i,a.targetId),e.next=14,Bw(i.localStore,a.targetId,!0);case 14:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function bT(e,t,n){return TT.apply(this,arguments)}function TT(){return(TT=e(a)(e(o).mark((function t(n,r,i){var a,s,u;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return a=KT(n),e.prev=1,e.next=4,function(e,t){var n,r,i=bm(e),a=Fm.now(),o=t.reduce((function(e,t){return e.add(t.key)}),m_());return i.persistence.runTransaction("Locally write mutations","readwrite",(function(e){var s=u_(),u=m_();return i.Ui.getEntries(e,o).next((function(e){(s=e).forEach((function(e,t){t.isValidDocument()||(u=u.add(e))}))})).next((function(){return i.localDocuments.getOverlayedDocuments(e,s)})).next((function(r){n=r;var o=[],s=!0,u=!1,c=void 0;try{for(var l,h=t[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value,d=Kk(f,n.get(f.key).overlayedDocument);null!=d&&o.push(new Yk(f.key,d,qg(d.value.mapValue),jk.exists(!0)))}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}return i.mutationQueue.addMutationBatch(e,a,o,t)})).next((function(t){r=t;var a=t.applyToLocalDocumentSet(n,u);return i.documentOverlayCache.saveOverlays(e,t.batchId,a)}))})).then((function(){return{batchId:r.batchId,changes:h_(n)}}))}(a.localStore,r);case 4:return s=e.sent,a.sharedClientState.addPendingMutation(s.batchId),t=a,o=s.batchId,c=i,l=void 0,(l=t.oc[t.currentUser.toKey()])||(l=new ag(Lm)),l=l.insert(o,c),t.oc[t.currentUser.toKey()]=l,e.next=9,jT(a,s.changes);case 9:return e.next=11,Nb(a.remoteStore);case 11:e.next=17;break;case 13:e.prev=13,e.t0=e.catch(1),u=Xb(e.t0,"Failed to persist write"),i.reject(u);case 17:case"end":return e.stop()}var t,o,c,l}),t,null,[[1,13]])})))).apply(this,arguments)}function IT(e,t){return xT.apply(this,arguments)}function xT(){return(xT=e(a)(e(o).mark((function t(n,r){var i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=bm(n),e.prev=1,e.next=4,Uw(i.localStore,r);case 4:return a=e.sent,r.targetChanges.forEach((function(e,t){var n=i.ic.get(t);n&&(wm(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1),e.addedDocuments.size>0?n.Xu=!0:e.modifiedDocuments.size>0?wm(n.Xu):e.removedDocuments.size>0&&(wm(n.Xu),n.Xu=!1))})),e.next=8,jT(i,a,r);case 8:e.next=14;break;case 10:return e.prev=10,e.t0=e.catch(1),e.next=14,Jm(e.t0);case 14:case"end":return e.stop()}}),t,null,[[1,10]])})))).apply(this,arguments)}function ET(e,t,n){var r=bm(e);if(r.isPrimaryClient&&0===n||!r.isPrimaryClient&&1===n){var i=[];r.tc.forEach((function(e,n){var r=n.view.Eu(t);r.snapshot&&i.push(r.snapshot)})),function(e,t){var n=bm(e);n.onlineState=t;var r=!1;n.queries.forEach((function(e,n){var i=!0,a=!1,o=void 0;try{for(var s,u=n.listeners[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){s.value.Eu(t)&&(r=!0)}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}})),r&&uT(n)}(r.eventManager,t),i.length&&r.Zu.Go(i),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}function CT(e,t,n){return ST.apply(this,arguments)}function ST(){return(ST=e(a)(e(o).mark((function t(n,r,i){var a,s,u,c,l,h;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if((a=bm(n)).sharedClientState.updateQueryState(r,"rejected",i),s=a.ic.get(r),!(u=s&&s.key)){e.next=14;break}return c=(c=new ag(zm.comparator)).insert(u,Bg.newNoDocument(u,Um.min())),l=m_().add(u),h=new __(Um.min(),new Map,new ug(Lm),c,l),e.next=9,IT(a,h);case 9:a.sc=a.sc.remove(u),a.ic.delete(r),VT(a),e.next=16;break;case 14:return e.next=16,Bw(a.localStore,r,!1).then((function(){return LT(a,r,i)})).catch(Jm);case 16:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function NT(e,t){return AT.apply(this,arguments)}function AT(){return(AT=e(a)(e(o).mark((function t(n,r){var i,a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=bm(n),a=r.batch.batchId,e.prev=1,e.next=4,Mw(i.localStore,r);case 4:return s=e.sent,OT(i,a,null),PT(i,a),i.sharedClientState.updateMutationState(a,"acknowledged"),e.next=10,jT(i,s);case 10:e.next=16;break;case 12:return e.prev=12,e.t0=e.catch(1),e.next=16,Jm(e.t0);case 16:case"end":return e.stop()}}),t,null,[[1,12]])})))).apply(this,arguments)}function RT(e,t,n){return DT.apply(this,arguments)}function DT(){return(DT=e(a)(e(o).mark((function t(n,r,i){var a,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return a=bm(n),e.prev=1,e.next=4,function(e,t){var n=bm(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",(function(e){var r;return n.mutationQueue.lookupMutationBatch(e,t).next((function(t){return wm(null!==t),r=t.keys(),n.mutationQueue.removeMutationBatch(e,t)})).next((function(){return n.mutationQueue.performConsistencyCheck(e)})).next((function(){return n.documentOverlayCache.removeOverlaysForBatchId(e,r,t)})).next((function(){return n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,r)})).next((function(){return n.localDocuments.getDocuments(e,r)}))}))}(a.localStore,r);case 4:return s=e.sent,OT(a,r,i),PT(a,r),a.sharedClientState.updateMutationState(r,"rejected",i),e.next=10,jT(a,s);case 10:e.next=16;break;case 12:return e.prev=12,e.t0=e.catch(1),e.next=16,Jm(e.t0);case 16:case"end":return e.stop()}}),t,null,[[1,12]])})))).apply(this,arguments)}function PT(e,t){(e.uc.get(t)||[]).forEach((function(e){e.resolve()})),e.uc.delete(t)}function OT(e,t,n){var r=bm(e),i=r.oc[r.currentUser.toKey()];if(i){var a=i.get(t);a&&(n?a.reject(n):a.resolve(),i=i.remove(t)),r.oc[r.currentUser.toKey()]=i}}function LT(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;e.sharedClientState.removeLocalQueryTarget(t);var r=!0,i=!1,a=void 0;try{for(var o,s=e.ec.get(t)[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;e.tc.delete(u),n&&e.Zu.lc(u,n)}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}e.ec.delete(t),e.isPrimaryClient&&e.rc.us(t).forEach((function(t){e.rc.containsKey(t)||MT(e,t)}))}function MT(e,t){e.nc.delete(t.path.canonicalString());var n=e.sc.get(t);null!==n&&(db(e.remoteStore,n),e.sc=e.sc.remove(t),e.ic.delete(n),VT(e))}function FT(e,t,n){var r=!0,i=!1,a=void 0;try{for(var o,s=n[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;u instanceof lT?(e.rc.addReference(u.key,t),UT(e,u)):u instanceof hT?(ym("SyncEngine","Document no longer in limbo: "+u.key),e.rc.removeReference(u.key,t),e.rc.containsKey(u.key)||MT(e,u.key)):_m()}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}}function UT(e,t){var n=t.key,r=n.path.canonicalString();e.sc.get(n)||e.nc.has(r)||(ym("SyncEngine","New document in limbo: "+n),e.nc.add(r),VT(e))}function VT(e){for(;e.nc.size>0&&e.sc.size<e.maxConcurrentLimboResolutions;){var t=e.nc.values().next().value;e.nc.delete(t);var n=new zm(jm.fromString(t)),r=e.cc.next();e.ic.set(r,new vT(n)),e.sc=e.sc.insert(n,r),fb(e.remoteStore,new uw(pk(lk(n.path)),r,2,tg.ot))}}function jT(e,t,n){return qT.apply(this,arguments)}function qT(){return qT=e(a)(e(o).mark((function t(n,r,i){var s,u,c,l;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(s=bm(n),u=[],c=[],l=[],t.t0=s.tc.isEmpty(),t.t0){t.next=9;break}return s.tc.forEach((function(e,t){l.push(s.hc(t,r,i).then((function(e){if(e){s.isPrimaryClient&&s.sharedClientState.updateQueryState(t.targetId,e.fromCache?"not-current":"current"),u.push(e);var n=Aw.Vi(t.targetId,e);c.push(n)}})))})),t.next=6,Promise.all(l);case 6:return s.Zu.Go(u),t.next=9,function(){var t=e(a)(e(o).mark((function t(n,r){var i,a,s,u,c,l,h,f,d,v,p;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=bm(n),e.prev=1,e.next=4,i.persistence.runTransaction("notifyLocalViewChanges","readwrite",(function(e){return Zm.forEach(r,(function(t){return Zm.forEach(t.Pi,(function(n){return i.persistence.referenceDelegate.addReference(e,t.targetId,n)})).next((function(){return Zm.forEach(t.vi,(function(n){return i.persistence.referenceDelegate.removeReference(e,t.targetId,n)}))}))}))}));case 4:e.next=11;break;case 6:if(e.prev=6,e.t0=e.catch(1),eg(e.t0)){e.next=10;break}throw e.t0;case 10:ym("LocalStore","Failed to update sequence numbers: "+e.t0);case 11:for(a=!0,s=!1,u=void 0,e.prev=12,c=r[Symbol.iterator]();!(a=(l=c.next()).done);a=!0)h=l.value,f=h.targetId,h.fromCache||(d=i.$i.get(f),v=d.snapshotVersion,p=d.withLastLimboFreeSnapshotVersion(v),i.$i=i.$i.insert(f,p));e.next=20;break;case 16:e.prev=16,e.t1=e.catch(12),s=!0,u=e.t1;case 20:e.prev=20,e.prev=21,a||null==c.return||c.return();case 23:if(e.prev=23,!s){e.next=26;break}throw u;case 26:return e.finish(23);case 27:return e.finish(20);case 28:case"end":return e.stop()}}),t,null,[[1,6],[12,16,20,28],[21,,23,27]])})));return function(e,n){return t.apply(this,arguments)}}()(s.localStore,c);case 9:case"end":return t.stop()}}),t)}))),qT.apply(this,arguments)}function BT(e,t){return zT.apply(this,arguments)}function zT(){return(zT=e(a)(e(o).mark((function t(n,r){var i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if((i=bm(n)).currentUser.isEqual(r)){e.next=11;break}return ym("SyncEngine","User change. New user:",r.toKey()),e.next=5,Ow(i.localStore,r);case 5:return a=e.sent,i.currentUser=r,(t=i).uc.forEach((function(e){e.forEach((function(e){e.reject(new Im(Tm.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))}))})),t.uc.clear(),i.sharedClientState.handleUserChange(r,a.removedBatchIds,a.addedBatchIds),e.next=11,jT(i,a.Ki);case 11:case"end":return e.stop()}var t}),t)})))).apply(this,arguments)}function HT(e,t){var n=bm(e),r=n.ic.get(t);if(r&&r.Xu)return m_().add(r.key);var i=m_(),a=n.ec.get(t);if(!a)return i;var o=!0,s=!1,u=void 0;try{for(var c,l=a[Symbol.iterator]();!(o=(c=l.next()).done);o=!0){var h=c.value,f=n.tc.get(h);i=i.unionWith(f.view.qu)}}catch(e){s=!0,u=e}finally{try{o||null==l.return||l.return()}finally{if(s)throw u}}return i}function WT(e){var t=bm(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=IT.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=HT.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=CT.bind(null,t),t.Zu.Go=oT.bind(null,t.eventManager),t.Zu.lc=sT.bind(null,t.eventManager),t}function KT(e){var t=bm(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=NT.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=RT.bind(null,t),t}var GT=function(){"use strict";function t(){e(D)(this,t),this.synchronizeTabs=!1}return e(P)(t,[{key:"initialize",value:function(t){var n=this;return e(a)(e(o).mark((function r(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.wt=eb(t.databaseInfo.databaseId),n.sharedClientState=n.dc(t),n.persistence=n._c(t),e.next=5,n.persistence.start();case 5:n.localStore=n.wc(t),n.gcScheduler=n.mc(t,n.localStore),n.indexBackfillerScheduler=n.gc(t,n.localStore);case 8:case"end":return e.stop()}}),r)})))()}},{key:"mc",value:function(e,t){return null}},{key:"gc",value:function(e,t){return null}},{key:"wc",value:function(e){return Pw(this.persistence,new Rw,e.initialUser,this.wt)}},{key:"_c",value:function(e){return new Cw(Nw.Ms,this.wt)}},{key:"dc",value:function(e){return new Gw}},{key:"terminate",value:function(){var t=this;return e(a)(e(o).mark((function n(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return t.gcScheduler&&t.gcScheduler.stop(),e.next=3,t.sharedClientState.shutdown();case 3:return e.next=5,t.persistence.shutdown();case 5:case"end":return e.stop()}}),n)})))()}}]),t}(),QT=function(){"use strict";function t(){e(D)(this,t)}return e(P)(t,[{key:"initialize",value:function(t,n){var r=this;return e(a)(e(o).mark((function i(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=r.localStore,e.t0){e.next=12;break}return r.localStore=t.localStore,r.sharedClientState=t.sharedClientState,r.datastore=r.createDatastore(n),r.remoteStore=r.createRemoteStore(n),r.eventManager=r.createEventManager(n),r.syncEngine=r.createSyncEngine(n,!t.synchronizeTabs),r.sharedClientState.onlineStateHandler=function(e){return ET(r.syncEngine,e,1)},r.remoteStore.remoteSyncer.handleCredentialChange=BT.bind(null,r.syncEngine),e.next=12,Wb(r.remoteStore,r.syncEngine.isPrimaryClient);case 12:case"end":return e.stop()}}),i)})))()}},{key:"createEventManager",value:function(e){return new tT}},{key:"createDatastore",value:function(e){var t,n,r,i=eb(e.databaseInfo.databaseId),a=(t=e.databaseInfo,new $w(t));return n=e.authCredentials,r=e.appCheckCredentials,new ab(n,r,a,i)}},{key:"createRemoteStore",value:function(e){var t,n,r,i,a,o=this;return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=function(e){return ET(o.syncEngine,e,0)},a=Yw.V()?new Yw:new Qw,new sb(t,n,r,i,a)}},{key:"createSyncEngine",value:function(e,t){return n=this.localStore,r=this.remoteStore,i=this.eventManager,a=this.sharedClientState,o=e.initialUser,s=e.maxConcurrentLimboResolutions,u=t,c=new pT(n,r,i,a,o,s),u&&(c.ac=!0),c;var n,r,i,a,o,s,u,c}},{key:"terminate",value:function(){return(t=e(a)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=bm(n),ym("RemoteStore","RemoteStore shutting down."),r.lu.add(5),e.next=5,lb(r);case 5:r.du.shutdown(),r._u.set("Unknown");case 7:case"end":return e.stop()}}),t)}))),function(e){return t.apply(this,arguments)})(this.remoteStore);var t}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JT(e,t){return $T.apply(this,arguments)}function $T(){return $T=e(a)(e(o).mark((function t(n,r){var i,s;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return n.asyncQueue.verifyOperationInProgress(),ym("FirestoreClient","Initializing OfflineComponentProvider"),t.next=3,n.getConfiguration();case 3:return i=t.sent,t.next=6,r.initialize(i);case 6:s=i.initialUser,n.setCredentialChangeListener(function(){var t=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=s.isEqual(n),e.t0){e.next=5;break}return e.next=4,Ow(r.localStore,n);case 4:s=n;case 5:case"end":return e.stop()}}),t)})));return function(e){return t.apply(this,arguments)}}()),r.persistence.setDatabaseDeletedListener((function(){return n.terminate()})),n.offlineComponents=r;case 8:case"end":return t.stop()}}),t)}))),$T.apply(this,arguments)}function ZT(e,t){return eI.apply(this,arguments)}function eI(){return(eI=e(a)(e(o).mark((function t(n,r){var i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.asyncQueue.verifyOperationInProgress(),e.next=3,tI(n);case 3:return i=e.sent,ym("FirestoreClient","Initializing OnlineComponentProvider"),e.next=7,n.getConfiguration();case 7:return a=e.sent,e.next=10,r.initialize(i,a);case 10:n.setCredentialChangeListener((function(e){return zb(r.remoteStore,e)})),n.setAppCheckTokenChangeListener((function(e,t){return zb(r.remoteStore,t)})),n.onlineComponents=r;case 13:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function tI(e){return nI.apply(this,arguments)}function nI(){return(nI=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=n.offlineComponents,e.t0){e.next=5;break}return ym("FirestoreClient","Using default OfflineComponentProvider"),e.next=5,JT(n,new GT);case 5:return e.abrupt("return",(e.t0||e.sent,n.offlineComponents));case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function rI(e){return iI.apply(this,arguments)}function iI(){return(iI=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=n.onlineComponents,e.t0){e.next=5;break}return ym("FirestoreClient","Using default OnlineComponentProvider"),e.next=5,ZT(n,new QT);case 5:return e.abrupt("return",(e.t0||e.sent,n.onlineComponents));case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function aI(e){return rI(e).then((function(e){return e.syncEngine}))}function oI(e){return sI.apply(this,arguments)}function sI(){return(sI=e(a)(e(o).mark((function t(n){var r,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,rI(n);case 2:return r=e.sent,i=r.eventManager,e.abrupt("return",(i.onListen=yT.bind(null,r.syncEngine),i.onUnlisten=_T.bind(null,r.syncEngine),i));case 5:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function uI(t,n){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},i=new xm;return t.asyncQueue.enqueueAndForget(e(a)(e(o).mark((function a(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.t0=function(e,t,n,r,i){var a=new YT({next:function(n){t.enqueueAndForget((function(){return iT(e,o)})),n.fromCache&&"server"===r.source?i.reject(new Im(Tm.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:function(e){return i.reject(e)}}),o=new cT(n,a,{includeMetadataChanges:!0,Du:!0});return nT(e,o)},e.next=3,oI(t);case 3:return e.t1=e.sent,e.t2=t.asyncQueue,e.t3=n,e.t4=r,e.t5=i,e.abrupt("return",(0,e.t0)(e.t1,e.t2,e.t3,e.t4,e.t5));case 9:case"end":return e.stop()}}),a)})))),i.promise}var cI=new Map;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lI(e,t,n){if(!n)throw new Im(Tm.INVALID_ARGUMENT,"Function ".concat(e,"() cannot be called with an empty ").concat(t,"."))}function hI(e){if(!zm.isDocumentKey(e))throw new Im(Tm.INVALID_ARGUMENT,"Invalid document reference. Document references must have an even number of segments, but ".concat(e," has ").concat(e.length,"."))}function fI(e){if(zm.isDocumentKey(e))throw new Im(Tm.INVALID_ARGUMENT,"Invalid collection reference. Collection references must have an odd number of segments, but ".concat(e," has ").concat(e.length,"."))}function dI(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e="".concat(e.substring(0,20),"...")),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";var t=(n=e).constructor?n.constructor.name:null;return t?"a custom ".concat(t," object"):"an object"}var n;return"function"==typeof e?"a function":_m()}function vI(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new Im(Tm.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");var n=dI(e);throw new Im(Tm.INVALID_ARGUMENT,"Expected type '".concat(t.name,"', but it was: ").concat(n))}return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var pI=function(){"use strict";function t(n){var r;if(e(D)(this,t),void 0===n.host){if(void 0!==n.ssl)throw new Im(Tm.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=n.host,this.ssl=null===(r=n.ssl)||void 0===r||r;if(this.credentials=n.credentials,this.ignoreUndefinedProperties=!!n.ignoreUndefinedProperties,void 0===n.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==n.cacheSizeBytes&&n.cacheSizeBytes<1048576)throw new Im(Tm.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=n.cacheSizeBytes}this.experimentalForceLongPolling=!!n.experimentalForceLongPolling,this.experimentalAutoDetectLongPolling=!!n.experimentalAutoDetectLongPolling,this.useFetchStreams=!!n.useFetchStreams,function(e,t,n,r){if(!0===t&&!0===r)throw new Im(Tm.INVALID_ARGUMENT,"".concat(e," and ").concat(n," cannot be used together."))}("experimentalForceLongPolling",n.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",n.experimentalAutoDetectLongPolling)}return e(P)(t,[{key:"isEqual",value:function(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}]),t}(),yI=function(){"use strict";function t(n,r,i){e(D)(this,t),this._authCredentials=r,this._appCheckCredentials=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new pI({}),this._settingsFrozen=!1,n instanceof wg?this._databaseId=n:(this._app=n,this._databaseId=function(e){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new Im(Tm.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wg(e.options.projectId)}(n))}return e(P)(t,[{key:"app",get:function(){if(!this._app)throw new Im(Tm.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}},{key:"_initialized",get:function(){return this._settingsFrozen}},{key:"_terminated",get:function(){return void 0!==this._terminateTask}},{key:"_setSettings",value:function(e){if(this._settingsFrozen)throw new Im(Tm.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new pI(e),void 0!==e.credentials&&(this._authCredentials=function(e){if(!e)return new Cm;switch(e.type){case"gapi":var t=e.client;return wm(!("object"!=typeof t||null===t||!t.auth||!t.auth.getAuthHeaderValueForFirstParty)),new Am(t,e.sessionIndex||"0",e.iamToken||null);case"provider":return e.client;default:throw new Im(Tm.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}},{key:"_getSettings",value:function(){return this._settings}},{key:"_freezeSettings",value:function(){return this._settingsFrozen=!0,this._settings}},{key:"_delete",value:function(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}},{key:"toJSON",value:function(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}},{key:"_terminate",value:function(){return e=this,(t=cI.get(e))&&(ym("ComponentProvider","Removing Datastore"),cI.delete(e),t.terminate()),Promise.resolve();var e,t}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var mI=function(){"use strict";function t(n,r,i){e(D)(this,t),this.converter=r,this._key=i,this.type="document",this.firestore=n}return e(P)(t,[{key:"_path",get:function(){return this._key.path}},{key:"id",get:function(){return this._key.path.lastSegment()}},{key:"path",get:function(){return this._key.path.canonicalString()}},{key:"parent",get:function(){return new kI(this.firestore,this.converter,this._key.path.popLast())}},{key:"withConverter",value:function(e){return new t(this.firestore,e,this._key)}}]),t}(),gI=function(){"use strict";function t(n,r,i){e(D)(this,t),this.converter=r,this._query=i,this.type="query",this.firestore=n}return e(P)(t,[{key:"withConverter",value:function(e){return new t(this.firestore,e,this._query)}}]),t}(),kI=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a){var o;return e(D)(this,r),(o=n.call(this,t,i,lk(a)))._path=a,o.type="collection",e($f)(o)}return e(P)(r,[{key:"id",get:function(){return this._query.path.lastSegment()}},{key:"path",get:function(){return this._query.path.canonicalString()}},{key:"parent",get:function(){var e=this._path.popLast();return e.isEmpty()?null:new mI(this.firestore,null,new zm(e))}},{key:"withConverter",value:function(e){return new r(this.firestore,e,this._path)}}]),r}(gI);function _I(t,n){for(var r=arguments.length,i=new Array(r>2?r-2:0),a=2;a<r;a++)i[a-2]=arguments[a];if(t=Oe(t),lI("collection","path",n),t instanceof yI){var o,s=(o=jm).fromString.apply(o,[n].concat(e(L)(i)));return fI(s),new kI(t,null,s)}var u;if(!(t instanceof mI||t instanceof kI))throw new Im(Tm.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");var c=t._path.child((u=jm).fromString.apply(u,[n].concat(e(L)(i))));return fI(c),new kI(t.firestore,null,c)}function wI(t,n){for(var r=arguments.length,i=new Array(r>2?r-2:0),a=2;a<r;a++)i[a-2]=arguments[a];if(t=Oe(t),1===arguments.length&&(n=Om.I()),lI("doc","path",n),t instanceof yI){var o,s=(o=jm).fromString.apply(o,[n].concat(e(L)(i)));return hI(s),new mI(t,null,new zm(s))}var u;if(!(t instanceof mI||t instanceof kI))throw new Im(Tm.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");var c=t._path.child((u=jm).fromString.apply(u,[n].concat(e(L)(i))));return hI(c),new mI(t.firestore,t instanceof kI?t.converter:null,new zm(c))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var bI=function(){"use strict";function t(){var n=this;e(D)(this,t),this.Oc=Promise.resolve(),this.Mc=[],this.Fc=!1,this.$c=[],this.Bc=null,this.Lc=!1,this.Uc=!1,this.qc=[],this.So=new tb(this,"async_queue_retry"),this.Kc=function(){var e=Zw();e&&ym("AsyncQueue","Visibility state changed to "+e.visibilityState),n.So.Eo()};var r=Zw();r&&"function"==typeof r.addEventListener&&r.addEventListener("visibilitychange",this.Kc)}return e(P)(t,[{key:"isShuttingDown",get:function(){return this.Fc}},{key:"enqueueAndForget",value:function(e){this.enqueue(e)}},{key:"enqueueAndForgetEvenWhileRestricted",value:function(e){this.Gc(),this.Qc(e)}},{key:"enterRestrictedMode",value:function(e){if(!this.Fc){this.Fc=!0,this.Uc=e||!1;var t=Zw();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.Kc)}}},{key:"enqueue",value:function(e){var t=this;if(this.Gc(),this.Fc)return new Promise((function(){}));var n=new xm;return this.Qc((function(){return t.Fc&&t.Uc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)})).then((function(){return n.promise}))}},{key:"enqueueRetryable",value:function(e){var t=this;this.enqueueAndForget((function(){return t.Mc.push(e),t.jc()}))}},{key:"jc",value:function(){var t=this;return e(a)(e(o).mark((function n(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(0===t.Mc.length){e.next=14;break}return e.prev=1,e.next=4,t.Mc[0]();case 4:t.Mc.shift(),t.So.reset(),e.next=13;break;case 8:if(e.prev=8,e.t0=e.catch(1),eg(e.t0)){e.next=12;break}throw e.t0;case 12:ym("AsyncQueue","Operation failed with retryable error: "+e.t0);case 13:t.Mc.length>0&&t.So.Io((function(){return t.jc()}));case 14:case"end":return e.stop()}}),n,null,[[1,8]])})))()}},{key:"Qc",value:function(e){var t=this,n=this.Oc.then((function(){return t.Lc=!0,e().catch((function(e){var n,r;throw t.Bc=e,t.Lc=!1,mm("INTERNAL UNHANDLED ERROR: ",(r=(n=e).message||"",n.stack&&(r=n.stack.includes(n.message)?n.stack:n.message+"\n"+n.stack),r)),e})).then((function(e){return t.Lc=!1,e}))}));return this.Oc=n,n}},{key:"enqueueAfterDelay",value:function(e,t,n){var r=this;this.Gc(),this.qc.indexOf(e)>-1&&(t=0);var i=Yb.createAndSchedule(this,e,t,n,(function(e){return r.Wc(e)}));return this.$c.push(i),i}},{key:"Gc",value:function(){this.Bc&&_m()}},{key:"verifyOperationInProgress",value:function(){}},{key:"zc",value:function(){var t=this;return e(a)(e(o).mark((function n(){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:case 1:return r=t.Oc,e.next=4,r;case 4:if(r!==t.Oc){e.next=1;break}case 5:case"end":return e.stop()}}),n)})))()}},{key:"Hc",value:function(e){var t=!0,n=!1,r=void 0;try{for(var i,a=this.$c[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){if(i.value.timerId===e)return!0}}catch(e){n=!0,r=e}finally{try{t||null==a.return||a.return()}finally{if(n)throw r}}return!1}},{key:"Jc",value:function(e){var t=this;return this.zc().then((function(){t.$c.sort((function(e,t){return e.targetTimeMs-t.targetTimeMs}));var n=!0,r=!1,i=void 0;try{for(var a,o=t.$c[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;if(s.skipDelay(),"all"!==e&&s.timerId===e)break}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}return t.zc()}))}},{key:"Yc",value:function(e){this.qc.push(e)}},{key:"Wc",value:function(e){var t=this.$c.indexOf(e);this.$c.splice(t,1)}}]),t}();var TI=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a){var o;return e(D)(this,r),(o=n.call(this,t,i,a)).type="firestore",o._queue=new bI,o._persistenceKey="name"in t?t.name:"[DEFAULT]",e($f)(o)}return e(P)(r,[{key:"_terminate",value:function(){return this._firestoreClient||xI(this),this._firestoreClient.terminate()}}]),r}(yI);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function II(e){return e._firestoreClient||xI(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function xI(e){var t,n,r,i,a,o=e._freezeSettings(),s=(n=e._databaseId,r=(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",i=e._persistenceKey,new _g(n,r,i,(a=o).host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams));e._firestoreClient=new XT(e._authCredentials,e._appCheckCredentials,e._queue,s)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var EI=function(){"use strict";function t(){for(var n=arguments.length,r=new Array(n),i=0;i<n;i++)r[i]=arguments[i];e(D)(this,t);for(var a=0;a<r.length;++a)if(0===r[a].length)throw new Im(Tm.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Bm(r)}return e(P)(t,[{key:"isEqual",value:function(e){return this._internalPath.isEqual(e._internalPath)}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var CI=function(){"use strict";function t(n){e(D)(this,t),this._byteString=n}return e(P)(t,[{key:"toBase64",value:function(){return this._byteString.toBase64()}},{key:"toUint8Array",value:function(){return this._byteString.toUint8Array()}},{key:"toString",value:function(){return"Bytes(base64: "+this.toBase64()+")"}},{key:"isEqual",value:function(e){return this._byteString.isEqual(e._byteString)}}],[{key:"fromBase64String",value:function(e){try{return new t(fg.fromBase64String(e))}catch(e){throw new Im(Tm.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}},{key:"fromUint8Array",value:function(e){return new t(fg.fromUint8Array(e))}}]),t}(),SI=function t(n){"use strict";e(D)(this,t),this._methodName=n},NI=function(){"use strict";function t(n,r){if(e(D)(this,t),!isFinite(n)||n<-90||n>90)throw new Im(Tm.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+n);if(!isFinite(r)||r<-180||r>180)throw new Im(Tm.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+r);this._lat=n,this._long=r}return e(P)(t,[{key:"latitude",get:function(){return this._lat}},{key:"longitude",get:function(){return this._long}},{key:"isEqual",value:function(e){return this._lat===e._lat&&this._long===e._long}},{key:"toJSON",value:function(){return{latitude:this._lat,longitude:this._long}}},{key:"_compareTo",value:function(e){return Lm(this._lat,e._lat)||Lm(this._long,e._long)}}]),t}(),AI=/^__.*__$/,RI=function(){"use strict";function t(n,r,i){e(D)(this,t),this.data=n,this.fieldMask=r,this.fieldTransforms=i}return e(P)(t,[{key:"toMutation",value:function(e,t){return null!==this.fieldMask?new Yk(e,this.data,this.fieldMask,t,this.fieldTransforms):new Qk(e,this.data,t,this.fieldTransforms)}}]),t}(),DI=function(){"use strict";function t(n,r,i){e(D)(this,t),this.data=n,this.fieldMask=r,this.fieldTransforms=i}return e(P)(t,[{key:"toMutation",value:function(e,t){return new Yk(e,this.data,this.fieldMask,t,this.fieldTransforms)}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw _m()}}var OI=function(){"use strict";function t(n,r,i,a,o,s){e(D)(this,t),this.settings=n,this.databaseId=r,this.wt=i,this.ignoreUndefinedProperties=a,void 0===o&&this.Xc(),this.fieldTransforms=o||[],this.fieldMask=s||[]}return e(P)(t,[{key:"path",get:function(){return this.settings.path}},{key:"Zc",get:function(){return this.settings.Zc}},{key:"ta",value:function(e){return new t(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.wt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}},{key:"ea",value:function(e){var t,n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ta({path:n,na:!1});return r.sa(e),r}},{key:"ia",value:function(e){var t,n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ta({path:n,na:!1});return r.Xc(),r}},{key:"ra",value:function(e){return this.ta({path:void 0,na:!0})}},{key:"oa",value:function(e){return QI(e,this.settings.methodName,this.settings.ua||!1,this.path,this.settings.ca)}},{key:"contains",value:function(e){return void 0!==this.fieldMask.find((function(t){return e.isPrefixOf(t)}))||void 0!==this.fieldTransforms.find((function(t){return e.isPrefixOf(t.field)}))}},{key:"Xc",value:function(){if(this.path)for(var e=0;e<this.path.length;e++)this.sa(this.path.get(e))}},{key:"sa",value:function(e){if(0===e.length)throw this.oa("Document fields must not be empty");if(PI(this.Zc)&&AI.test(e))throw this.oa('Document fields cannot begin and end with "__"')}}]),t}(),LI=function(){"use strict";function t(n,r,i){e(D)(this,t),this.databaseId=n,this.ignoreUndefinedProperties=r,this.wt=i||eb(n)}return e(P)(t,[{key:"aa",value:function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]&&arguments[3];return new OI({Zc:e,methodName:t,ca:n,path:Bm.emptyPath(),na:!1,ua:r},this.databaseId,this.wt,this.ignoreUndefinedProperties)}}]),t}();function MI(e){var t=e._freezeSettings(),n=eb(e._databaseId);return new LI(e._databaseId,!!t.ignoreUndefinedProperties,n)}function FI(e,t,n,r,i){var a=arguments.length>5&&void 0!==arguments[5]?arguments[5]:{},o=e.aa(a.merge||a.mergeFields?2:0,t,n,i);HI("Data must be an object, but it was:",o,r);var s,u,c=BI(r,o);if(a.merge)s=new lg(o.fieldMask),u=o.fieldTransforms;else if(a.mergeFields){var l=[],h=!0,f=!1,d=void 0;try{for(var v,p=a.mergeFields[Symbol.iterator]();!(h=(v=p.next()).done);h=!0){var y=v.value,m=WI(t,y,n);if(!o.contains(m))throw new Im(Tm.INVALID_ARGUMENT,"Field '".concat(m,"' is specified in your field mask but missing from your input data."));YI(l,m)||l.push(m)}}catch(e){f=!0,d=e}finally{try{h||null==p.return||p.return()}finally{if(f)throw d}}s=new lg(l),u=o.fieldTransforms.filter((function(e){return s.covers(e.field)}))}else s=null,u=o.fieldTransforms;return new RI(new jg(c),s,u)}var UI=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(){return e(D)(this,r),n.apply(this,arguments)}return e(P)(r,[{key:"_toFieldTransform",value:function(e){if(2!==e.Zc)throw 1===e.Zc?e.oa("".concat(this._methodName,"() can only appear at the top level of your update data")):e.oa("".concat(this._methodName,"() cannot be used with set() unless you pass {merge:true}"));return e.fieldMask.push(e.path),null}},{key:"isEqual",value:function(e){return e instanceof r}}]),r}(SI);function VI(e,t,n,r){var i=e.aa(1,t,n);HI("Data must be an object, but it was:",i,r);var a=[],o=jg.empty();rg(r,(function(e,r){var s=GI(t,e,n);r=Oe(r);var u=i.ia(s);if(r instanceof UI)a.push(s);else{var c=qI(r,u);null!=c&&(a.push(s),o.set(s,c))}}));var s=new lg(a);return new DI(o,s,i.fieldTransforms)}function jI(e,t,n,r,i,a){var o=e.aa(1,t,n),s=[WI(t,r,n)],u=[i];if(a.length%2!=0)throw new Im(Tm.INVALID_ARGUMENT,"Function ".concat(t,"() needs to be called with an even number of arguments that alternate between field names and values."));for(var c=0;c<a.length;c+=2)s.push(WI(t,a[c])),u.push(a[c+1]);for(var l=[],h=jg.empty(),f=s.length-1;f>=0;--f)if(!YI(l,s[f])){var d=s[f],v=u[f];v=Oe(v);var p=o.ia(d);if(v instanceof UI)l.push(d);else{var y=qI(v,p);null!=y&&(l.push(d),h.set(d,y))}}var m=new lg(l);return new DI(h,m,o.fieldTransforms)}function qI(e,t){if(zI(e=Oe(e)))return HI("Unsupported field value:",t,e),BI(e,t);if(e instanceof SI)return function(e,t){if(!PI(t.Zc))throw t.oa("".concat(e._methodName,"() can only be used with update() and set()"));if(!t.path)throw t.oa("".concat(e._methodName,"() is not currently supported inside arrays"));var n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.na&&4!==t.Zc)throw t.oa("Nested arrays are not supported");return function(e,t){var n=[],r=0,i=!0,a=!1,o=void 0;try{for(var s,u=e[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=qI(s.value,t.ra(r));null==c&&(c={nullValue:"NULL_VALUE"}),n.push(c),r++}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=Oe(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return Ek(t.wt,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){var n=Fm.fromDate(e);return{timestampValue:D_(t.wt,n)}}if(e instanceof Fm){var r=new Fm(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:D_(t.wt,r)}}if(e instanceof NI)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof CI)return{bytesValue:P_(t.wt,e._byteString)};if(e instanceof mI){var i=t.databaseId,a=e.firestore._databaseId;if(!a.isEqual(i))throw t.oa("Document reference is for database ".concat(a.projectId,"/").concat(a.database," but should be for database ").concat(i.projectId,"/").concat(i.database));return{referenceValue:M_(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.oa("Unsupported field value: ".concat(dI(e)))}(e,t)}function BI(e,t){var n={};return ig(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):rg(e,(function(e,r){var i=qI(r,t.ea(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function zI(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof Fm||e instanceof NI||e instanceof CI||e instanceof mI||e instanceof SI)}function HI(e,t,n){if(!zI(n)||("object"!=typeof(i=n)||null===i||Object.getPrototypeOf(i)!==Object.prototype&&null!==Object.getPrototypeOf(i))){var r=dI(n);throw"an object"===r?t.oa(e+" a custom object"):t.oa(e+" "+r)}var i}function WI(e,t,n){if((t=Oe(t))instanceof EI)return t._internalPath;if("string"==typeof t)return GI(e,t);throw QI("Field path arguments must be of type string or ",e,!1,void 0,n)}var KI=new RegExp("[~\\*/\\[\\]]");function GI(t,n,r){if(n.search(KI)>=0)throw QI("Invalid field path (".concat(n,"). Paths must not contain '~', '*', '/', '[', or ']'"),t,!1,void 0,r);try{return e(Jf)(EI,e(L)(n.split(".")))._internalPath}catch(e){throw QI("Invalid field path (".concat(n,"). Paths must not be empty, begin with '.', end with '.', or contain '..'"),t,!1,void 0,r)}}function QI(e,t,n,r,i){var a=r&&!r.isEmpty(),o=void 0!==i,s="Function ".concat(t,"() called with invalid data");n&&(s+=" (via `toFirestore()`)"),s+=". ";var u="";return(a||o)&&(u+=" (found",a&&(u+=" in field ".concat(r)),o&&(u+=" in document ".concat(i)),u+=")"),new Im(Tm.INVALID_ARGUMENT,s+e+u)}function YI(e,t){return e.some((function(e){return e.isEqual(t)}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var XI=function(){"use strict";function t(n,r,i,a,o){e(D)(this,t),this._firestore=n,this._userDataWriter=r,this._key=i,this._document=a,this._converter=o}return e(P)(t,[{key:"id",get:function(){return this._key.path.lastSegment()}},{key:"ref",get:function(){return new mI(this._firestore,this._converter,this._key)}},{key:"exists",value:function(){return null!==this._document}},{key:"data",value:function(){if(this._document){if(this._converter){var e=new JI(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}},{key:"get",value:function(e){if(this._document){var t=this._document.data.field($I("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}]),t}(),JI=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(){return e(D)(this,r),n.apply(this,arguments)}return e(P)(r,[{key:"data",value:function(){return e(ei)(e(ri)(r.prototype),"data",this).call(this)}}]),r}(XI);function $I(e,t){return"string"==typeof t?GI(e,t):t instanceof EI?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ZI=function(){"use strict";function t(n,r){e(D)(this,t),this.hasPendingWrites=n,this.fromCache=r}return e(P)(t,[{key:"isEqual",value:function(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}]),t}(),ex=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t,i,a,o,s,u){var c;return e(D)(this,r),(c=n.call(this,t,i,a,o,u))._firestore=t,c._firestoreImpl=t,c.metadata=s,e($f)(c)}return e(P)(r,[{key:"exists",value:function(){return e(ei)(e(ri)(r.prototype),"exists",this).call(this)}},{key:"data",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(this._document){if(this._converter){var t=new tx(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}},{key:"get",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if(this._document){var n=this._document.data.field($I("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}]),r}(XI),tx=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(){return e(D)(this,r),n.apply(this,arguments)}return e(P)(r,[{key:"data",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return e(ei)(e(ri)(r.prototype),"data",this).call(this,t)}}]),r}(ex),nx=function(){"use strict";function t(n,r,i,a){e(D)(this,t),this._firestore=n,this._userDataWriter=r,this._snapshot=a,this.metadata=new ZI(a.hasPendingWrites,a.fromCache),this.query=i}return e(P)(t,[{key:"docs",get:function(){var e=[];return this.forEach((function(t){return e.push(t)})),e}},{key:"size",get:function(){return this._snapshot.docs.size}},{key:"empty",get:function(){return 0===this.size}},{key:"forEach",value:function(e,t){var n=this;this._snapshot.docs.forEach((function(r){e.call(t,new tx(n._firestore,n._userDataWriter,r.key,r,new ZI(n._snapshot.mutatedKeys.has(r.key),n._snapshot.fromCache),n.query.converter))}))}},{key:"docChanges",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new Im(Tm.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){var n=0;return e._snapshot.docChanges.map((function(t){return{type:"added",doc:new tx(e._firestore,e._userDataWriter,t.doc.key,t.doc,new ZI(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),oldIndex:-1,newIndex:n++}}))}var r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((function(e){return t||3!==e.type})).map((function(t){var n=new tx(e._firestore,e._userDataWriter,t.doc.key,t.doc,new ZI(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,a=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(a=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:rx(t.type),doc:n,oldIndex:i,newIndex:a}}))}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}]),t}();function rx(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return _m()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function ix(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new Im(Tm.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
var ax=function(){"use strict";function t(){e(D)(this,t)}return e(P)(t,[{key:"convertValue",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"none";switch(Eg(e)){case 0:return null;case 1:return e.booleanValue;case 2:return pg(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(yg(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw _m()}}},{key:"convertObject",value:function(e,t){var n=this,r={};return rg(e.fields,(function(e,i){r[e]=n.convertValue(i,t)})),r}},{key:"convertGeoPoint",value:function(e){return new NI(pg(e.latitude),pg(e.longitude))}},{key:"convertArray",value:function(e,t){var n=this;return(e.values||[]).map((function(e){return n.convertValue(e,t)}))}},{key:"convertServerTimestamp",value:function(e,t){switch(t){case"previous":var n=gg(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(kg(e));default:return null}}},{key:"convertTimestamp",value:function(e){var t=vg(e);return new Fm(t.seconds,t.nanos)}},{key:"convertDocumentKey",value:function(e,t){var n=jm.fromString(e);wm(tw(n));var r=new wg(n.get(1),n.get(3)),i=new zm(n.popFirst(5));return r.isEqual(t)||mm("Document ".concat(i," contains a document reference within a different database (").concat(r.projectId,"/").concat(r.database,") which is not supported. It will be treated as a reference in the current database (").concat(t.projectId,"/").concat(t.database,") instead.")),i}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function ox(e,t,n){return e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t}var sx=function(t){"use strict";e(U)(r,t);var n=e(j)(r);function r(t){var i;return e(D)(this,r),(i=n.call(this)).firestore=t,e($f)(i)}return e(P)(r,[{key:"convertBytes",value:function(e){return new CI(e)}},{key:"convertReference",value:function(e){var t=this.convertDocumentKey(e,this.firestore._databaseId);return new mI(this.firestore,null,t)}}]),r}(ax);function ux(e){e=vI(e,gI);var t=vI(e.firestore,TI),n=II(t),r=new sx(t);return ix(e._query),uI(n,e._query).then((function(n){return new nx(t,r,e,n)}))}function cx(e,t,n){for(var r=arguments.length,i=new Array(r>3?r-3:0),a=3;a<r;a++)i[a-3]=arguments[a];e=vI(e,mI);var o=vI(e.firestore,TI),s=MI(o);return hx(o,[("string"==typeof(t=Oe(t))||t instanceof EI?jI(s,"updateDoc",e._key,t,n,i):VI(s,"updateDoc",e._key,t)).toMutation(e._key,jk.exists(!0))])}function lx(e,t){var n=vI(e.firestore,TI),r=wI(e),i=ox(e.converter,t);return hx(n,[FI(MI(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,jk.exists(!1))]).then((function(){return r}))}function hx(t,n){return r=II(t),i=n,s=new xm,r.asyncQueue.enqueueAndForget(e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.t0=bT,e.next=3,aI(r);case 3:return e.t1=e.sent,e.t2=i,e.t3=s,e.abrupt("return",(0,e.t0)(e.t1,e.t2,e.t3));case 7:case"end":return e.stop()}}),t)})))),s.promise;var r,i,s}!function(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];dm=At,xt(new Le("firestore",(function(e,n){var r=n.options,i=e.getProvider("app").getImmediate(),a=new TI(i,new Sm(e.getProvider("auth-internal")),new Dm(e.getProvider("app-check-internal")));return r=Object.assign({useFetchStreams:t},r),a._setSettings(r),a}),"PUBLIC")),Dt(hm,"3.4.10",e),Dt(hm,"3.4.10","esm2017")}();u=i("dh4R1");var fx,dx,vx,px,yx,mx=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("object"!=typeof t){var n=t;t={name:n}}var r=Object.assign({name:_t,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw St.create("bad-app-name",{appName:String(i)});var a=bt.get(i);if(a){if(we(e,a.options)&&we(r,a.config))return a;throw St.create("duplicate-app",{appName:i})}var o=new je(i),s=!0,u=!1,c=void 0;try{for(var l,h=Tt.values()[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value;o.addComponent(f)}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}var d=new Nt(e,r,o);return bt.set(i,d),d}({apiKey:"AIzaSyDl7udEYc6yHxHTsho7iDZ8HPitihaHEU4",authDomain:"filmoteka-46cf5.firebaseapp.com",databaseURL:"https://filmoteka-46cf5-default-rtdb.europe-west1.firebasedatabase.app",projectId:"filmoteka-46cf5",storageBucket:"filmoteka-46cf5.appspot.com",messagingSenderId:"1056346694690",appId:"1:1056346694690:web:c5c566f94f38d4dac1167b",measurementId:"G-9M2V8M9NTK"}),gx=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Rt(),t=Et(e=Oe(e),cr);t.isInitialized()?t.getImmediate():Xr(e)}(mx),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Rt();return Et(e,"firestore").getImmediate()}(mx)),kx=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Rt(),t=Et(e,"auth");return t.isInitialized()?t.getImmediate():ki(e,{popupRedirectResolver:Js,persistence:[Yo,xo,Co]})}(),_x={formWrap:document.querySelector(".form-auth"),libBtn:document.querySelector(".nav__library"),regForm:document.querySelector('[name="regForm"]'),regBtn:document.querySelector('[name="regBtn"]'),loginForm:document.querySelector('[name="loginForm"]'),logoutBtn:document.querySelector('[name="logoutBtn"]'),loginBtn:document.querySelector('[name="loginBtn"]')};function wx(){return(wx=e(a)(e(o).mark((function t(n){var r,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.t0=wI,e.t1=gx,e.next=4,bx();case 4:return e.t2=e.sent,r=(0,e.t0)(e.t1,"users",e.t2),e.next=8,u.default.fetchFullMovieInfo(n);case 8:return i=e.sent,e.next=11,cx(r,{films:i});case 11:console.log("film add");case 12:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function bx(){return Tx.apply(this,arguments)}function Tx(){return Tx=e(a)(e(o).mark((function t(){var n;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=3,ux(_I(gx,"users"));case 3:return t.sent.forEach(function(){var t=e(a)(e(o).mark((function t(r){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:e.prev=0,r.data().email===kx.currentUser.email&&(n=r.id),e.next=8;break;case 4:return e.prev=4,e.t0=e.catch(0),console.log(e.t0),e.abrupt("return");case 8:case"end":return e.stop()}}),t,null,[[0,4]])})));return function(e){return t.apply(this,arguments)}}()),t.abrupt("return",n);case 6:case"end":return t.stop()}}),t)}))),Tx.apply(this,arguments)}function Ix(){return(Ix=e(a)(e(o).mark((function t(n){var r,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),r=n.target.elements.emailLogin.value.trim(),i=n.target.elements.passwordLogin.value.trim(),kx.currentUser,e.next=6,_o(kx,r,i);case 6:_x.loginForm.classList.add("is-hidden"),_x.formWrap.classList.add("is-hidden");case 8:case"end":return e.stop()}}),t)})))).apply(this,arguments)}_x.regForm.addEventListener("submit",(function(t){t.preventDefault();var n=t.target.elements.emailReg.value.trim(),r=t.target.elements.passwordReg.value.trim();go(kx,n,r).then((i=e(a)(e(o).mark((function t(i){var a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return console.log("New user registered ".concat(i.user.email)),e.prev=1,e.next=4,lx(_I(gx,"users"),{email:n,password:r,films:{}});case 4:a=e.sent,console.log("Document written with ID: ",a.id),e.next=11;break;case 8:e.prev=8,e.t0=e.catch(1),console.error("Error adding document: ",e.t0);case 11:_x.regForm.classList.add("is-hidden"),_x.formWrap.classList.add("is-hidden");case 13:case"end":return e.stop()}}),t,null,[[1,8]])}))),function(e){return i.apply(this,arguments)}));var i})),_x.loginForm.addEventListener("submit",(function(e){return Ix.apply(this,arguments)})),_x.logoutBtn.addEventListener("click",(function(e){e.preventDefault(),t=kx,Oe(t).signOut(),_x.libBtn.classList.add("is-hidden");var t})),_x.loginBtn.addEventListener("click",(function(){_x.loginForm.classList.remove("is-hidden"),_x.formWrap.classList.remove("is-hidden"),_x.regForm.classList.add("is-hidden")})),_x.regBtn.addEventListener("click",(function(){_x.regForm.classList.remove("is-hidden"),_x.formWrap.classList.remove("is-hidden"),_x.loginForm.classList.add("is-hidden")})),fx=kx,yx=e(a)(e(o).mark((function t(n){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n&&(_x.logoutBtn.classList.remove("is-hidden"),_x.libBtn.classList.remove("is-hidden"),_x.loginBtn.classList.add("is-hidden"),_x.regBtn.classList.add("is-hidden")),n){e.next=7;break}return _x.loginBtn.classList.remove("is-hidden"),_x.regBtn.classList.remove("is-hidden"),_x.libBtn.classList.add("is-hidden"),_x.logoutBtn.classList.add("is-hidden"),e.abrupt("return");case 7:case"end":return e.stop()}}),t)}))),dx=function(e){return yx.apply(this,arguments)},Oe(fx).onAuthStateChanged(dx,vx,px),function(e){wx.apply(this,arguments)}(705865);_=i("1vR0Z");var xx,Ex=i("eMaQ6"),Cx=i("7LMqv"),Sx=document.querySelector(".movie-card-list");function Nx(){return(Nx=e(a)(e(o).mark((function t(n){var r,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.target.dataset.target){e.next=2;break}return e.abrupt("return");case 2:return r=n.target.dataset.id,e.next=5,u.default.fetchFullMovieInfo(r);case 5:if(i=e.sent,"watched"!==n.target.dataset.target){e.next=14;break}if(n.target.classList.toggle("pressed"),!n.target.classList.contains("pressed")){e.next=12;break}return n.target.textContent="Remove from Watched",(0,Ex.default)(i,_.watchedArr,n.target.dataset.target),e.abrupt("return");case 12:n.target.textContent="Add to Watched",(0,Cx.default)(r,_.watchedArr,n.target.dataset.target);case 14:if("queue"!==n.target.dataset.target){e.next=22;break}if(n.target.classList.toggle("pressed"),!n.target.classList.contains("pressed")){e.next=20;break}return n.target.textContent="Remove from Queue",(0,Ex.default)(i,_.queueArr,n.target.dataset.target),e.abrupt("return");case 20:n.target.textContent="Add to Queue",(0,Cx.default)(r,_.queueArr,n.target.dataset.target);case 22:case"end":return e.stop()}}),t)})))).apply(this,arguments)}e(l).start(),(0,_.default)(Sx),u.default.fetchGenresList().then((function(e){xx=e})),u.default.fetchTrendData().then((function(t){var n,r,i=h(c(t.results,xx));Sx.insertAdjacentHTML("beforeend",i),n=t.results,r=n.map((function(t){var n=t.poster_path,r=t.id,i=n?"".concat("https://image.tmdb.org/t/p/w500").concat(n):e(s);return'<div class="swiper-slide">\n\t\t\t\t<img src="'.concat(i,'" alt="poster" class="slide-poster" data-id="').concat(r,'"/>\n\t\t\t</div>')})).join(""),C.insertAdjacentHTML("beforeend",r);var a=document.querySelectorAll(".btn-watche"),o=document.querySelectorAll(".btn-queue");a.forEach((function(e){_.watchedArr.forEach((function(t){t.id===Number(e.dataset.id)&&(e.classList.add("pressed"),e.textContent="Remove from Watched")}))})),o.forEach((function(e){_.queueArr.forEach((function(t){t.id===Number(e.dataset.id)&&(e.classList.add("pressed"),e.textContent="Remove from Queue")}))})),m(t.total_pages,t.page)})).catch((function(e){return console.log(e)})),e(l).done(),Sx.addEventListener("click",(function(e){return Nx.apply(this,arguments)}))}();
//# sourceMappingURL=index.9f6a6950.js.map
